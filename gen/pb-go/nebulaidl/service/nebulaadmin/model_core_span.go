...
// Span represents a duration trace of Nebula execution. The id field denotes a Nebula execution entity or an operation which uniquely identifies the Span. The spans attribute allows this Span to be further broken down into more precise definitions.
