...
type AdminNodeExecutionClosure struct {
	...
	WorkflowNodeMetadata *NebulaidladminWorkflowNodeMetadata `json:"workflow_node_metadata,omitempty"`
	TaskNodeMetadata *NebulaidladminTaskNodeMetadata `json:"task_node_metadata,omitempty"`
