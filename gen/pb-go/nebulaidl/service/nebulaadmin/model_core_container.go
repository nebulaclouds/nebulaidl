...
type CoreContainer struct {
	...
	// These will default to Nebula given paths. If provided, the system will not append known paths. If the task still needs nebula's inputs and outputs path, add $(NEBULA_INPUT_FILE), $(NEBULA_OUTPUT_FILE) wherever makes sense and the system will populate these before executing the container.
