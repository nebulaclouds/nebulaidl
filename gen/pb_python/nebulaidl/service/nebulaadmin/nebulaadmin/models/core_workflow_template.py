...
from nebulaadmin.models.core_workflow_metadata import CoreWorkflowMetadata  # noqa: F401,E501
from nebulaadmin.models.core_workflow_metadata_defaults import CoreWorkflowMetadataDefaults  # noqa: F401,E501
...
class CoreWorkflowTemplate(object):
    ...
    def failure_node(self):
        ...
        +optional A catch-all node. This node is executed whenever the execution engine determines the workflow has failed. The interface of this node must match the Workflow interface with an additional input named 'error' of type pb.lyft.nebula.core.Error.  # noqa: E501
