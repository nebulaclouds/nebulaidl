...
from nebulaadmin.models.core_task_execution_phase import CoreTaskExecutionPhase  # noqa: F401,E501
from nebulaadmin.models.core_task_log import CoreTaskLog  # noqa: F401,E501
from nebulaadmin.models.event_event_reason import EventEventReason  # noqa: F401,E501
from nebulaadmin.models.nebulaidlevent_task_execution_metadata import NebulaidleventTaskExecutionMetadata  # noqa: F401,E501
...
class EventTaskExecutionEvent(object):
    ...
    swagger_types = {
        ...
        'task_type': 'str',
        'metadata': 'NebulaidleventTaskExecutionMetadata',
        'event_version': 'int',
    ...
    def task_type(self):
        ...
        A predefined yet extensible Task type identifier. If the task definition is already registered in nebula admin this type will be identical, but not all task executions necessarily use pre-registered definitions and this type is useful to render the task in the UI, filter task executions, etc.  # noqa: E501
    ...
    def metadata(self):
        ...
        :rtype: NebulaidleventTaskExecutionMetadata
        """
    ...
    def metadata(self, metadata):
        ...
        :type: NebulaidleventTaskExecutionMetadata
        """
