...
from nebulaadmin.models.core_identity import CoreIdentity  # noqa: F401,E501
from nebulaadmin.models.core_o_auth2_token_request import CoreOAuth2TokenRequest  # noqa: F401,E501
from nebulaadmin.models.core_secret import CoreSecret  # noqa: F401,E501
...
class CoreSecurityContext(object):
    ...
    def secrets(self):
        ...
        secrets indicate the list of secrets the task needs in order to proceed. Secrets will be mounted/passed to the pod as it starts. If the plugin responsible for kicking of the task will not run it on a nebula cluster (e.g. AWS Batch), it's the responsibility of the plugin to fetch the secret (which means propeller identity will need access to the secret) and to pass it to the remote execution engine.  # noqa: E501
