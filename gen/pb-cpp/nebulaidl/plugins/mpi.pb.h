...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fmpi_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fmpi_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2fmpi_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2fmpi_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::DistributedMPITrainingTask* Arena::CreateMaybeMessage<::nebulaidl::plugins::DistributedMPITrainingTask>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class DistributedMPITrainingTask final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.DistributedMPITrainingTask) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fplugins_2fmpi_2eproto;
};
// ===================================================================
...
inline ::google::protobuf::int32 DistributedMPITrainingTask::num_workers() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedMPITrainingTask.num_workers)
  return num_workers_;
}
inline void DistributedMPITrainingTask::set_num_workers(::google::protobuf::int32 value) {
  
  num_workers_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedMPITrainingTask.num_workers)
}
...
inline ::google::protobuf::int32 DistributedMPITrainingTask::num_launcher_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedMPITrainingTask.num_launcher_replicas)
...
inline void DistributedMPITrainingTask::set_num_launcher_replicas(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedMPITrainingTask.num_launcher_replicas)
}
...
inline ::google::protobuf::int32 DistributedMPITrainingTask::slots() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedMPITrainingTask.slots)
  return slots_;
}
inline void DistributedMPITrainingTask::set_slots(::google::protobuf::int32 value) {
  
  slots_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedMPITrainingTask.slots)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fmpi_2eproto
