...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fpytorch_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fpytorch_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2fpytorch_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2fpytorch_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::DistributedPyTorchTrainingTask* Arena::CreateMaybeMessage<::nebulaidl::plugins::DistributedPyTorchTrainingTask>(Arena*);
template<> ::nebulaidl::plugins::ElasticConfig* Arena::CreateMaybeMessage<::nebulaidl::plugins::ElasticConfig>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class ElasticConfig final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.ElasticConfig) */ {
 public:
  ElasticConfig();
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fplugins_2fpytorch_2eproto;
};
// -------------------------------------------------------------------

class DistributedPyTorchTrainingTask final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.DistributedPyTorchTrainingTask) */ {
 public:
  ...
  const ::nebulaidl::plugins::ElasticConfig& elastic_config() const;
  ::nebulaidl::plugins::ElasticConfig* release_elastic_config();
  ::nebulaidl::plugins::ElasticConfig* mutable_elastic_config();
  void set_allocated_elastic_config(::nebulaidl::plugins::ElasticConfig* elastic_config);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::nebulaidl::plugins::ElasticConfig* elastic_config_;
...
inline const ::std::string& ElasticConfig::rdzv_backend() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.ElasticConfig.rdzv_backend)
...
inline void ElasticConfig::set_rdzv_backend(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.ElasticConfig.rdzv_backend)
}
#if LANG_CXX11
inline void ElasticConfig::set_rdzv_backend(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.ElasticConfig.rdzv_backend)
}
#endif
inline void ElasticConfig::set_rdzv_backend(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.ElasticConfig.rdzv_backend)
}
inline void ElasticConfig::set_rdzv_backend(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.ElasticConfig.rdzv_backend)
}
inline ::std::string* ElasticConfig::mutable_rdzv_backend() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.ElasticConfig.rdzv_backend)
...
inline ::std::string* ElasticConfig::release_rdzv_backend() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.ElasticConfig.rdzv_backend)
...
inline void ElasticConfig::set_allocated_rdzv_backend(::std::string* rdzv_backend) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.ElasticConfig.rdzv_backend)
}
...
inline ::google::protobuf::int32 ElasticConfig::min_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.ElasticConfig.min_replicas)
  return min_replicas_;
}
inline void ElasticConfig::set_min_replicas(::google::protobuf::int32 value) {
  
  min_replicas_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.ElasticConfig.min_replicas)
}
...
inline ::google::protobuf::int32 ElasticConfig::max_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.ElasticConfig.max_replicas)
  return max_replicas_;
}
inline void ElasticConfig::set_max_replicas(::google::protobuf::int32 value) {
  
  max_replicas_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.ElasticConfig.max_replicas)
}
...
inline ::google::protobuf::int32 ElasticConfig::nproc_per_node() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.ElasticConfig.nproc_per_node)
  return nproc_per_node_;
}
inline void ElasticConfig::set_nproc_per_node(::google::protobuf::int32 value) {
  
  nproc_per_node_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.ElasticConfig.nproc_per_node)
}
...
inline ::google::protobuf::int32 ElasticConfig::max_restarts() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.ElasticConfig.max_restarts)
  return max_restarts_;
}
inline void ElasticConfig::set_max_restarts(::google::protobuf::int32 value) {
  
  max_restarts_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.ElasticConfig.max_restarts)
}
...
inline ::google::protobuf::int32 DistributedPyTorchTrainingTask::workers() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedPyTorchTrainingTask.workers)
  return workers_;
}
inline void DistributedPyTorchTrainingTask::set_workers(::google::protobuf::int32 value) {
  
  workers_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.DistributedPyTorchTrainingTask.workers)
}
...
inline const ::nebulaidl::plugins::ElasticConfig& DistributedPyTorchTrainingTask::elastic_config() const {
  const ::nebulaidl::plugins::ElasticConfig* p = elastic_config_;
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.DistributedPyTorchTrainingTask.elastic_config)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::plugins::ElasticConfig*>(
      &::nebulaidl::plugins::_ElasticConfig_default_instance_);
}
inline ::nebulaidl::plugins::ElasticConfig* DistributedPyTorchTrainingTask::release_elastic_config() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.DistributedPyTorchTrainingTask.elastic_config)
  
  ::nebulaidl::plugins::ElasticConfig* temp = elastic_config_;
  elastic_config_ = nullptr;
  return temp;
}
inline ::nebulaidl::plugins::ElasticConfig* DistributedPyTorchTrainingTask::mutable_elastic_config() {
  
  if (elastic_config_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::plugins::ElasticConfig>(GetArenaNoVirtual());
    elastic_config_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.DistributedPyTorchTrainingTask.elastic_config)
  return elastic_config_;
}
inline void DistributedPyTorchTrainingTask::set_allocated_elastic_config(::nebulaidl::plugins::ElasticConfig* elastic_config) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.DistributedPyTorchTrainingTask.elastic_config)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fpytorch_2eproto
