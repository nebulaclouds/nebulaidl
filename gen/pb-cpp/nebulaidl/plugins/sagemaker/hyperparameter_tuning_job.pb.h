...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fsagemaker_2fhyperparameter_5ftuning_5fjob_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fsagemaker_2fhyperparameter_5ftuning_5fjob_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2fsagemaker_2fhyperparameter_5ftuning_5fjob_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2fsagemaker_2fhyperparameter_5ftuning_5fjob_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::sagemaker::HyperparameterTuningJob* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::HyperparameterTuningJob>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::HyperparameterTuningJobConfig* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::HyperparameterTuningJobConfig>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class HyperparameterTuningJob final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.HyperparameterTuningJob) */ {
 public:
  ...
  const ::nebulaidl::plugins::sagemaker::TrainingJob& training_job() const;
  ::nebulaidl::plugins::sagemaker::TrainingJob* release_training_job();
  ::nebulaidl::plugins::sagemaker::TrainingJob* mutable_training_job();
  void set_allocated_training_job(::nebulaidl::plugins::sagemaker::TrainingJob* training_job);
 ...
 private:
  ...
  ::nebulaidl::plugins::sagemaker::TrainingJob* training_job_;
  ::google::protobuf::int64 max_number_of_training_jobs_;
  ::google::protobuf::int64 max_parallel_training_jobs_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fplugins_2fsagemaker_2fhyperparameter_5ftuning_5fjob_2eproto;
};
// -------------------------------------------------------------------

class HyperparameterTuningObjectiveType final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.HyperparameterTuningObjectiveType) */ {
 public:
...
class HyperparameterTuningObjective final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective) */ {
 public:
  ...
  ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value objective_type() const;
  void set_objective_type(::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value value);
...
class HyperparameterTuningStrategy final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.HyperparameterTuningStrategy) */ {
 public:
...
class TrainingJobEarlyStoppingType final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.TrainingJobEarlyStoppingType) */ {
 public:
...
class HyperparameterTuningJobConfig final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig) */ {
 public:
  ...
  const ::nebulaidl::plugins::sagemaker::ParameterRanges& hyperparameter_ranges() const;
  ::nebulaidl::plugins::sagemaker::ParameterRanges* release_hyperparameter_ranges();
  ::nebulaidl::plugins::sagemaker::ParameterRanges* mutable_hyperparameter_ranges();
  void set_allocated_hyperparameter_ranges(::nebulaidl::plugins::sagemaker::ParameterRanges* hyperparameter_ranges);
  ...
  const ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective& tuning_objective() const;
  ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* release_tuning_objective();
  ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* mutable_tuning_objective();
  void set_allocated_tuning_objective(::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* tuning_objective);
  ...
  ::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value tuning_strategy() const;
  void set_tuning_strategy(::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value value);
  ...
  ::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value training_job_early_stopping_type() const;
  void set_training_job_early_stopping_type(::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::nebulaidl::plugins::sagemaker::ParameterRanges* hyperparameter_ranges_;
  ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* tuning_objective_;
...
inline const ::nebulaidl::plugins::sagemaker::TrainingJob& HyperparameterTuningJob::training_job() const {
  const ::nebulaidl::plugins::sagemaker::TrainingJob* p = training_job_;
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.training_job)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::plugins::sagemaker::TrainingJob*>(
      &::nebulaidl::plugins::sagemaker::_TrainingJob_default_instance_);
}
inline ::nebulaidl::plugins::sagemaker::TrainingJob* HyperparameterTuningJob::release_training_job() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.training_job)
  
  ::nebulaidl::plugins::sagemaker::TrainingJob* temp = training_job_;
  training_job_ = nullptr;
  return temp;
}
inline ::nebulaidl::plugins::sagemaker::TrainingJob* HyperparameterTuningJob::mutable_training_job() {
  
  if (training_job_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::plugins::sagemaker::TrainingJob>(GetArenaNoVirtual());
    training_job_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.training_job)
  return training_job_;
}
inline void HyperparameterTuningJob::set_allocated_training_job(::nebulaidl::plugins::sagemaker::TrainingJob* training_job) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.training_job)
}
...
inline ::google::protobuf::int64 HyperparameterTuningJob::max_number_of_training_jobs() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.max_number_of_training_jobs)
...
inline void HyperparameterTuningJob::set_max_number_of_training_jobs(::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.max_number_of_training_jobs)
}
...
inline ::google::protobuf::int64 HyperparameterTuningJob::max_parallel_training_jobs() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.max_parallel_training_jobs)
...
inline void HyperparameterTuningJob::set_max_parallel_training_jobs(::google::protobuf::int64 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.HyperparameterTuningJob.max_parallel_training_jobs)
}
...
inline ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value HyperparameterTuningObjective::objective_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.objective_type)
  return static_cast< ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value >(objective_type_);
}
inline void HyperparameterTuningObjective::set_objective_type(::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value value) {
  
  objective_type_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.objective_type)
}
...
inline const ::std::string& HyperparameterTuningObjective::metric_name() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
...
inline void HyperparameterTuningObjective::set_metric_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
}
#if LANG_CXX11
inline void HyperparameterTuningObjective::set_metric_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
}
#endif
inline void HyperparameterTuningObjective::set_metric_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
}
inline void HyperparameterTuningObjective::set_metric_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
}
inline ::std::string* HyperparameterTuningObjective::mutable_metric_name() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
...
inline ::std::string* HyperparameterTuningObjective::release_metric_name() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
...
inline void HyperparameterTuningObjective::set_allocated_metric_name(::std::string* metric_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.sagemaker.HyperparameterTuningObjective.metric_name)
}
...
inline const ::nebulaidl::plugins::sagemaker::ParameterRanges& HyperparameterTuningJobConfig::hyperparameter_ranges() const {
  const ::nebulaidl::plugins::sagemaker::ParameterRanges* p = hyperparameter_ranges_;
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.hyperparameter_ranges)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::plugins::sagemaker::ParameterRanges*>(
      &::nebulaidl::plugins::sagemaker::_ParameterRanges_default_instance_);
}
inline ::nebulaidl::plugins::sagemaker::ParameterRanges* HyperparameterTuningJobConfig::release_hyperparameter_ranges() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.hyperparameter_ranges)
  
  ::nebulaidl::plugins::sagemaker::ParameterRanges* temp = hyperparameter_ranges_;
  hyperparameter_ranges_ = nullptr;
  return temp;
}
inline ::nebulaidl::plugins::sagemaker::ParameterRanges* HyperparameterTuningJobConfig::mutable_hyperparameter_ranges() {
  
  if (hyperparameter_ranges_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::plugins::sagemaker::ParameterRanges>(GetArenaNoVirtual());
    hyperparameter_ranges_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.hyperparameter_ranges)
  return hyperparameter_ranges_;
}
inline void HyperparameterTuningJobConfig::set_allocated_hyperparameter_ranges(::nebulaidl::plugins::sagemaker::ParameterRanges* hyperparameter_ranges) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.hyperparameter_ranges)
}
...
inline ::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value HyperparameterTuningJobConfig::tuning_strategy() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.tuning_strategy)
  return static_cast< ::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value >(tuning_strategy_);
}
inline void HyperparameterTuningJobConfig::set_tuning_strategy(::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value value) {
  
  tuning_strategy_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.tuning_strategy)
}
...
inline const ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective& HyperparameterTuningJobConfig::tuning_objective() const {
  const ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* p = tuning_objective_;
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.tuning_objective)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective*>(
      &::nebulaidl::plugins::sagemaker::_HyperparameterTuningObjective_default_instance_);
}
inline ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* HyperparameterTuningJobConfig::release_tuning_objective() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.tuning_objective)
  
  ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* temp = tuning_objective_;
  tuning_objective_ = nullptr;
  return temp;
}
inline ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* HyperparameterTuningJobConfig::mutable_tuning_objective() {
  
  if (tuning_objective_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective>(GetArenaNoVirtual());
    tuning_objective_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.tuning_objective)
  return tuning_objective_;
}
inline void HyperparameterTuningJobConfig::set_allocated_tuning_objective(::nebulaidl::plugins::sagemaker::HyperparameterTuningObjective* tuning_objective) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete tuning_objective_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.tuning_objective)
}
...
inline ::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value HyperparameterTuningJobConfig::training_job_early_stopping_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.training_job_early_stopping_type)
  return static_cast< ::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value >(training_job_early_stopping_type_);
}
inline void HyperparameterTuningJobConfig::set_training_job_early_stopping_type(::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value value) {
  
  training_job_early_stopping_type_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.HyperparameterTuningJobConfig.training_job_early_stopping_type)
}
...
template <> struct is_proto_enum< ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value>() {
  return ::nebulaidl::plugins::sagemaker::HyperparameterTuningObjectiveType_Value_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value>() {
  return ::nebulaidl::plugins::sagemaker::HyperparameterTuningStrategy_Value_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value>() {
  return ::nebulaidl::plugins::sagemaker::TrainingJobEarlyStoppingType_Value_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fsagemaker_2fhyperparameter_5ftuning_5fjob_2eproto
