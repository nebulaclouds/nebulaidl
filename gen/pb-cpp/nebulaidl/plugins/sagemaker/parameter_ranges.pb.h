...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fsagemaker_2fparameter_5franges_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fsagemaker_2fparameter_5franges_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2fsagemaker_2fparameter_5franges_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2fsagemaker_2fparameter_5franges_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::sagemaker::CategoricalParameterRange* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::CategoricalParameterRange>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::ContinuousParameterRange* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::ContinuousParameterRange>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::HyperparameterScalingType* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::HyperparameterScalingType>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::IntegerParameterRange* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::IntegerParameterRange>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::ParameterRangeOneOf* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::ParameterRangeOneOf>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::ParameterRanges* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::ParameterRanges>(Arena*);
template<> ::nebulaidl::plugins::sagemaker::ParameterRanges_ParameterRangeMapEntry_DoNotUse* Arena::CreateMaybeMessage<::nebulaidl::plugins::sagemaker::ParameterRanges_ParameterRangeMapEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class HyperparameterScalingType final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.HyperparameterScalingType) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fplugins_2fsagemaker_2fparameter_5franges_2eproto;
};
// -------------------------------------------------------------------

class ContinuousParameterRange final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.ContinuousParameterRange) */ {
 public:
  ...
  ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value scaling_type() const;
  void set_scaling_type(::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value value);
...
class IntegerParameterRange final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.IntegerParameterRange) */ {
 public:
...
class CategoricalParameterRange final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.CategoricalParameterRange) */ {
 public:
...
class ParameterRangeOneOf final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.ParameterRangeOneOf) */ {
 public:
  ParameterRangeOneOf();
  ...
  const ::nebulaidl::plugins::sagemaker::ContinuousParameterRange& continuous_parameter_range() const;
  ::nebulaidl::plugins::sagemaker::ContinuousParameterRange* release_continuous_parameter_range();
  ::nebulaidl::plugins::sagemaker::ContinuousParameterRange* mutable_continuous_parameter_range();
  void set_allocated_continuous_parameter_range(::nebulaidl::plugins::sagemaker::ContinuousParameterRange* continuous_parameter_range);
  ...
  const ::nebulaidl::plugins::sagemaker::IntegerParameterRange& integer_parameter_range() const;
  ::nebulaidl::plugins::sagemaker::IntegerParameterRange* release_integer_parameter_range();
  ::nebulaidl::plugins::sagemaker::IntegerParameterRange* mutable_integer_parameter_range();
  void set_allocated_integer_parameter_range(::nebulaidl::plugins::sagemaker::IntegerParameterRange* integer_parameter_range);
  ...
  const ::nebulaidl::plugins::sagemaker::CategoricalParameterRange& categorical_parameter_range() const;
  ::nebulaidl::plugins::sagemaker::CategoricalParameterRange* release_categorical_parameter_range();
  ::nebulaidl::plugins::sagemaker::CategoricalParameterRange* mutable_categorical_parameter_range();
  void set_allocated_categorical_parameter_range(::nebulaidl::plugins::sagemaker::CategoricalParameterRange* categorical_parameter_range);
 ...
 private:
  ...
  union ParameterRangeTypeUnion {
    ...
    ::nebulaidl::plugins::sagemaker::ContinuousParameterRange* continuous_parameter_range_;
    ::nebulaidl::plugins::sagemaker::IntegerParameterRange* integer_parameter_range_;
    ::nebulaidl::plugins::sagemaker::CategoricalParameterRange* categorical_parameter_range_;
...
class ParameterRanges final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.sagemaker.ParameterRanges) */ {
 public:
  ParameterRanges();
  ...
  const ::google::protobuf::Map< ::std::string, ::nebulaidl::plugins::sagemaker::ParameterRangeOneOf >&
      parameter_range_map() const;
  ::google::protobuf::Map< ::std::string, ::nebulaidl::plugins::sagemaker::ParameterRangeOneOf >*
...
inline double ContinuousParameterRange::max_value() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.ContinuousParameterRange.max_value)
  return max_value_;
}
inline void ContinuousParameterRange::set_max_value(double value) {
  
  max_value_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.ContinuousParameterRange.max_value)
}
...
inline double ContinuousParameterRange::min_value() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.ContinuousParameterRange.min_value)
  return min_value_;
}
inline void ContinuousParameterRange::set_min_value(double value) {
  
  min_value_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.ContinuousParameterRange.min_value)
}
...
inline ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value ContinuousParameterRange::scaling_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.ContinuousParameterRange.scaling_type)
  return static_cast< ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value >(scaling_type_);
}
inline void ContinuousParameterRange::set_scaling_type(::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value value) {
  
  scaling_type_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.ContinuousParameterRange.scaling_type)
}
...
inline ::google::protobuf::int64 IntegerParameterRange::max_value() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.IntegerParameterRange.max_value)
  return max_value_;
}
inline void IntegerParameterRange::set_max_value(::google::protobuf::int64 value) {
  
  max_value_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.IntegerParameterRange.max_value)
}
...
inline ::google::protobuf::int64 IntegerParameterRange::min_value() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.IntegerParameterRange.min_value)
  return min_value_;
}
inline void IntegerParameterRange::set_min_value(::google::protobuf::int64 value) {
  
  min_value_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.IntegerParameterRange.min_value)
}
...
inline ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value IntegerParameterRange::scaling_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.IntegerParameterRange.scaling_type)
  return static_cast< ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value >(scaling_type_);
}
inline void IntegerParameterRange::set_scaling_type(::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value value) {
  
  scaling_type_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.IntegerParameterRange.scaling_type)
}
...
inline const ::std::string& CategoricalParameterRange::values(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
  return values_.Get(index);
}
inline ::std::string* CategoricalParameterRange::mutable_values(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
  return values_.Mutable(index);
}
inline void CategoricalParameterRange::set_values(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
...
inline void CategoricalParameterRange::set_values(int index, const char* value) {
  ...
  values_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
}
inline void CategoricalParameterRange::set_values(int index, const char* value, size_t size) {
  values_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
}
inline ::std::string* CategoricalParameterRange::add_values() {
  // @@protoc_insertion_point(field_add_mutable:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
  return values_.Add();
}
inline void CategoricalParameterRange::add_values(const ::std::string& value) {
  values_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
}
#if LANG_CXX11
...
inline void CategoricalParameterRange::add_values(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  values_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
}
inline void CategoricalParameterRange::add_values(const char* value, size_t size) {
  values_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
CategoricalParameterRange::values() const {
  // @@protoc_insertion_point(field_list:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
  return values_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>*
CategoricalParameterRange::mutable_values() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.plugins.sagemaker.CategoricalParameterRange.values)
  return &values_;
}
...
inline ::nebulaidl::plugins::sagemaker::ContinuousParameterRange* ParameterRangeOneOf::release_continuous_parameter_range() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.continuous_parameter_range)
  if (has_continuous_parameter_range()) {
    clear_has_parameter_range_type();
      ::nebulaidl::plugins::sagemaker::ContinuousParameterRange* temp = parameter_range_type_.continuous_parameter_range_;
...
inline const ::nebulaidl::plugins::sagemaker::ContinuousParameterRange& ParameterRangeOneOf::continuous_parameter_range() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.continuous_parameter_range)
  return has_continuous_parameter_range()
      ? *parameter_range_type_.continuous_parameter_range_
      : *reinterpret_cast< ::nebulaidl::plugins::sagemaker::ContinuousParameterRange*>(&::nebulaidl::plugins::sagemaker::_ContinuousParameterRange_default_instance_);
}
inline ::nebulaidl::plugins::sagemaker::ContinuousParameterRange* ParameterRangeOneOf::mutable_continuous_parameter_range() {
  if (!has_continuous_parameter_range()) {
    clear_parameter_range_type();
    set_has_continuous_parameter_range();
    parameter_range_type_.continuous_parameter_range_ = CreateMaybeMessage< ::nebulaidl::plugins::sagemaker::ContinuousParameterRange >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.continuous_parameter_range)
...
inline ::nebulaidl::plugins::sagemaker::IntegerParameterRange* ParameterRangeOneOf::release_integer_parameter_range() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.integer_parameter_range)
  if (has_integer_parameter_range()) {
    clear_has_parameter_range_type();
      ::nebulaidl::plugins::sagemaker::IntegerParameterRange* temp = parameter_range_type_.integer_parameter_range_;
...
inline const ::nebulaidl::plugins::sagemaker::IntegerParameterRange& ParameterRangeOneOf::integer_parameter_range() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.integer_parameter_range)
  return has_integer_parameter_range()
      ? *parameter_range_type_.integer_parameter_range_
      : *reinterpret_cast< ::nebulaidl::plugins::sagemaker::IntegerParameterRange*>(&::nebulaidl::plugins::sagemaker::_IntegerParameterRange_default_instance_);
}
inline ::nebulaidl::plugins::sagemaker::IntegerParameterRange* ParameterRangeOneOf::mutable_integer_parameter_range() {
  if (!has_integer_parameter_range()) {
    clear_parameter_range_type();
    set_has_integer_parameter_range();
    parameter_range_type_.integer_parameter_range_ = CreateMaybeMessage< ::nebulaidl::plugins::sagemaker::IntegerParameterRange >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.integer_parameter_range)
...
inline ::nebulaidl::plugins::sagemaker::CategoricalParameterRange* ParameterRangeOneOf::release_categorical_parameter_range() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.categorical_parameter_range)
  if (has_categorical_parameter_range()) {
    clear_has_parameter_range_type();
      ::nebulaidl::plugins::sagemaker::CategoricalParameterRange* temp = parameter_range_type_.categorical_parameter_range_;
...
inline const ::nebulaidl::plugins::sagemaker::CategoricalParameterRange& ParameterRangeOneOf::categorical_parameter_range() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.categorical_parameter_range)
  return has_categorical_parameter_range()
      ? *parameter_range_type_.categorical_parameter_range_
      : *reinterpret_cast< ::nebulaidl::plugins::sagemaker::CategoricalParameterRange*>(&::nebulaidl::plugins::sagemaker::_CategoricalParameterRange_default_instance_);
}
inline ::nebulaidl::plugins::sagemaker::CategoricalParameterRange* ParameterRangeOneOf::mutable_categorical_parameter_range() {
  if (!has_categorical_parameter_range()) {
    clear_parameter_range_type();
    set_has_categorical_parameter_range();
    parameter_range_type_.categorical_parameter_range_ = CreateMaybeMessage< ::nebulaidl::plugins::sagemaker::CategoricalParameterRange >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.sagemaker.ParameterRangeOneOf.categorical_parameter_range)
...
inline const ::google::protobuf::Map< ::std::string, ::nebulaidl::plugins::sagemaker::ParameterRangeOneOf >&
ParameterRanges::parameter_range_map() const {
  // @@protoc_insertion_point(field_map:nebulaidl.plugins.sagemaker.ParameterRanges.parameter_range_map)
  return parameter_range_map_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::nebulaidl::plugins::sagemaker::ParameterRangeOneOf >*
ParameterRanges::mutable_parameter_range_map() {
  // @@protoc_insertion_point(field_mutable_map:nebulaidl.plugins.sagemaker.ParameterRanges.parameter_range_map)
...
template <> struct is_proto_enum< ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value>() {
  return ::nebulaidl::plugins::sagemaker::HyperparameterScalingType_Value_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fsagemaker_2fparameter_5franges_2eproto
