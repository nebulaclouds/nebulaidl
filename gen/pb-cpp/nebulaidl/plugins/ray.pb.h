...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fray_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fray_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2fray_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2fray_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::HeadGroupSpec* Arena::CreateMaybeMessage<::nebulaidl::plugins::HeadGroupSpec>(Arena*);
template<> ::nebulaidl::plugins::HeadGroupSpec_RayStartParamsEntry_DoNotUse* Arena::CreateMaybeMessage<::nebulaidl::plugins::HeadGroupSpec_RayStartParamsEntry_DoNotUse>(Arena*);
template<> ::nebulaidl::plugins::RayCluster* Arena::CreateMaybeMessage<::nebulaidl::plugins::RayCluster>(Arena*);
template<> ::nebulaidl::plugins::RayJob* Arena::CreateMaybeMessage<::nebulaidl::plugins::RayJob>(Arena*);
template<> ::nebulaidl::plugins::WorkerGroupSpec* Arena::CreateMaybeMessage<::nebulaidl::plugins::WorkerGroupSpec>(Arena*);
template<> ::nebulaidl::plugins::WorkerGroupSpec_RayStartParamsEntry_DoNotUse* Arena::CreateMaybeMessage<::nebulaidl::plugins::WorkerGroupSpec_RayStartParamsEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class RayJob final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.RayJob) */ {
 public:
  RayJob();
  virtual ~RayJob();
  ...
  const ::nebulaidl::plugins::RayCluster& ray_cluster() const;
  ::nebulaidl::plugins::RayCluster* release_ray_cluster();
  ::nebulaidl::plugins::RayCluster* mutable_ray_cluster();
  void set_allocated_ray_cluster(::nebulaidl::plugins::RayCluster* ray_cluster);
 ...
 private:
  ...
  ::nebulaidl::plugins::RayCluster* ray_cluster_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fplugins_2fray_2eproto;
};
// -------------------------------------------------------------------

class RayCluster final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.RayCluster) */ {
 public:
  RayCluster();
  virtual ~RayCluster();
  ...
  ::nebulaidl::plugins::WorkerGroupSpec* mutable_worker_group_spec(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::plugins::WorkerGroupSpec >*
      mutable_worker_group_spec();
  const ::nebulaidl::plugins::WorkerGroupSpec& worker_group_spec(int index) const;
  ::nebulaidl::plugins::WorkerGroupSpec* add_worker_group_spec();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::plugins::WorkerGroupSpec >&
  ...
  const ::nebulaidl::plugins::HeadGroupSpec& head_group_spec() const;
  ::nebulaidl::plugins::HeadGroupSpec* release_head_group_spec();
  ::nebulaidl::plugins::HeadGroupSpec* mutable_head_group_spec();
  void set_allocated_head_group_spec(::nebulaidl::plugins::HeadGroupSpec* head_group_spec);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::plugins::WorkerGroupSpec > worker_group_spec_;
  ::nebulaidl::plugins::HeadGroupSpec* head_group_spec_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fplugins_2fray_2eproto;
};
// -------------------------------------------------------------------
...
class HeadGroupSpec final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.HeadGroupSpec) */ {
 public:
  HeadGroupSpec();
...
class WorkerGroupSpec final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.WorkerGroupSpec) */ {
 public:
  WorkerGroupSpec();
...
inline const ::nebulaidl::plugins::RayCluster& RayJob::ray_cluster() const {
  const ::nebulaidl::plugins::RayCluster* p = ray_cluster_;
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.RayJob.ray_cluster)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::plugins::RayCluster*>(
      &::nebulaidl::plugins::_RayCluster_default_instance_);
}
inline ::nebulaidl::plugins::RayCluster* RayJob::release_ray_cluster() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.RayJob.ray_cluster)
  
  ::nebulaidl::plugins::RayCluster* temp = ray_cluster_;
  ray_cluster_ = nullptr;
  return temp;
}
inline ::nebulaidl::plugins::RayCluster* RayJob::mutable_ray_cluster() {
  
  if (ray_cluster_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::plugins::RayCluster>(GetArenaNoVirtual());
    ray_cluster_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.RayJob.ray_cluster)
  return ray_cluster_;
}
inline void RayJob::set_allocated_ray_cluster(::nebulaidl::plugins::RayCluster* ray_cluster) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.RayJob.ray_cluster)
}
...
inline const ::std::string& RayJob::runtime_env() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.RayJob.runtime_env)
...
inline void RayJob::set_runtime_env(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.RayJob.runtime_env)
}
#if LANG_CXX11
inline void RayJob::set_runtime_env(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.RayJob.runtime_env)
}
#endif
inline void RayJob::set_runtime_env(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.RayJob.runtime_env)
}
inline void RayJob::set_runtime_env(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.RayJob.runtime_env)
}
inline ::std::string* RayJob::mutable_runtime_env() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.RayJob.runtime_env)
...
inline ::std::string* RayJob::release_runtime_env() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.RayJob.runtime_env)
...
inline void RayJob::set_allocated_runtime_env(::std::string* runtime_env) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.RayJob.runtime_env)
}
...
inline const ::nebulaidl::plugins::HeadGroupSpec& RayCluster::head_group_spec() const {
  const ::nebulaidl::plugins::HeadGroupSpec* p = head_group_spec_;
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.RayCluster.head_group_spec)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::plugins::HeadGroupSpec*>(
      &::nebulaidl::plugins::_HeadGroupSpec_default_instance_);
}
inline ::nebulaidl::plugins::HeadGroupSpec* RayCluster::release_head_group_spec() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.RayCluster.head_group_spec)
  
  ::nebulaidl::plugins::HeadGroupSpec* temp = head_group_spec_;
  head_group_spec_ = nullptr;
  return temp;
}
inline ::nebulaidl::plugins::HeadGroupSpec* RayCluster::mutable_head_group_spec() {
  
  if (head_group_spec_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::plugins::HeadGroupSpec>(GetArenaNoVirtual());
    head_group_spec_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.RayCluster.head_group_spec)
  return head_group_spec_;
}
inline void RayCluster::set_allocated_head_group_spec(::nebulaidl::plugins::HeadGroupSpec* head_group_spec) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete head_group_spec_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.RayCluster.head_group_spec)
}
...
inline ::nebulaidl::plugins::WorkerGroupSpec* RayCluster::mutable_worker_group_spec(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.RayCluster.worker_group_spec)
  return worker_group_spec_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::plugins::WorkerGroupSpec >*
RayCluster::mutable_worker_group_spec() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.plugins.RayCluster.worker_group_spec)
  return &worker_group_spec_;
}
inline const ::nebulaidl::plugins::WorkerGroupSpec& RayCluster::worker_group_spec(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.RayCluster.worker_group_spec)
  return worker_group_spec_.Get(index);
}
inline ::nebulaidl::plugins::WorkerGroupSpec* RayCluster::add_worker_group_spec() {
  // @@protoc_insertion_point(field_add:nebulaidl.plugins.RayCluster.worker_group_spec)
  return worker_group_spec_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::plugins::WorkerGroupSpec >&
RayCluster::worker_group_spec() const {
  // @@protoc_insertion_point(field_list:nebulaidl.plugins.RayCluster.worker_group_spec)
  return worker_group_spec_;
}
...
HeadGroupSpec::ray_start_params() const {
  // @@protoc_insertion_point(field_map:nebulaidl.plugins.HeadGroupSpec.ray_start_params)
  return ray_start_params_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
HeadGroupSpec::mutable_ray_start_params() {
  // @@protoc_insertion_point(field_mutable_map:nebulaidl.plugins.HeadGroupSpec.ray_start_params)
...
inline const ::std::string& WorkerGroupSpec::group_name() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.WorkerGroupSpec.group_name)
...
inline void WorkerGroupSpec::set_group_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.WorkerGroupSpec.group_name)
}
#if LANG_CXX11
inline void WorkerGroupSpec::set_group_name(::std::string&& value) {
  ...
  group_name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.WorkerGroupSpec.group_name)
}
#endif
inline void WorkerGroupSpec::set_group_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.WorkerGroupSpec.group_name)
}
inline void WorkerGroupSpec::set_group_name(const char* value, size_t size) {
  ...
  group_name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.WorkerGroupSpec.group_name)
}
inline ::std::string* WorkerGroupSpec::mutable_group_name() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.WorkerGroupSpec.group_name)
...
inline ::std::string* WorkerGroupSpec::release_group_name() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.WorkerGroupSpec.group_name)
...
inline void WorkerGroupSpec::set_allocated_group_name(::std::string* group_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.WorkerGroupSpec.group_name)
}
...
inline ::google::protobuf::int32 WorkerGroupSpec::replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.WorkerGroupSpec.replicas)
  return replicas_;
}
inline void WorkerGroupSpec::set_replicas(::google::protobuf::int32 value) {
  
  replicas_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.WorkerGroupSpec.replicas)
}
...
inline ::google::protobuf::int32 WorkerGroupSpec::min_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.WorkerGroupSpec.min_replicas)
  return min_replicas_;
}
inline void WorkerGroupSpec::set_min_replicas(::google::protobuf::int32 value) {
  
  min_replicas_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.WorkerGroupSpec.min_replicas)
}
...
inline ::google::protobuf::int32 WorkerGroupSpec::max_replicas() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.WorkerGroupSpec.max_replicas)
  return max_replicas_;
}
inline void WorkerGroupSpec::set_max_replicas(::google::protobuf::int32 value) {
  
  max_replicas_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.WorkerGroupSpec.max_replicas)
}
...
WorkerGroupSpec::ray_start_params() const {
  // @@protoc_insertion_point(field_map:nebulaidl.plugins.WorkerGroupSpec.ray_start_params)
  return ray_start_params_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
WorkerGroupSpec::mutable_ray_start_params() {
  // @@protoc_insertion_point(field_mutable_map:nebulaidl.plugins.WorkerGroupSpec.ray_start_params)
  return ray_start_params_.MutableMap();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fray_2eproto
