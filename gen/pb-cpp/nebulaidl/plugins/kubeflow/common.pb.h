...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fkubeflow_2fcommon_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fkubeflow_2fcommon_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2fkubeflow_2fcommon_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2fkubeflow_2fcommon_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::kubeflow::RunPolicy* Arena::CreateMaybeMessage<::nebulaidl::plugins::kubeflow::RunPolicy>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class RunPolicy final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.kubeflow.RunPolicy) */ {
 public:
  RunPolicy();
  virtual ~RunPolicy();
  ...
  ::nebulaidl::plugins::kubeflow::CleanPodPolicy clean_pod_policy() const;
  void set_clean_pod_policy(::nebulaidl::plugins::kubeflow::CleanPodPolicy value);
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fplugins_2fkubeflow_2fcommon_2eproto;
};
// ===================================================================
...
inline ::nebulaidl::plugins::kubeflow::CleanPodPolicy RunPolicy::clean_pod_policy() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.kubeflow.RunPolicy.clean_pod_policy)
  return static_cast< ::nebulaidl::plugins::kubeflow::CleanPodPolicy >(clean_pod_policy_);
}
inline void RunPolicy::set_clean_pod_policy(::nebulaidl::plugins::kubeflow::CleanPodPolicy value) {
  
  clean_pod_policy_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.kubeflow.RunPolicy.clean_pod_policy)
}
...
inline ::google::protobuf::int32 RunPolicy::ttl_seconds_after_finished() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.kubeflow.RunPolicy.ttl_seconds_after_finished)
...
inline void RunPolicy::set_ttl_seconds_after_finished(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.kubeflow.RunPolicy.ttl_seconds_after_finished)
}
...
inline ::google::protobuf::int32 RunPolicy::active_deadline_seconds() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.kubeflow.RunPolicy.active_deadline_seconds)
...
inline void RunPolicy::set_active_deadline_seconds(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.kubeflow.RunPolicy.active_deadline_seconds)
}
...
inline ::google::protobuf::int32 RunPolicy::backoff_limit() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.kubeflow.RunPolicy.backoff_limit)
  return backoff_limit_;
}
inline void RunPolicy::set_backoff_limit(::google::protobuf::int32 value) {
  
  backoff_limit_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.kubeflow.RunPolicy.backoff_limit)
}
...
template <> struct is_proto_enum< ::nebulaidl::plugins::kubeflow::RestartPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::plugins::kubeflow::RestartPolicy>() {
  return ::nebulaidl::plugins::kubeflow::RestartPolicy_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::plugins::kubeflow::CleanPodPolicy> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::plugins::kubeflow::CleanPodPolicy>() {
  return ::nebulaidl::plugins::kubeflow::CleanPodPolicy_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fkubeflow_2fcommon_2eproto
