...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fpresto_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fpresto_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fplugins_2fpresto_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fplugins_2fpresto_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::plugins::PrestoQuery* Arena::CreateMaybeMessage<::nebulaidl::plugins::PrestoQuery>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace plugins {
...
class PrestoQuery final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.plugins.PrestoQuery) */ {
 public:
  PrestoQuery();
  virtual ~PrestoQuery();
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fplugins_2fpresto_2eproto;
};
// ===================================================================
...
inline const ::std::string& PrestoQuery::routing_group() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.PrestoQuery.routing_group)
...
inline void PrestoQuery::set_routing_group(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.PrestoQuery.routing_group)
}
#if LANG_CXX11
inline void PrestoQuery::set_routing_group(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.PrestoQuery.routing_group)
}
#endif
inline void PrestoQuery::set_routing_group(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.PrestoQuery.routing_group)
}
inline void PrestoQuery::set_routing_group(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.PrestoQuery.routing_group)
}
inline ::std::string* PrestoQuery::mutable_routing_group() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.PrestoQuery.routing_group)
...
inline ::std::string* PrestoQuery::release_routing_group() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.PrestoQuery.routing_group)
...
inline void PrestoQuery::set_allocated_routing_group(::std::string* routing_group) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.PrestoQuery.routing_group)
}
...
inline const ::std::string& PrestoQuery::catalog() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.PrestoQuery.catalog)
...
inline void PrestoQuery::set_catalog(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.PrestoQuery.catalog)
}
#if LANG_CXX11
inline void PrestoQuery::set_catalog(::std::string&& value) {
  ...
  catalog_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.PrestoQuery.catalog)
}
#endif
inline void PrestoQuery::set_catalog(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.PrestoQuery.catalog)
}
inline void PrestoQuery::set_catalog(const char* value, size_t size) {
  ...
  catalog_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.PrestoQuery.catalog)
}
inline ::std::string* PrestoQuery::mutable_catalog() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.PrestoQuery.catalog)
...
inline ::std::string* PrestoQuery::release_catalog() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.PrestoQuery.catalog)
...
inline void PrestoQuery::set_allocated_catalog(::std::string* catalog) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.PrestoQuery.catalog)
}
...
inline const ::std::string& PrestoQuery::schema() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.PrestoQuery.schema)
...
inline void PrestoQuery::set_schema(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.PrestoQuery.schema)
}
#if LANG_CXX11
inline void PrestoQuery::set_schema(::std::string&& value) {
  ...
  schema_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.PrestoQuery.schema)
}
#endif
inline void PrestoQuery::set_schema(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.PrestoQuery.schema)
}
inline void PrestoQuery::set_schema(const char* value, size_t size) {
  ...
  schema_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.PrestoQuery.schema)
}
inline ::std::string* PrestoQuery::mutable_schema() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.PrestoQuery.schema)
...
inline ::std::string* PrestoQuery::release_schema() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.PrestoQuery.schema)
...
inline void PrestoQuery::set_allocated_schema(::std::string* schema) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.PrestoQuery.schema)
}
...
inline const ::std::string& PrestoQuery::statement() const {
  // @@protoc_insertion_point(field_get:nebulaidl.plugins.PrestoQuery.statement)
...
inline void PrestoQuery::set_statement(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.plugins.PrestoQuery.statement)
}
#if LANG_CXX11
inline void PrestoQuery::set_statement(::std::string&& value) {
  ...
  statement_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.plugins.PrestoQuery.statement)
}
#endif
inline void PrestoQuery::set_statement(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.plugins.PrestoQuery.statement)
}
inline void PrestoQuery::set_statement(const char* value, size_t size) {
  ...
  statement_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.plugins.PrestoQuery.statement)
}
inline ::std::string* PrestoQuery::mutable_statement() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.plugins.PrestoQuery.statement)
...
inline ::std::string* PrestoQuery::release_statement() {
  // @@protoc_insertion_point(field_release:nebulaidl.plugins.PrestoQuery.statement)
...
inline void PrestoQuery::set_allocated_statement(::std::string* statement) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.plugins.PrestoQuery.statement)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fplugins_2fpresto_2eproto
