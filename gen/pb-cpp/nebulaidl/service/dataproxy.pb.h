...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fservice_2fdataproxy_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fservice_2fdataproxy_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fservice_2fdataproxy_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fservice_2fdataproxy_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::service::CreateDownloadLinkRequest* Arena::CreateMaybeMessage<::nebulaidl::service::CreateDownloadLinkRequest>(Arena*);
template<> ::nebulaidl::service::CreateDownloadLinkResponse* Arena::CreateMaybeMessage<::nebulaidl::service::CreateDownloadLinkResponse>(Arena*);
template<> ::nebulaidl::service::CreateDownloadLocationRequest* Arena::CreateMaybeMessage<::nebulaidl::service::CreateDownloadLocationRequest>(Arena*);
template<> ::nebulaidl::service::CreateDownloadLocationResponse* Arena::CreateMaybeMessage<::nebulaidl::service::CreateDownloadLocationResponse>(Arena*);
template<> ::nebulaidl::service::CreateUploadLocationRequest* Arena::CreateMaybeMessage<::nebulaidl::service::CreateUploadLocationRequest>(Arena*);
template<> ::nebulaidl::service::CreateUploadLocationResponse* Arena::CreateMaybeMessage<::nebulaidl::service::CreateUploadLocationResponse>(Arena*);
template<> ::nebulaidl::service::GetDataRequest* Arena::CreateMaybeMessage<::nebulaidl::service::GetDataRequest>(Arena*);
template<> ::nebulaidl::service::GetDataResponse* Arena::CreateMaybeMessage<::nebulaidl::service::GetDataResponse>(Arena*);
template<> ::nebulaidl::service::PreSignedURLs* Arena::CreateMaybeMessage<::nebulaidl::service::PreSignedURLs>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace service {
...
class CreateUploadLocationResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.CreateUploadLocationResponse) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fservice_2fdataproxy_2eproto;
};
// -------------------------------------------------------------------

class CreateUploadLocationRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.CreateUploadLocationRequest) */ {
 public:
...
class CreateDownloadLocationRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.CreateDownloadLocationRequest) */ {
 public:
...
class CreateDownloadLocationResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.CreateDownloadLocationResponse) */ {
 public:
...
class CreateDownloadLinkRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.CreateDownloadLinkRequest) */ {
 public:
  ...
  ::nebulaidl::service::ArtifactType artifact_type() const;
  void set_artifact_type(::nebulaidl::service::ArtifactType value);
...
class CreateDownloadLinkResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.CreateDownloadLinkResponse) */ {
 public:
  ...
  const ::nebulaidl::service::PreSignedURLs& pre_signed_urls() const;
  ::nebulaidl::service::PreSignedURLs* release_pre_signed_urls();
  ::nebulaidl::service::PreSignedURLs* mutable_pre_signed_urls();
  void set_allocated_pre_signed_urls(::nebulaidl::service::PreSignedURLs* pre_signed_urls);
 ...
 private:
  ...
  ::google::protobuf::Timestamp* expires_at_;
  ::nebulaidl::service::PreSignedURLs* pre_signed_urls_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fservice_2fdataproxy_2eproto;
};
// -------------------------------------------------------------------
...
class PreSignedURLs final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.PreSignedURLs) */ {
 public:
  PreSignedURLs();
...
class GetDataRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.GetDataRequest) */ {
 public:
  GetDataRequest();
  ...
  // string nebula_url = 1;
  void clear_nebula_url();
  static const int kNebulaUrlFieldNumber = 1;
  const ::std::string& nebula_url() const;
  void set_nebula_url(const ::std::string& value);
  #if LANG_CXX11
  void set_nebula_url(::std::string&& value);
  #endif
  void set_nebula_url(const char* value);
  void set_nebula_url(const char* value, size_t size);
  ::std::string* mutable_nebula_url();
  ::std::string* release_nebula_url();
  void set_allocated_nebula_url(::std::string* nebula_url);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::ArenaStringPtr nebula_url_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fservice_2fdataproxy_2eproto;
};
// -------------------------------------------------------------------
...
class GetDataResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.service.GetDataResponse) */ {
 public:
  GetDataResponse();
  ...
  const ::nebulaidl::core::LiteralMap& literal_map() const;
  ::nebulaidl::core::LiteralMap* release_literal_map();
  ::nebulaidl::core::LiteralMap* mutable_literal_map();
  void set_allocated_literal_map(::nebulaidl::core::LiteralMap* literal_map);
  ...
  const ::nebulaidl::core::Literal& literal() const;
  ::nebulaidl::core::Literal* release_literal();
  ::nebulaidl::core::Literal* mutable_literal();
  void set_allocated_literal(::nebulaidl::core::Literal* literal);
 ...
 private:
  ...
  union DataUnion {
    DataUnion() {}
    ::nebulaidl::core::LiteralMap* literal_map_;
    ::nebulaidl::service::PreSignedURLs* pre_signed_urls_;
    ::nebulaidl::core::Literal* literal_;
  } data_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::uint32 _oneof_case_[1];
...
inline const ::std::string& CreateUploadLocationResponse::signed_url() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationResponse.signed_url)
...
inline void CreateUploadLocationResponse::set_signed_url(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateUploadLocationResponse.signed_url)
}
#if LANG_CXX11
inline void CreateUploadLocationResponse::set_signed_url(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateUploadLocationResponse.signed_url)
}
#endif
inline void CreateUploadLocationResponse::set_signed_url(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateUploadLocationResponse.signed_url)
}
inline void CreateUploadLocationResponse::set_signed_url(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateUploadLocationResponse.signed_url)
}
inline ::std::string* CreateUploadLocationResponse::mutable_signed_url() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationResponse.signed_url)
...
inline ::std::string* CreateUploadLocationResponse::release_signed_url() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationResponse.signed_url)
...
inline void CreateUploadLocationResponse::set_allocated_signed_url(::std::string* signed_url) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationResponse.signed_url)
}
...
inline const ::std::string& CreateUploadLocationResponse::native_url() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationResponse.native_url)
...
inline void CreateUploadLocationResponse::set_native_url(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateUploadLocationResponse.native_url)
}
#if LANG_CXX11
inline void CreateUploadLocationResponse::set_native_url(::std::string&& value) {
  ...
  native_url_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateUploadLocationResponse.native_url)
}
#endif
inline void CreateUploadLocationResponse::set_native_url(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateUploadLocationResponse.native_url)
}
inline void CreateUploadLocationResponse::set_native_url(const char* value, size_t size) {
  ...
  native_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateUploadLocationResponse.native_url)
}
inline ::std::string* CreateUploadLocationResponse::mutable_native_url() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationResponse.native_url)
...
inline ::std::string* CreateUploadLocationResponse::release_native_url() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationResponse.native_url)
...
inline void CreateUploadLocationResponse::set_allocated_native_url(::std::string* native_url) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationResponse.native_url)
}
...
inline const ::google::protobuf::Timestamp& CreateUploadLocationResponse::expires_at() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationResponse.expires_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* CreateUploadLocationResponse::release_expires_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationResponse.expires_at)
...
inline ::google::protobuf::Timestamp* CreateUploadLocationResponse::mutable_expires_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationResponse.expires_at)
  return expires_at_;
}
inline void CreateUploadLocationResponse::set_allocated_expires_at(::google::protobuf::Timestamp* expires_at) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationResponse.expires_at)
}
...
inline const ::std::string& CreateUploadLocationRequest::project() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationRequest.project)
...
inline void CreateUploadLocationRequest::set_project(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateUploadLocationRequest.project)
}
#if LANG_CXX11
inline void CreateUploadLocationRequest::set_project(::std::string&& value) {
  ...
  project_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateUploadLocationRequest.project)
}
#endif
inline void CreateUploadLocationRequest::set_project(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateUploadLocationRequest.project)
}
inline void CreateUploadLocationRequest::set_project(const char* value, size_t size) {
  ...
  project_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateUploadLocationRequest.project)
}
inline ::std::string* CreateUploadLocationRequest::mutable_project() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationRequest.project)
...
inline ::std::string* CreateUploadLocationRequest::release_project() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationRequest.project)
...
inline void CreateUploadLocationRequest::set_allocated_project(::std::string* project) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationRequest.project)
}
...
inline const ::std::string& CreateUploadLocationRequest::domain() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationRequest.domain)
  return domain_.GetNoArena();
}
inline void CreateUploadLocationRequest::set_domain(const ::std::string& value) {
  
  domain_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateUploadLocationRequest.domain)
}
#if LANG_CXX11
inline void CreateUploadLocationRequest::set_domain(::std::string&& value) {
  ...
  domain_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateUploadLocationRequest.domain)
}
#endif
inline void CreateUploadLocationRequest::set_domain(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateUploadLocationRequest.domain)
}
inline void CreateUploadLocationRequest::set_domain(const char* value, size_t size) {
  
  domain_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateUploadLocationRequest.domain)
}
inline ::std::string* CreateUploadLocationRequest::mutable_domain() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationRequest.domain)
  return domain_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CreateUploadLocationRequest::release_domain() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationRequest.domain)
...
inline void CreateUploadLocationRequest::set_allocated_domain(::std::string* domain) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationRequest.domain)
}
...
inline const ::std::string& CreateUploadLocationRequest::filename() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationRequest.filename)
  return filename_.GetNoArena();
}
inline void CreateUploadLocationRequest::set_filename(const ::std::string& value) {
  
  filename_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateUploadLocationRequest.filename)
}
#if LANG_CXX11
inline void CreateUploadLocationRequest::set_filename(::std::string&& value) {
  ...
  filename_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateUploadLocationRequest.filename)
}
#endif
inline void CreateUploadLocationRequest::set_filename(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateUploadLocationRequest.filename)
}
inline void CreateUploadLocationRequest::set_filename(const char* value, size_t size) {
  
  filename_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateUploadLocationRequest.filename)
}
inline ::std::string* CreateUploadLocationRequest::mutable_filename() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationRequest.filename)
  return filename_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CreateUploadLocationRequest::release_filename() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationRequest.filename)
...
inline void CreateUploadLocationRequest::set_allocated_filename(::std::string* filename) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationRequest.filename)
}
...
inline const ::google::protobuf::Duration& CreateUploadLocationRequest::expires_in() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationRequest.expires_in)
...
inline ::google::protobuf::Duration* CreateUploadLocationRequest::release_expires_in() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationRequest.expires_in)
...
inline ::google::protobuf::Duration* CreateUploadLocationRequest::mutable_expires_in() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationRequest.expires_in)
  return expires_in_;
}
inline void CreateUploadLocationRequest::set_allocated_expires_in(::google::protobuf::Duration* expires_in) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationRequest.expires_in)
}
...
inline const ::std::string& CreateUploadLocationRequest::content_md5() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationRequest.content_md5)
...
inline void CreateUploadLocationRequest::set_content_md5(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateUploadLocationRequest.content_md5)
}
#if LANG_CXX11
inline void CreateUploadLocationRequest::set_content_md5(::std::string&& value) {
  ...
  content_md5_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateUploadLocationRequest.content_md5)
}
#endif
inline void CreateUploadLocationRequest::set_content_md5(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateUploadLocationRequest.content_md5)
}
inline void CreateUploadLocationRequest::set_content_md5(const void* value, size_t size) {
  ...
  content_md5_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateUploadLocationRequest.content_md5)
}
inline ::std::string* CreateUploadLocationRequest::mutable_content_md5() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationRequest.content_md5)
...
inline ::std::string* CreateUploadLocationRequest::release_content_md5() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationRequest.content_md5)
...
inline void CreateUploadLocationRequest::set_allocated_content_md5(::std::string* content_md5) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationRequest.content_md5)
}
...
inline const ::std::string& CreateUploadLocationRequest::filename_root() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateUploadLocationRequest.filename_root)
...
inline void CreateUploadLocationRequest::set_filename_root(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateUploadLocationRequest.filename_root)
}
#if LANG_CXX11
inline void CreateUploadLocationRequest::set_filename_root(::std::string&& value) {
  ...
  filename_root_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateUploadLocationRequest.filename_root)
}
#endif
inline void CreateUploadLocationRequest::set_filename_root(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateUploadLocationRequest.filename_root)
}
inline void CreateUploadLocationRequest::set_filename_root(const char* value, size_t size) {
  ...
  filename_root_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateUploadLocationRequest.filename_root)
}
inline ::std::string* CreateUploadLocationRequest::mutable_filename_root() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateUploadLocationRequest.filename_root)
...
inline ::std::string* CreateUploadLocationRequest::release_filename_root() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateUploadLocationRequest.filename_root)
...
inline void CreateUploadLocationRequest::set_allocated_filename_root(::std::string* filename_root) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateUploadLocationRequest.filename_root)
}
...
inline const ::std::string& CreateDownloadLocationRequest::native_url() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLocationRequest.native_url)
  return native_url_.GetNoArena();
}
inline void CreateDownloadLocationRequest::set_native_url(const ::std::string& value) {
  
  native_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateDownloadLocationRequest.native_url)
}
#if LANG_CXX11
inline void CreateDownloadLocationRequest::set_native_url(::std::string&& value) {
  ...
  native_url_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateDownloadLocationRequest.native_url)
}
#endif
inline void CreateDownloadLocationRequest::set_native_url(const char* value) {
  ...
  native_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateDownloadLocationRequest.native_url)
}
inline void CreateDownloadLocationRequest::set_native_url(const char* value, size_t size) {
  
  native_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateDownloadLocationRequest.native_url)
}
inline ::std::string* CreateDownloadLocationRequest::mutable_native_url() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLocationRequest.native_url)
  return native_url_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CreateDownloadLocationRequest::release_native_url() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLocationRequest.native_url)
...
inline void CreateDownloadLocationRequest::set_allocated_native_url(::std::string* native_url) {
  ...
  native_url_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), native_url);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateDownloadLocationRequest.native_url)
}
...
inline const ::google::protobuf::Duration& CreateDownloadLocationRequest::expires_in() const {
  const ::google::protobuf::Duration* p = expires_in_;
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLocationRequest.expires_in)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Duration*>(
      &::google::protobuf::_Duration_default_instance_);
}
inline ::google::protobuf::Duration* CreateDownloadLocationRequest::release_expires_in() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLocationRequest.expires_in)
...
inline ::google::protobuf::Duration* CreateDownloadLocationRequest::mutable_expires_in() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLocationRequest.expires_in)
  return expires_in_;
}
inline void CreateDownloadLocationRequest::set_allocated_expires_in(::google::protobuf::Duration* expires_in) {
  ...
  expires_in_ = expires_in;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateDownloadLocationRequest.expires_in)
}
...
inline const ::std::string& CreateDownloadLocationResponse::signed_url() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
  return signed_url_.GetNoArena();
}
inline void CreateDownloadLocationResponse::set_signed_url(const ::std::string& value) {
  
  signed_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
}
#if LANG_CXX11
inline void CreateDownloadLocationResponse::set_signed_url(::std::string&& value) {
  ...
  signed_url_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
}
#endif
inline void CreateDownloadLocationResponse::set_signed_url(const char* value) {
  ...
  signed_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
}
inline void CreateDownloadLocationResponse::set_signed_url(const char* value, size_t size) {
  
  signed_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
}
inline ::std::string* CreateDownloadLocationResponse::mutable_signed_url() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
  return signed_url_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CreateDownloadLocationResponse::release_signed_url() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
...
inline void CreateDownloadLocationResponse::set_allocated_signed_url(::std::string* signed_url) {
  ...
  signed_url_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), signed_url);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateDownloadLocationResponse.signed_url)
}
...
inline const ::google::protobuf::Timestamp& CreateDownloadLocationResponse::expires_at() const {
  const ::google::protobuf::Timestamp* p = expires_at_;
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLocationResponse.expires_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* CreateDownloadLocationResponse::release_expires_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLocationResponse.expires_at)
...
inline ::google::protobuf::Timestamp* CreateDownloadLocationResponse::mutable_expires_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLocationResponse.expires_at)
  return expires_at_;
}
inline void CreateDownloadLocationResponse::set_allocated_expires_at(::google::protobuf::Timestamp* expires_at) {
  ...
  expires_at_ = expires_at;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateDownloadLocationResponse.expires_at)
}
...
inline ::nebulaidl::service::ArtifactType CreateDownloadLinkRequest::artifact_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLinkRequest.artifact_type)
  return static_cast< ::nebulaidl::service::ArtifactType >(artifact_type_);
}
inline void CreateDownloadLinkRequest::set_artifact_type(::nebulaidl::service::ArtifactType value) {
  
  artifact_type_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateDownloadLinkRequest.artifact_type)
}
...
inline const ::google::protobuf::Duration& CreateDownloadLinkRequest::expires_in() const {
  const ::google::protobuf::Duration* p = expires_in_;
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLinkRequest.expires_in)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Duration*>(
      &::google::protobuf::_Duration_default_instance_);
}
inline ::google::protobuf::Duration* CreateDownloadLinkRequest::release_expires_in() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLinkRequest.expires_in)
...
inline ::google::protobuf::Duration* CreateDownloadLinkRequest::mutable_expires_in() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLinkRequest.expires_in)
  return expires_in_;
}
inline void CreateDownloadLinkRequest::set_allocated_expires_in(::google::protobuf::Duration* expires_in) {
  ...
  expires_in_ = expires_in;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateDownloadLinkRequest.expires_in)
}
...
inline ::nebulaidl::core::NodeExecutionIdentifier* CreateDownloadLinkRequest::release_node_execution_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLinkRequest.node_execution_id)
  if (has_node_execution_id()) {
    clear_has_source();
      ::nebulaidl::core::NodeExecutionIdentifier* temp = source_.node_execution_id_;
...
inline const ::nebulaidl::core::NodeExecutionIdentifier& CreateDownloadLinkRequest::node_execution_id() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLinkRequest.node_execution_id)
  return has_node_execution_id()
      ? *source_.node_execution_id_
      : *reinterpret_cast< ::nebulaidl::core::NodeExecutionIdentifier*>(&::nebulaidl::core::_NodeExecutionIdentifier_default_instance_);
}
inline ::nebulaidl::core::NodeExecutionIdentifier* CreateDownloadLinkRequest::mutable_node_execution_id() {
  if (!has_node_execution_id()) {
    clear_source();
    set_has_node_execution_id();
    source_.node_execution_id_ = CreateMaybeMessage< ::nebulaidl::core::NodeExecutionIdentifier >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLinkRequest.node_execution_id)
...
inline const ::std::string& CreateDownloadLinkResponse::signed_url(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
  return signed_url_.Get(index);
}
inline ::std::string* CreateDownloadLinkResponse::mutable_signed_url(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
  return signed_url_.Mutable(index);
}
inline void CreateDownloadLinkResponse::set_signed_url(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
...
inline void CreateDownloadLinkResponse::set_signed_url(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  signed_url_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
}
inline void CreateDownloadLinkResponse::set_signed_url(int index, const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
}
inline ::std::string* CreateDownloadLinkResponse::add_signed_url() {
  // @@protoc_insertion_point(field_add_mutable:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
...
inline void CreateDownloadLinkResponse::add_signed_url(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
}
#if LANG_CXX11
...
inline void CreateDownloadLinkResponse::add_signed_url(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  signed_url_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
}
inline void CreateDownloadLinkResponse::add_signed_url(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
CreateDownloadLinkResponse::signed_url() const {
  // @@protoc_insertion_point(field_list:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
  return signed_url_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>*
CreateDownloadLinkResponse::mutable_signed_url() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.service.CreateDownloadLinkResponse.signed_url)
  return &signed_url_;
}
...
inline const ::google::protobuf::Timestamp& CreateDownloadLinkResponse::expires_at() const {
  const ::google::protobuf::Timestamp* p = expires_at_;
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLinkResponse.expires_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* CreateDownloadLinkResponse::release_expires_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLinkResponse.expires_at)
...
inline ::google::protobuf::Timestamp* CreateDownloadLinkResponse::mutable_expires_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLinkResponse.expires_at)
  return expires_at_;
}
inline void CreateDownloadLinkResponse::set_allocated_expires_at(::google::protobuf::Timestamp* expires_at) {
  ...
  expires_at_ = expires_at;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateDownloadLinkResponse.expires_at)
}
...
inline const ::nebulaidl::service::PreSignedURLs& CreateDownloadLinkResponse::pre_signed_urls() const {
  const ::nebulaidl::service::PreSignedURLs* p = pre_signed_urls_;
  // @@protoc_insertion_point(field_get:nebulaidl.service.CreateDownloadLinkResponse.pre_signed_urls)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::service::PreSignedURLs*>(
      &::nebulaidl::service::_PreSignedURLs_default_instance_);
}
inline ::nebulaidl::service::PreSignedURLs* CreateDownloadLinkResponse::release_pre_signed_urls() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.CreateDownloadLinkResponse.pre_signed_urls)
  
  ::nebulaidl::service::PreSignedURLs* temp = pre_signed_urls_;
  pre_signed_urls_ = nullptr;
  return temp;
}
inline ::nebulaidl::service::PreSignedURLs* CreateDownloadLinkResponse::mutable_pre_signed_urls() {
  
  if (pre_signed_urls_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::service::PreSignedURLs>(GetArenaNoVirtual());
    pre_signed_urls_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.CreateDownloadLinkResponse.pre_signed_urls)
  return pre_signed_urls_;
}
inline void CreateDownloadLinkResponse::set_allocated_pre_signed_urls(::nebulaidl::service::PreSignedURLs* pre_signed_urls) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete pre_signed_urls_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.CreateDownloadLinkResponse.pre_signed_urls)
}
...
inline const ::std::string& PreSignedURLs::signed_url(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.PreSignedURLs.signed_url)
  return signed_url_.Get(index);
}
inline ::std::string* PreSignedURLs::mutable_signed_url(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.PreSignedURLs.signed_url)
  return signed_url_.Mutable(index);
}
inline void PreSignedURLs::set_signed_url(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.service.PreSignedURLs.signed_url)
  signed_url_.Mutable(index)->assign(value);
}
#if LANG_CXX11
...
inline void PreSignedURLs::set_signed_url(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  signed_url_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.PreSignedURLs.signed_url)
}
inline void PreSignedURLs::set_signed_url(int index, const char* value, size_t size) {
  signed_url_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.PreSignedURLs.signed_url)
}
inline ::std::string* PreSignedURLs::add_signed_url() {
  // @@protoc_insertion_point(field_add_mutable:nebulaidl.service.PreSignedURLs.signed_url)
  return signed_url_.Add();
}
inline void PreSignedURLs::add_signed_url(const ::std::string& value) {
  signed_url_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:nebulaidl.service.PreSignedURLs.signed_url)
}
#if LANG_CXX11
...
inline void PreSignedURLs::add_signed_url(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  signed_url_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:nebulaidl.service.PreSignedURLs.signed_url)
}
inline void PreSignedURLs::add_signed_url(const char* value, size_t size) {
  signed_url_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:nebulaidl.service.PreSignedURLs.signed_url)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
PreSignedURLs::signed_url() const {
  // @@protoc_insertion_point(field_list:nebulaidl.service.PreSignedURLs.signed_url)
  return signed_url_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>*
PreSignedURLs::mutable_signed_url() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.service.PreSignedURLs.signed_url)
  return &signed_url_;
}
...
inline const ::google::protobuf::Timestamp& PreSignedURLs::expires_at() const {
  const ::google::protobuf::Timestamp* p = expires_at_;
  // @@protoc_insertion_point(field_get:nebulaidl.service.PreSignedURLs.expires_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* PreSignedURLs::release_expires_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.PreSignedURLs.expires_at)
...
inline ::google::protobuf::Timestamp* PreSignedURLs::mutable_expires_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.PreSignedURLs.expires_at)
  return expires_at_;
}
inline void PreSignedURLs::set_allocated_expires_at(::google::protobuf::Timestamp* expires_at) {
  ...
  expires_at_ = expires_at;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.PreSignedURLs.expires_at)
}
...
// string nebula_url = 1;
inline void GetDataRequest::clear_nebula_url() {
  nebula_url_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline const ::std::string& GetDataRequest::nebula_url() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.GetDataRequest.nebula_url)
  return nebula_url_.GetNoArena();
}
inline void GetDataRequest::set_nebula_url(const ::std::string& value) {
  
  nebula_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.service.GetDataRequest.nebula_url)
}
#if LANG_CXX11
inline void GetDataRequest::set_nebula_url(::std::string&& value) {
  
  nebula_url_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.service.GetDataRequest.nebula_url)
}
#endif
inline void GetDataRequest::set_nebula_url(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  nebula_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.service.GetDataRequest.nebula_url)
}
inline void GetDataRequest::set_nebula_url(const char* value, size_t size) {
  
  nebula_url_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.service.GetDataRequest.nebula_url)
}
inline ::std::string* GetDataRequest::mutable_nebula_url() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.GetDataRequest.nebula_url)
  return nebula_url_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* GetDataRequest::release_nebula_url() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.GetDataRequest.nebula_url)
  
  return nebula_url_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline void GetDataRequest::set_allocated_nebula_url(::std::string* nebula_url) {
  if (nebula_url != nullptr) {
    
  } else {
    
  }
  nebula_url_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), nebula_url);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.service.GetDataRequest.nebula_url)
}
...
inline ::nebulaidl::core::LiteralMap* GetDataResponse::release_literal_map() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.GetDataResponse.literal_map)
  if (has_literal_map()) {
    clear_has_data();
      ::nebulaidl::core::LiteralMap* temp = data_.literal_map_;
...
inline const ::nebulaidl::core::LiteralMap& GetDataResponse::literal_map() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.GetDataResponse.literal_map)
  return has_literal_map()
      ? *data_.literal_map_
      : *reinterpret_cast< ::nebulaidl::core::LiteralMap*>(&::nebulaidl::core::_LiteralMap_default_instance_);
}
inline ::nebulaidl::core::LiteralMap* GetDataResponse::mutable_literal_map() {
  if (!has_literal_map()) {
    clear_data();
    set_has_literal_map();
    data_.literal_map_ = CreateMaybeMessage< ::nebulaidl::core::LiteralMap >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.GetDataResponse.literal_map)
...
inline ::nebulaidl::service::PreSignedURLs* GetDataResponse::release_pre_signed_urls() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.GetDataResponse.pre_signed_urls)
  if (has_pre_signed_urls()) {
    clear_has_data();
      ::nebulaidl::service::PreSignedURLs* temp = data_.pre_signed_urls_;
...
inline const ::nebulaidl::service::PreSignedURLs& GetDataResponse::pre_signed_urls() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.GetDataResponse.pre_signed_urls)
  return has_pre_signed_urls()
      ? *data_.pre_signed_urls_
      : *reinterpret_cast< ::nebulaidl::service::PreSignedURLs*>(&::nebulaidl::service::_PreSignedURLs_default_instance_);
}
inline ::nebulaidl::service::PreSignedURLs* GetDataResponse::mutable_pre_signed_urls() {
  if (!has_pre_signed_urls()) {
    clear_data();
    set_has_pre_signed_urls();
    data_.pre_signed_urls_ = CreateMaybeMessage< ::nebulaidl::service::PreSignedURLs >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.GetDataResponse.pre_signed_urls)
...
inline ::nebulaidl::core::Literal* GetDataResponse::release_literal() {
  // @@protoc_insertion_point(field_release:nebulaidl.service.GetDataResponse.literal)
  if (has_literal()) {
    clear_has_data();
      ::nebulaidl::core::Literal* temp = data_.literal_;
...
inline const ::nebulaidl::core::Literal& GetDataResponse::literal() const {
  // @@protoc_insertion_point(field_get:nebulaidl.service.GetDataResponse.literal)
  return has_literal()
      ? *data_.literal_
      : *reinterpret_cast< ::nebulaidl::core::Literal*>(&::nebulaidl::core::_Literal_default_instance_);
}
inline ::nebulaidl::core::Literal* GetDataResponse::mutable_literal() {
  if (!has_literal()) {
    clear_data();
    set_has_literal();
    data_.literal_ = CreateMaybeMessage< ::nebulaidl::core::Literal >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.service.GetDataResponse.literal)
...
template <> struct is_proto_enum< ::nebulaidl::service::ArtifactType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::service::ArtifactType>() {
  return ::nebulaidl::service::ArtifactType_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fservice_2fdataproxy_2eproto
