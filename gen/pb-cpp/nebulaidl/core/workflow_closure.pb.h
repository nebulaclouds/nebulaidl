...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fcore_2fworkflow_5fclosure_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fcore_2fworkflow_5fclosure_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fcore_2fworkflow_5fclosure_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fcore_2fworkflow_5fclosure_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::core::WorkflowClosure* Arena::CreateMaybeMessage<::nebulaidl::core::WorkflowClosure>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace core {
...
class WorkflowClosure final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.WorkflowClosure) */ {
 public:
  WorkflowClosure();
  ...
  const ::nebulaidl::core::WorkflowTemplate& workflow() const;
  ::nebulaidl::core::WorkflowTemplate* release_workflow();
  ::nebulaidl::core::WorkflowTemplate* mutable_workflow();
  void set_allocated_workflow(::nebulaidl::core::WorkflowTemplate* workflow);
 ...
 private:
  ...
  ::nebulaidl::core::WorkflowTemplate* workflow_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fcore_2fworkflow_5fclosure_2eproto;
};
// ===================================================================
...
inline const ::nebulaidl::core::WorkflowTemplate& WorkflowClosure::workflow() const {
  const ::nebulaidl::core::WorkflowTemplate* p = workflow_;
  // @@protoc_insertion_point(field_get:nebulaidl.core.WorkflowClosure.workflow)
...
inline ::nebulaidl::core::WorkflowTemplate* WorkflowClosure::release_workflow() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.WorkflowClosure.workflow)
  
  ::nebulaidl::core::WorkflowTemplate* temp = workflow_;
  workflow_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::WorkflowTemplate* WorkflowClosure::mutable_workflow() {
  
  if (workflow_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::WorkflowTemplate>(GetArenaNoVirtual());
    workflow_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.WorkflowClosure.workflow)
  return workflow_;
}
inline void WorkflowClosure::set_allocated_workflow(::nebulaidl::core::WorkflowTemplate* workflow) {
  ...
  workflow_ = workflow;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.WorkflowClosure.workflow)
}
...
inline ::nebulaidl::core::TaskTemplate* WorkflowClosure::mutable_tasks(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.WorkflowClosure.tasks)
  return tasks_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::core::TaskTemplate >*
WorkflowClosure::mutable_tasks() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.core.WorkflowClosure.tasks)
  return &tasks_;
}
inline const ::nebulaidl::core::TaskTemplate& WorkflowClosure::tasks(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.WorkflowClosure.tasks)
  return tasks_.Get(index);
}
inline ::nebulaidl::core::TaskTemplate* WorkflowClosure::add_tasks() {
  // @@protoc_insertion_point(field_add:nebulaidl.core.WorkflowClosure.tasks)
  return tasks_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::core::TaskTemplate >&
WorkflowClosure::tasks() const {
  // @@protoc_insertion_point(field_list:nebulaidl.core.WorkflowClosure.tasks)
  return tasks_;
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fcore_2fworkflow_5fclosure_2eproto
