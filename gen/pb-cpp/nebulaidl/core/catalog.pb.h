...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fcore_2fcatalog_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fcore_2fcatalog_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fcore_2fcatalog_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fcore_2fcatalog_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::core::CatalogArtifactTag* Arena::CreateMaybeMessage<::nebulaidl::core::CatalogArtifactTag>(Arena*);
template<> ::nebulaidl::core::CatalogMetadata* Arena::CreateMaybeMessage<::nebulaidl::core::CatalogMetadata>(Arena*);
template<> ::nebulaidl::core::CatalogReservation* Arena::CreateMaybeMessage<::nebulaidl::core::CatalogReservation>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace core {
...
class CatalogArtifactTag final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.CatalogArtifactTag) */ {
 public:
  CatalogArtifactTag();
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fcore_2fcatalog_2eproto;
};
// -------------------------------------------------------------------

class CatalogMetadata final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.CatalogMetadata) */ {
 public:
  CatalogMetadata();
  ...
  const ::nebulaidl::core::Identifier& dataset_id() const;
  ::nebulaidl::core::Identifier* release_dataset_id();
  ::nebulaidl::core::Identifier* mutable_dataset_id();
  void set_allocated_dataset_id(::nebulaidl::core::Identifier* dataset_id);
  ...
  const ::nebulaidl::core::CatalogArtifactTag& artifact_tag() const;
  ::nebulaidl::core::CatalogArtifactTag* release_artifact_tag();
  ::nebulaidl::core::CatalogArtifactTag* mutable_artifact_tag();
  void set_allocated_artifact_tag(::nebulaidl::core::CatalogArtifactTag* artifact_tag);
  ...
  const ::nebulaidl::core::TaskExecutionIdentifier& source_task_execution() const;
  ::nebulaidl::core::TaskExecutionIdentifier* release_source_task_execution();
  ::nebulaidl::core::TaskExecutionIdentifier* mutable_source_task_execution();
  void set_allocated_source_task_execution(::nebulaidl::core::TaskExecutionIdentifier* source_task_execution);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::nebulaidl::core::Identifier* dataset_id_;
  ::nebulaidl::core::CatalogArtifactTag* artifact_tag_;
  union SourceExecutionUnion {
    SourceExecutionUnion() {}
    ::nebulaidl::core::TaskExecutionIdentifier* source_task_execution_;
  } source_execution_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
class CatalogReservation final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.CatalogReservation) */ {
 public:
  CatalogReservation();
...
inline const ::std::string& CatalogArtifactTag::artifact_id() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.CatalogArtifactTag.artifact_id)
...
inline void CatalogArtifactTag::set_artifact_id(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.core.CatalogArtifactTag.artifact_id)
}
#if LANG_CXX11
inline void CatalogArtifactTag::set_artifact_id(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.CatalogArtifactTag.artifact_id)
}
#endif
inline void CatalogArtifactTag::set_artifact_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.CatalogArtifactTag.artifact_id)
}
inline void CatalogArtifactTag::set_artifact_id(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.CatalogArtifactTag.artifact_id)
}
inline ::std::string* CatalogArtifactTag::mutable_artifact_id() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.CatalogArtifactTag.artifact_id)
...
inline ::std::string* CatalogArtifactTag::release_artifact_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.CatalogArtifactTag.artifact_id)
...
inline void CatalogArtifactTag::set_allocated_artifact_id(::std::string* artifact_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.CatalogArtifactTag.artifact_id)
}
...
inline const ::std::string& CatalogArtifactTag::name() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.CatalogArtifactTag.name)
  return name_.GetNoArena();
}
inline void CatalogArtifactTag::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.core.CatalogArtifactTag.name)
}
#if LANG_CXX11
inline void CatalogArtifactTag::set_name(::std::string&& value) {
  ...
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.CatalogArtifactTag.name)
}
#endif
inline void CatalogArtifactTag::set_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.CatalogArtifactTag.name)
}
inline void CatalogArtifactTag::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.CatalogArtifactTag.name)
}
inline ::std::string* CatalogArtifactTag::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.CatalogArtifactTag.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* CatalogArtifactTag::release_name() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.CatalogArtifactTag.name)
...
inline void CatalogArtifactTag::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.CatalogArtifactTag.name)
}
...
inline const ::nebulaidl::core::Identifier& CatalogMetadata::dataset_id() const {
  const ::nebulaidl::core::Identifier* p = dataset_id_;
  // @@protoc_insertion_point(field_get:nebulaidl.core.CatalogMetadata.dataset_id)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::Identifier*>(
      &::nebulaidl::core::_Identifier_default_instance_);
}
inline ::nebulaidl::core::Identifier* CatalogMetadata::release_dataset_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.CatalogMetadata.dataset_id)
  
  ::nebulaidl::core::Identifier* temp = dataset_id_;
  dataset_id_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::Identifier* CatalogMetadata::mutable_dataset_id() {
  
  if (dataset_id_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::Identifier>(GetArenaNoVirtual());
    dataset_id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.CatalogMetadata.dataset_id)
  return dataset_id_;
}
inline void CatalogMetadata::set_allocated_dataset_id(::nebulaidl::core::Identifier* dataset_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.CatalogMetadata.dataset_id)
}
...
inline const ::nebulaidl::core::CatalogArtifactTag& CatalogMetadata::artifact_tag() const {
  const ::nebulaidl::core::CatalogArtifactTag* p = artifact_tag_;
  // @@protoc_insertion_point(field_get:nebulaidl.core.CatalogMetadata.artifact_tag)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::CatalogArtifactTag*>(
      &::nebulaidl::core::_CatalogArtifactTag_default_instance_);
}
inline ::nebulaidl::core::CatalogArtifactTag* CatalogMetadata::release_artifact_tag() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.CatalogMetadata.artifact_tag)
  
  ::nebulaidl::core::CatalogArtifactTag* temp = artifact_tag_;
  artifact_tag_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::CatalogArtifactTag* CatalogMetadata::mutable_artifact_tag() {
  
  if (artifact_tag_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::CatalogArtifactTag>(GetArenaNoVirtual());
    artifact_tag_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.CatalogMetadata.artifact_tag)
  return artifact_tag_;
}
inline void CatalogMetadata::set_allocated_artifact_tag(::nebulaidl::core::CatalogArtifactTag* artifact_tag) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete artifact_tag_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.CatalogMetadata.artifact_tag)
}
...
inline ::nebulaidl::core::TaskExecutionIdentifier* CatalogMetadata::release_source_task_execution() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.CatalogMetadata.source_task_execution)
  if (has_source_task_execution()) {
    clear_has_source_execution();
      ::nebulaidl::core::TaskExecutionIdentifier* temp = source_execution_.source_task_execution_;
...
inline const ::nebulaidl::core::TaskExecutionIdentifier& CatalogMetadata::source_task_execution() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.CatalogMetadata.source_task_execution)
  return has_source_task_execution()
      ? *source_execution_.source_task_execution_
      : *reinterpret_cast< ::nebulaidl::core::TaskExecutionIdentifier*>(&::nebulaidl::core::_TaskExecutionIdentifier_default_instance_);
}
inline ::nebulaidl::core::TaskExecutionIdentifier* CatalogMetadata::mutable_source_task_execution() {
  if (!has_source_task_execution()) {
    clear_source_execution();
    set_has_source_task_execution();
    source_execution_.source_task_execution_ = CreateMaybeMessage< ::nebulaidl::core::TaskExecutionIdentifier >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.CatalogMetadata.source_task_execution)
...
template <> struct is_proto_enum< ::nebulaidl::core::CatalogReservation_Status> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::CatalogReservation_Status>() {
  return ::nebulaidl::core::CatalogReservation_Status_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::core::CatalogCacheStatus> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::CatalogCacheStatus>() {
  return ::nebulaidl::core::CatalogCacheStatus_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fcore_2fcatalog_2eproto
