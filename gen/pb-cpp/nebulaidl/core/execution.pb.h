...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fcore_2fexecution_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fcore_2fexecution_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fcore_2fexecution_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fcore_2fexecution_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::core::ExecutionError* Arena::CreateMaybeMessage<::nebulaidl::core::ExecutionError>(Arena*);
template<> ::nebulaidl::core::NodeExecution* Arena::CreateMaybeMessage<::nebulaidl::core::NodeExecution>(Arena*);
template<> ::nebulaidl::core::QualityOfService* Arena::CreateMaybeMessage<::nebulaidl::core::QualityOfService>(Arena*);
template<> ::nebulaidl::core::QualityOfServiceSpec* Arena::CreateMaybeMessage<::nebulaidl::core::QualityOfServiceSpec>(Arena*);
template<> ::nebulaidl::core::TaskExecution* Arena::CreateMaybeMessage<::nebulaidl::core::TaskExecution>(Arena*);
template<> ::nebulaidl::core::TaskLog* Arena::CreateMaybeMessage<::nebulaidl::core::TaskLog>(Arena*);
template<> ::nebulaidl::core::WorkflowExecution* Arena::CreateMaybeMessage<::nebulaidl::core::WorkflowExecution>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace core {
...
class WorkflowExecution final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.WorkflowExecution) */ {
 public:
  WorkflowExecution();
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fcore_2fexecution_2eproto;
};
// -------------------------------------------------------------------

class NodeExecution final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.NodeExecution) */ {
 public:
  NodeExecution();
...
class TaskExecution final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.TaskExecution) */ {
 public:
  TaskExecution();
...
class ExecutionError final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.ExecutionError) */ {
 public:
  ExecutionError();
  ...
  ::nebulaidl::core::ExecutionError_ErrorKind kind() const;
  void set_kind(::nebulaidl::core::ExecutionError_ErrorKind value);
...
class TaskLog final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.TaskLog) */ {
 public:
  TaskLog();
  virtual ~TaskLog();
  ...
  ::nebulaidl::core::TaskLog_MessageFormat message_format() const;
  void set_message_format(::nebulaidl::core::TaskLog_MessageFormat value);
...
class QualityOfServiceSpec final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.QualityOfServiceSpec) */ {
 public:
...
class QualityOfService final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.QualityOfService) */ {
 public:
  QualityOfService();
  ...
  ::nebulaidl::core::QualityOfService_Tier tier() const;
  void set_tier(::nebulaidl::core::QualityOfService_Tier value);

  // .nebulaidl.core.QualityOfServiceSpec spec = 2;
  bool has_spec() const;
  void clear_spec();
  static const int kSpecFieldNumber = 2;
  const ::nebulaidl::core::QualityOfServiceSpec& spec() const;
  ::nebulaidl::core::QualityOfServiceSpec* release_spec();
  ::nebulaidl::core::QualityOfServiceSpec* mutable_spec();
  void set_allocated_spec(::nebulaidl::core::QualityOfServiceSpec* spec);
 ...
 private:
  ...
  union DesignationUnion {
    DesignationUnion() {}
    int tier_;
    ::nebulaidl::core::QualityOfServiceSpec* spec_;
  } designation_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
inline const ::std::string& ExecutionError::code() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.ExecutionError.code)
  return code_.GetNoArena();
}
inline void ExecutionError::set_code(const ::std::string& value) {
  
  code_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.core.ExecutionError.code)
}
#if LANG_CXX11
inline void ExecutionError::set_code(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.ExecutionError.code)
}
#endif
inline void ExecutionError::set_code(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.ExecutionError.code)
}
inline void ExecutionError::set_code(const char* value, size_t size) {
  
  code_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.ExecutionError.code)
}
inline ::std::string* ExecutionError::mutable_code() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.ExecutionError.code)
  return code_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ExecutionError::release_code() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.ExecutionError.code)
...
inline void ExecutionError::set_allocated_code(::std::string* code) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.ExecutionError.code)
}
...
inline const ::std::string& ExecutionError::message() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.ExecutionError.message)
  return message_.GetNoArena();
}
inline void ExecutionError::set_message(const ::std::string& value) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.core.ExecutionError.message)
}
#if LANG_CXX11
inline void ExecutionError::set_message(::std::string&& value) {
  ...
  message_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.ExecutionError.message)
}
#endif
inline void ExecutionError::set_message(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.ExecutionError.message)
}
inline void ExecutionError::set_message(const char* value, size_t size) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.ExecutionError.message)
}
inline ::std::string* ExecutionError::mutable_message() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.ExecutionError.message)
  return message_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ExecutionError::release_message() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.ExecutionError.message)
...
inline void ExecutionError::set_allocated_message(::std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.ExecutionError.message)
}
...
inline const ::std::string& ExecutionError::error_uri() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.ExecutionError.error_uri)
...
inline void ExecutionError::set_error_uri(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.core.ExecutionError.error_uri)
}
#if LANG_CXX11
inline void ExecutionError::set_error_uri(::std::string&& value) {
  ...
  error_uri_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.ExecutionError.error_uri)
}
#endif
inline void ExecutionError::set_error_uri(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.ExecutionError.error_uri)
}
inline void ExecutionError::set_error_uri(const char* value, size_t size) {
  ...
  error_uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.ExecutionError.error_uri)
}
inline ::std::string* ExecutionError::mutable_error_uri() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.ExecutionError.error_uri)
...
inline ::std::string* ExecutionError::release_error_uri() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.ExecutionError.error_uri)
...
inline void ExecutionError::set_allocated_error_uri(::std::string* error_uri) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.ExecutionError.error_uri)
}
...
inline ::nebulaidl::core::ExecutionError_ErrorKind ExecutionError::kind() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.ExecutionError.kind)
  return static_cast< ::nebulaidl::core::ExecutionError_ErrorKind >(kind_);
}
inline void ExecutionError::set_kind(::nebulaidl::core::ExecutionError_ErrorKind value) {
  
  kind_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.core.ExecutionError.kind)
}
...
inline const ::std::string& TaskLog::uri() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.TaskLog.uri)
  return uri_.GetNoArena();
}
inline void TaskLog::set_uri(const ::std::string& value) {
  
  uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.core.TaskLog.uri)
}
#if LANG_CXX11
inline void TaskLog::set_uri(::std::string&& value) {
  ...
  uri_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.TaskLog.uri)
}
#endif
inline void TaskLog::set_uri(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.TaskLog.uri)
}
inline void TaskLog::set_uri(const char* value, size_t size) {
  
  uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.TaskLog.uri)
}
inline ::std::string* TaskLog::mutable_uri() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.TaskLog.uri)
  return uri_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TaskLog::release_uri() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.TaskLog.uri)
...
inline void TaskLog::set_allocated_uri(::std::string* uri) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.TaskLog.uri)
}
...
inline const ::std::string& TaskLog::name() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.TaskLog.name)
  return name_.GetNoArena();
}
inline void TaskLog::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.core.TaskLog.name)
}
#if LANG_CXX11
inline void TaskLog::set_name(::std::string&& value) {
  ...
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.TaskLog.name)
}
#endif
inline void TaskLog::set_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.TaskLog.name)
}
inline void TaskLog::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.TaskLog.name)
}
inline ::std::string* TaskLog::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.TaskLog.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TaskLog::release_name() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.TaskLog.name)
...
inline void TaskLog::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.TaskLog.name)
}
...
inline ::nebulaidl::core::TaskLog_MessageFormat TaskLog::message_format() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.TaskLog.message_format)
  return static_cast< ::nebulaidl::core::TaskLog_MessageFormat >(message_format_);
}
inline void TaskLog::set_message_format(::nebulaidl::core::TaskLog_MessageFormat value) {
  
  message_format_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.core.TaskLog.message_format)
}
...
inline const ::google::protobuf::Duration& TaskLog::ttl() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.core.TaskLog.ttl)
...
inline ::google::protobuf::Duration* TaskLog::release_ttl() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.TaskLog.ttl)
...
inline ::google::protobuf::Duration* TaskLog::mutable_ttl() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.TaskLog.ttl)
  return ttl_;
}
inline void TaskLog::set_allocated_ttl(::google::protobuf::Duration* ttl) {
  ...
  ttl_ = ttl;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.TaskLog.ttl)
}
...
inline const ::google::protobuf::Duration& QualityOfServiceSpec::queueing_budget() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.core.QualityOfServiceSpec.queueing_budget)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Duration*>(
      &::google::protobuf::_Duration_default_instance_);
}
inline ::google::protobuf::Duration* QualityOfServiceSpec::release_queueing_budget() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.QualityOfServiceSpec.queueing_budget)
...
inline ::google::protobuf::Duration* QualityOfServiceSpec::mutable_queueing_budget() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.QualityOfServiceSpec.queueing_budget)
...
inline void QualityOfServiceSpec::set_allocated_queueing_budget(::google::protobuf::Duration* queueing_budget) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.QualityOfServiceSpec.queueing_budget)
}
...
inline ::nebulaidl::core::QualityOfService_Tier QualityOfService::tier() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.QualityOfService.tier)
  if (has_tier()) {
    return static_cast< ::nebulaidl::core::QualityOfService_Tier >(designation_.tier_);
  }
  return static_cast< ::nebulaidl::core::QualityOfService_Tier >(0);
}
inline void QualityOfService::set_tier(::nebulaidl::core::QualityOfService_Tier value) {
  if (!has_tier()) {
    clear_designation();
    set_has_tier();
  }
  designation_.tier_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.core.QualityOfService.tier)
}
...
inline ::nebulaidl::core::QualityOfServiceSpec* QualityOfService::release_spec() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.QualityOfService.spec)
  if (has_spec()) {
    clear_has_designation();
      ::nebulaidl::core::QualityOfServiceSpec* temp = designation_.spec_;
...
inline const ::nebulaidl::core::QualityOfServiceSpec& QualityOfService::spec() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.QualityOfService.spec)
  return has_spec()
      ? *designation_.spec_
      : *reinterpret_cast< ::nebulaidl::core::QualityOfServiceSpec*>(&::nebulaidl::core::_QualityOfServiceSpec_default_instance_);
}
inline ::nebulaidl::core::QualityOfServiceSpec* QualityOfService::mutable_spec() {
  if (!has_spec()) {
    clear_designation();
    set_has_spec();
    designation_.spec_ = CreateMaybeMessage< ::nebulaidl::core::QualityOfServiceSpec >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.QualityOfService.spec)
...
template <> struct is_proto_enum< ::nebulaidl::core::WorkflowExecution_Phase> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::WorkflowExecution_Phase>() {
  return ::nebulaidl::core::WorkflowExecution_Phase_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::core::NodeExecution_Phase> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::NodeExecution_Phase>() {
  return ::nebulaidl::core::NodeExecution_Phase_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::core::TaskExecution_Phase> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::TaskExecution_Phase>() {
  return ::nebulaidl::core::TaskExecution_Phase_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::core::ExecutionError_ErrorKind> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::ExecutionError_ErrorKind>() {
  return ::nebulaidl::core::ExecutionError_ErrorKind_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::core::TaskLog_MessageFormat> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::TaskLog_MessageFormat>() {
  return ::nebulaidl::core::TaskLog_MessageFormat_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::core::QualityOfService_Tier> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::QualityOfService_Tier>() {
  return ::nebulaidl::core::QualityOfService_Tier_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fcore_2fexecution_2eproto
