...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fcore_2fcondition_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fcore_2fcondition_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fcore_2fcondition_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fcore_2fcondition_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::core::BooleanExpression* Arena::CreateMaybeMessage<::nebulaidl::core::BooleanExpression>(Arena*);
template<> ::nebulaidl::core::ComparisonExpression* Arena::CreateMaybeMessage<::nebulaidl::core::ComparisonExpression>(Arena*);
template<> ::nebulaidl::core::ConjunctionExpression* Arena::CreateMaybeMessage<::nebulaidl::core::ConjunctionExpression>(Arena*);
template<> ::nebulaidl::core::Operand* Arena::CreateMaybeMessage<::nebulaidl::core::Operand>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace core {
...
class ComparisonExpression final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.ComparisonExpression) */ {
 public:
  ...
  const ::nebulaidl::core::Operand& left_value() const;
  ::nebulaidl::core::Operand* release_left_value();
  ::nebulaidl::core::Operand* mutable_left_value();
  void set_allocated_left_value(::nebulaidl::core::Operand* left_value);
  ...
  const ::nebulaidl::core::Operand& right_value() const;
  ::nebulaidl::core::Operand* release_right_value();
  ::nebulaidl::core::Operand* mutable_right_value();
  void set_allocated_right_value(::nebulaidl::core::Operand* right_value);

  // .nebulaidl.core.ComparisonExpression.Operator operator = 1;
  void clear_operator_();
  static const int kOperatorFieldNumber = 1;
  ::nebulaidl::core::ComparisonExpression_Operator operator_() const;
  void set_operator_(::nebulaidl::core::ComparisonExpression_Operator value);
 ...
 private:
  ...
  ::nebulaidl::core::Operand* left_value_;
  ::nebulaidl::core::Operand* right_value_;
  int operator__;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fcore_2fcondition_2eproto;
};
// -------------------------------------------------------------------

class Operand final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.Operand) */ {
 public:
  Operand();
  virtual ~Operand();
  ...
  PROTOBUF_DEPRECATED const ::nebulaidl::core::Primitive& primitive() const;
  PROTOBUF_DEPRECATED ::nebulaidl::core::Primitive* release_primitive();
  PROTOBUF_DEPRECATED ::nebulaidl::core::Primitive* mutable_primitive();
  PROTOBUF_DEPRECATED void set_allocated_primitive(::nebulaidl::core::Primitive* primitive);
...
class BooleanExpression final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.BooleanExpression) */ {
 public:
  BooleanExpression();
  ...
  const ::nebulaidl::core::ConjunctionExpression& conjunction() const;
  ::nebulaidl::core::ConjunctionExpression* release_conjunction();
  ::nebulaidl::core::ConjunctionExpression* mutable_conjunction();
  void set_allocated_conjunction(::nebulaidl::core::ConjunctionExpression* conjunction);
  ...
  const ::nebulaidl::core::ComparisonExpression& comparison() const;
  ::nebulaidl::core::ComparisonExpression* release_comparison();
  ::nebulaidl::core::ComparisonExpression* mutable_comparison();
  void set_allocated_comparison(::nebulaidl::core::ComparisonExpression* comparison);
 ...
 private:
  ...
  union ExprUnion {
    ExprUnion() {}
    ::nebulaidl::core::ConjunctionExpression* conjunction_;
    ::nebulaidl::core::ComparisonExpression* comparison_;
  } expr_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  ::google::protobuf::uint32 _oneof_case_[1];
...
class ConjunctionExpression final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.core.ConjunctionExpression) */ {
 public:
  ...
  const ::nebulaidl::core::BooleanExpression& left_expression() const;
  ::nebulaidl::core::BooleanExpression* release_left_expression();
  ::nebulaidl::core::BooleanExpression* mutable_left_expression();
  void set_allocated_left_expression(::nebulaidl::core::BooleanExpression* left_expression);
  ...
  const ::nebulaidl::core::BooleanExpression& right_expression() const;
  ::nebulaidl::core::BooleanExpression* release_right_expression();
  ::nebulaidl::core::BooleanExpression* mutable_right_expression();
  void set_allocated_right_expression(::nebulaidl::core::BooleanExpression* right_expression);

  // .nebulaidl.core.ConjunctionExpression.LogicalOperator operator = 1;
  void clear_operator_();
  static const int kOperatorFieldNumber = 1;
  ::nebulaidl::core::ConjunctionExpression_LogicalOperator operator_() const;
  void set_operator_(::nebulaidl::core::ConjunctionExpression_LogicalOperator value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::nebulaidl::core::BooleanExpression* left_expression_;
  ::nebulaidl::core::BooleanExpression* right_expression_;
  int operator__;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fcore_2fcondition_2eproto;
};
...
inline ::nebulaidl::core::ComparisonExpression_Operator ComparisonExpression::operator_() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.ComparisonExpression.operator)
  return static_cast< ::nebulaidl::core::ComparisonExpression_Operator >(operator__);
}
inline void ComparisonExpression::set_operator_(::nebulaidl::core::ComparisonExpression_Operator value) {
  
  operator__ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.core.ComparisonExpression.operator)
}
...
inline const ::nebulaidl::core::Operand& ComparisonExpression::left_value() const {
  const ::nebulaidl::core::Operand* p = left_value_;
  // @@protoc_insertion_point(field_get:nebulaidl.core.ComparisonExpression.left_value)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::Operand*>(
      &::nebulaidl::core::_Operand_default_instance_);
}
inline ::nebulaidl::core::Operand* ComparisonExpression::release_left_value() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.ComparisonExpression.left_value)
  
  ::nebulaidl::core::Operand* temp = left_value_;
  left_value_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::Operand* ComparisonExpression::mutable_left_value() {
  
  if (left_value_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::Operand>(GetArenaNoVirtual());
    left_value_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.ComparisonExpression.left_value)
  return left_value_;
}
inline void ComparisonExpression::set_allocated_left_value(::nebulaidl::core::Operand* left_value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.ComparisonExpression.left_value)
}
...
inline const ::nebulaidl::core::Operand& ComparisonExpression::right_value() const {
  const ::nebulaidl::core::Operand* p = right_value_;
  // @@protoc_insertion_point(field_get:nebulaidl.core.ComparisonExpression.right_value)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::Operand*>(
      &::nebulaidl::core::_Operand_default_instance_);
}
inline ::nebulaidl::core::Operand* ComparisonExpression::release_right_value() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.ComparisonExpression.right_value)
  
  ::nebulaidl::core::Operand* temp = right_value_;
  right_value_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::Operand* ComparisonExpression::mutable_right_value() {
  
  if (right_value_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::Operand>(GetArenaNoVirtual());
    right_value_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.ComparisonExpression.right_value)
  return right_value_;
}
inline void ComparisonExpression::set_allocated_right_value(::nebulaidl::core::Operand* right_value) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete right_value_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.ComparisonExpression.right_value)
}
...
inline ::nebulaidl::core::Primitive* Operand::release_primitive() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.Operand.primitive)
  if (has_primitive()) {
    clear_has_val();
      ::nebulaidl::core::Primitive* temp = val_.primitive_;
...
inline const ::nebulaidl::core::Primitive& Operand::primitive() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.Operand.primitive)
  return has_primitive()
      ? *val_.primitive_
      : *reinterpret_cast< ::nebulaidl::core::Primitive*>(&::nebulaidl::core::_Primitive_default_instance_);
}
inline ::nebulaidl::core::Primitive* Operand::mutable_primitive() {
  if (!has_primitive()) {
    clear_val();
    set_has_primitive();
    val_.primitive_ = CreateMaybeMessage< ::nebulaidl::core::Primitive >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.Operand.primitive)
...
inline const ::std::string& Operand::var() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.Operand.var)
  if (has_var()) {
...
inline void Operand::set_var(const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.core.Operand.var)
  if (!has_var()) {
    clear_val();
    set_has_var();
...
inline void Operand::set_var(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.core.Operand.var)
}
#endif
inline void Operand::set_var(const char* value) {
  ...
  val_.var_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.core.Operand.var)
}
inline void Operand::set_var(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.core.Operand.var)
}
inline ::std::string* Operand::mutable_var() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.Operand.var)
...
inline ::std::string* Operand::release_var() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.Operand.var)
  if (has_var()) {
    clear_has_val();
...
inline void Operand::set_allocated_var(::std::string* var) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.Operand.var)
}
...
inline ::nebulaidl::core::Scalar* Operand::release_scalar() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.Operand.scalar)
  if (has_scalar()) {
    clear_has_val();
      ::nebulaidl::core::Scalar* temp = val_.scalar_;
...
inline const ::nebulaidl::core::Scalar& Operand::scalar() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.Operand.scalar)
  return has_scalar()
      ? *val_.scalar_
      : *reinterpret_cast< ::nebulaidl::core::Scalar*>(&::nebulaidl::core::_Scalar_default_instance_);
}
inline ::nebulaidl::core::Scalar* Operand::mutable_scalar() {
  if (!has_scalar()) {
    clear_val();
    set_has_scalar();
    val_.scalar_ = CreateMaybeMessage< ::nebulaidl::core::Scalar >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.Operand.scalar)
  return val_.scalar_;
}
...
inline ::nebulaidl::core::ConjunctionExpression* BooleanExpression::release_conjunction() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.BooleanExpression.conjunction)
  if (has_conjunction()) {
    clear_has_expr();
      ::nebulaidl::core::ConjunctionExpression* temp = expr_.conjunction_;
...
inline const ::nebulaidl::core::ConjunctionExpression& BooleanExpression::conjunction() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.BooleanExpression.conjunction)
  return has_conjunction()
      ? *expr_.conjunction_
      : *reinterpret_cast< ::nebulaidl::core::ConjunctionExpression*>(&::nebulaidl::core::_ConjunctionExpression_default_instance_);
}
inline ::nebulaidl::core::ConjunctionExpression* BooleanExpression::mutable_conjunction() {
  if (!has_conjunction()) {
    clear_expr();
    set_has_conjunction();
    expr_.conjunction_ = CreateMaybeMessage< ::nebulaidl::core::ConjunctionExpression >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.BooleanExpression.conjunction)
...
inline ::nebulaidl::core::ComparisonExpression* BooleanExpression::release_comparison() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.BooleanExpression.comparison)
  if (has_comparison()) {
    clear_has_expr();
      ::nebulaidl::core::ComparisonExpression* temp = expr_.comparison_;
...
inline const ::nebulaidl::core::ComparisonExpression& BooleanExpression::comparison() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.BooleanExpression.comparison)
  return has_comparison()
      ? *expr_.comparison_
      : *reinterpret_cast< ::nebulaidl::core::ComparisonExpression*>(&::nebulaidl::core::_ComparisonExpression_default_instance_);
}
inline ::nebulaidl::core::ComparisonExpression* BooleanExpression::mutable_comparison() {
  if (!has_comparison()) {
    clear_expr();
    set_has_comparison();
    expr_.comparison_ = CreateMaybeMessage< ::nebulaidl::core::ComparisonExpression >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.BooleanExpression.comparison)
...
inline ::nebulaidl::core::ConjunctionExpression_LogicalOperator ConjunctionExpression::operator_() const {
  // @@protoc_insertion_point(field_get:nebulaidl.core.ConjunctionExpression.operator)
  return static_cast< ::nebulaidl::core::ConjunctionExpression_LogicalOperator >(operator__);
}
inline void ConjunctionExpression::set_operator_(::nebulaidl::core::ConjunctionExpression_LogicalOperator value) {
  
  operator__ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.core.ConjunctionExpression.operator)
}
...
inline const ::nebulaidl::core::BooleanExpression& ConjunctionExpression::left_expression() const {
  const ::nebulaidl::core::BooleanExpression* p = left_expression_;
  // @@protoc_insertion_point(field_get:nebulaidl.core.ConjunctionExpression.left_expression)
...
inline ::nebulaidl::core::BooleanExpression* ConjunctionExpression::release_left_expression() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.ConjunctionExpression.left_expression)
  
  ::nebulaidl::core::BooleanExpression* temp = left_expression_;
  left_expression_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::BooleanExpression* ConjunctionExpression::mutable_left_expression() {
  
  if (left_expression_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::BooleanExpression>(GetArenaNoVirtual());
    left_expression_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.ConjunctionExpression.left_expression)
  return left_expression_;
}
inline void ConjunctionExpression::set_allocated_left_expression(::nebulaidl::core::BooleanExpression* left_expression) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete left_expression_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.ConjunctionExpression.left_expression)
}
...
inline const ::nebulaidl::core::BooleanExpression& ConjunctionExpression::right_expression() const {
  const ::nebulaidl::core::BooleanExpression* p = right_expression_;
  // @@protoc_insertion_point(field_get:nebulaidl.core.ConjunctionExpression.right_expression)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::BooleanExpression*>(
      &::nebulaidl::core::_BooleanExpression_default_instance_);
}
inline ::nebulaidl::core::BooleanExpression* ConjunctionExpression::release_right_expression() {
  // @@protoc_insertion_point(field_release:nebulaidl.core.ConjunctionExpression.right_expression)
  
  ::nebulaidl::core::BooleanExpression* temp = right_expression_;
  right_expression_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::BooleanExpression* ConjunctionExpression::mutable_right_expression() {
  
  if (right_expression_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::BooleanExpression>(GetArenaNoVirtual());
    right_expression_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.core.ConjunctionExpression.right_expression)
  return right_expression_;
}
inline void ConjunctionExpression::set_allocated_right_expression(::nebulaidl::core::BooleanExpression* right_expression) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete right_expression_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.core.ConjunctionExpression.right_expression)
}
...
template <> struct is_proto_enum< ::nebulaidl::core::ComparisonExpression_Operator> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::ComparisonExpression_Operator>() {
  return ::nebulaidl::core::ComparisonExpression_Operator_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::core::ConjunctionExpression_LogicalOperator> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::core::ConjunctionExpression_LogicalOperator>() {
  return ::nebulaidl::core::ConjunctionExpression_LogicalOperator_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fcore_2fcondition_2eproto
