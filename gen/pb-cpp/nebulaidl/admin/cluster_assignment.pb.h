...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fcluster_5fassignment_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fcluster_5fassignment_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fadmin_2fcluster_5fassignment_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fadmin_2fcluster_5fassignment_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::admin::ClusterAssignment* Arena::CreateMaybeMessage<::nebulaidl::admin::ClusterAssignment>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace admin {
...
class ClusterAssignment final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ClusterAssignment) */ {
 public:
  ClusterAssignment();
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fadmin_2fcluster_5fassignment_2eproto;
};
// ===================================================================
...
inline const ::std::string& ClusterAssignment::cluster_pool_name() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
...
inline void ClusterAssignment::set_cluster_pool_name(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
}
#if LANG_CXX11
inline void ClusterAssignment::set_cluster_pool_name(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
}
#endif
inline void ClusterAssignment::set_cluster_pool_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
}
inline void ClusterAssignment::set_cluster_pool_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
}
inline ::std::string* ClusterAssignment::mutable_cluster_pool_name() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
...
inline ::std::string* ClusterAssignment::release_cluster_pool_name() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
...
inline void ClusterAssignment::set_allocated_cluster_pool_name(::std::string* cluster_pool_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.ClusterAssignment.cluster_pool_name)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fcluster_5fassignment_2eproto
