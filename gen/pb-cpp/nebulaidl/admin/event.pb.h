...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fevent_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fevent_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fadmin_2fevent_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fadmin_2fevent_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::admin::EventErrorAlreadyInTerminalState* Arena::CreateMaybeMessage<::nebulaidl::admin::EventErrorAlreadyInTerminalState>(Arena*);
template<> ::nebulaidl::admin::EventErrorIncompatibleCluster* Arena::CreateMaybeMessage<::nebulaidl::admin::EventErrorIncompatibleCluster>(Arena*);
template<> ::nebulaidl::admin::EventFailureReason* Arena::CreateMaybeMessage<::nebulaidl::admin::EventFailureReason>(Arena*);
template<> ::nebulaidl::admin::NodeExecutionEventRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::NodeExecutionEventRequest>(Arena*);
template<> ::nebulaidl::admin::NodeExecutionEventResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::NodeExecutionEventResponse>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionEventRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionEventRequest>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionEventResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionEventResponse>(Arena*);
template<> ::nebulaidl::admin::WorkflowExecutionEventRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::WorkflowExecutionEventRequest>(Arena*);
template<> ::nebulaidl::admin::WorkflowExecutionEventResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::WorkflowExecutionEventResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace admin {
...
class EventErrorAlreadyInTerminalState final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.EventErrorAlreadyInTerminalState) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fadmin_2fevent_2eproto;
};
// -------------------------------------------------------------------

class EventErrorIncompatibleCluster final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.EventErrorIncompatibleCluster) */ {
 public:
...
class EventFailureReason final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.EventFailureReason) */ {
 public:
  EventFailureReason();
  ...
  const ::nebulaidl::admin::EventErrorAlreadyInTerminalState& already_in_terminal_state() const;
  ::nebulaidl::admin::EventErrorAlreadyInTerminalState* release_already_in_terminal_state();
  ::nebulaidl::admin::EventErrorAlreadyInTerminalState* mutable_already_in_terminal_state();
  void set_allocated_already_in_terminal_state(::nebulaidl::admin::EventErrorAlreadyInTerminalState* already_in_terminal_state);
  ...
  const ::nebulaidl::admin::EventErrorIncompatibleCluster& incompatible_cluster() const;
  ::nebulaidl::admin::EventErrorIncompatibleCluster* release_incompatible_cluster();
  ::nebulaidl::admin::EventErrorIncompatibleCluster* mutable_incompatible_cluster();
  void set_allocated_incompatible_cluster(::nebulaidl::admin::EventErrorIncompatibleCluster* incompatible_cluster);
 ...
 private:
  ...
  union ReasonUnion {
    ReasonUnion() {}
    ::nebulaidl::admin::EventErrorAlreadyInTerminalState* already_in_terminal_state_;
    ::nebulaidl::admin::EventErrorIncompatibleCluster* incompatible_cluster_;
  } reason_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
...
class WorkflowExecutionEventRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.WorkflowExecutionEventRequest) */ {
 public:
  ...
  const ::nebulaidl::event::WorkflowExecutionEvent& event() const;
  ::nebulaidl::event::WorkflowExecutionEvent* release_event();
  ::nebulaidl::event::WorkflowExecutionEvent* mutable_event();
  void set_allocated_event(::nebulaidl::event::WorkflowExecutionEvent* event);
 ...
 private:
  ...
  ::nebulaidl::event::WorkflowExecutionEvent* event_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fevent_2eproto;
};
// -------------------------------------------------------------------
...
class WorkflowExecutionEventResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.WorkflowExecutionEventResponse) */ {
 public:
...
class NodeExecutionEventRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.NodeExecutionEventRequest) */ {
 public:
  ...
  void clear_event();
  static const int kEventFieldNumber = 2;
  const ::nebulaidl::event::NodeExecutionEvent& event() const;
  ::nebulaidl::event::NodeExecutionEvent* release_event();
  ::nebulaidl::event::NodeExecutionEvent* mutable_event();
  void set_allocated_event(::nebulaidl::event::NodeExecutionEvent* event);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::ArenaStringPtr request_id_;
  ::nebulaidl::event::NodeExecutionEvent* event_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fevent_2eproto;
};
// -------------------------------------------------------------------
...
class NodeExecutionEventResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.NodeExecutionEventResponse) */ {
 public:
...
class TaskExecutionEventRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionEventRequest) */ {
 public:
  ...
  void clear_event();
  static const int kEventFieldNumber = 2;
  const ::nebulaidl::event::TaskExecutionEvent& event() const;
  ::nebulaidl::event::TaskExecutionEvent* release_event();
  ::nebulaidl::event::TaskExecutionEvent* mutable_event();
  void set_allocated_event(::nebulaidl::event::TaskExecutionEvent* event);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::ArenaStringPtr request_id_;
  ::nebulaidl::event::TaskExecutionEvent* event_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fevent_2eproto;
};
// -------------------------------------------------------------------
...
class TaskExecutionEventResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionEventResponse) */ {
 public:
...
inline const ::std::string& EventErrorAlreadyInTerminalState::current_phase() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
...
inline void EventErrorAlreadyInTerminalState::set_current_phase(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
}
#if LANG_CXX11
inline void EventErrorAlreadyInTerminalState::set_current_phase(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
}
#endif
inline void EventErrorAlreadyInTerminalState::set_current_phase(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
}
inline void EventErrorAlreadyInTerminalState::set_current_phase(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
}
inline ::std::string* EventErrorAlreadyInTerminalState::mutable_current_phase() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
...
inline ::std::string* EventErrorAlreadyInTerminalState::release_current_phase() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
...
inline void EventErrorAlreadyInTerminalState::set_allocated_current_phase(::std::string* current_phase) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.EventErrorAlreadyInTerminalState.current_phase)
}
...
inline const ::std::string& EventErrorIncompatibleCluster::cluster() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
...
inline void EventErrorIncompatibleCluster::set_cluster(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
}
#if LANG_CXX11
inline void EventErrorIncompatibleCluster::set_cluster(::std::string&& value) {
  ...
  cluster_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
}
#endif
inline void EventErrorIncompatibleCluster::set_cluster(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
}
inline void EventErrorIncompatibleCluster::set_cluster(const char* value, size_t size) {
  ...
  cluster_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
}
inline ::std::string* EventErrorIncompatibleCluster::mutable_cluster() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
...
inline ::std::string* EventErrorIncompatibleCluster::release_cluster() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
...
inline void EventErrorIncompatibleCluster::set_allocated_cluster(::std::string* cluster) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.EventErrorIncompatibleCluster.cluster)
}
...
inline ::nebulaidl::admin::EventErrorAlreadyInTerminalState* EventFailureReason::release_already_in_terminal_state() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.EventFailureReason.already_in_terminal_state)
  if (has_already_in_terminal_state()) {
    clear_has_reason();
      ::nebulaidl::admin::EventErrorAlreadyInTerminalState* temp = reason_.already_in_terminal_state_;
...
inline const ::nebulaidl::admin::EventErrorAlreadyInTerminalState& EventFailureReason::already_in_terminal_state() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.EventFailureReason.already_in_terminal_state)
  return has_already_in_terminal_state()
      ? *reason_.already_in_terminal_state_
      : *reinterpret_cast< ::nebulaidl::admin::EventErrorAlreadyInTerminalState*>(&::nebulaidl::admin::_EventErrorAlreadyInTerminalState_default_instance_);
}
inline ::nebulaidl::admin::EventErrorAlreadyInTerminalState* EventFailureReason::mutable_already_in_terminal_state() {
  if (!has_already_in_terminal_state()) {
    clear_reason();
    set_has_already_in_terminal_state();
    reason_.already_in_terminal_state_ = CreateMaybeMessage< ::nebulaidl::admin::EventErrorAlreadyInTerminalState >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.EventFailureReason.already_in_terminal_state)
...
inline ::nebulaidl::admin::EventErrorIncompatibleCluster* EventFailureReason::release_incompatible_cluster() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.EventFailureReason.incompatible_cluster)
  if (has_incompatible_cluster()) {
    clear_has_reason();
      ::nebulaidl::admin::EventErrorIncompatibleCluster* temp = reason_.incompatible_cluster_;
...
inline const ::nebulaidl::admin::EventErrorIncompatibleCluster& EventFailureReason::incompatible_cluster() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.EventFailureReason.incompatible_cluster)
  return has_incompatible_cluster()
      ? *reason_.incompatible_cluster_
      : *reinterpret_cast< ::nebulaidl::admin::EventErrorIncompatibleCluster*>(&::nebulaidl::admin::_EventErrorIncompatibleCluster_default_instance_);
}
inline ::nebulaidl::admin::EventErrorIncompatibleCluster* EventFailureReason::mutable_incompatible_cluster() {
  if (!has_incompatible_cluster()) {
    clear_reason();
    set_has_incompatible_cluster();
    reason_.incompatible_cluster_ = CreateMaybeMessage< ::nebulaidl::admin::EventErrorIncompatibleCluster >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.EventFailureReason.incompatible_cluster)
...
inline const ::std::string& WorkflowExecutionEventRequest::request_id() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
...
inline void WorkflowExecutionEventRequest::set_request_id(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
}
#if LANG_CXX11
inline void WorkflowExecutionEventRequest::set_request_id(::std::string&& value) {
  ...
  request_id_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
}
#endif
inline void WorkflowExecutionEventRequest::set_request_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
}
inline void WorkflowExecutionEventRequest::set_request_id(const char* value, size_t size) {
  
  request_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
}
inline ::std::string* WorkflowExecutionEventRequest::mutable_request_id() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
  return request_id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* WorkflowExecutionEventRequest::release_request_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
...
inline void WorkflowExecutionEventRequest::set_allocated_request_id(::std::string* request_id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionEventRequest.request_id)
}
...
inline const ::nebulaidl::event::WorkflowExecutionEvent& WorkflowExecutionEventRequest::event() const {
  const ::nebulaidl::event::WorkflowExecutionEvent* p = event_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionEventRequest.event)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::event::WorkflowExecutionEvent*>(
      &::nebulaidl::event::_WorkflowExecutionEvent_default_instance_);
}
inline ::nebulaidl::event::WorkflowExecutionEvent* WorkflowExecutionEventRequest::release_event() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionEventRequest.event)
  
  ::nebulaidl::event::WorkflowExecutionEvent* temp = event_;
  event_ = nullptr;
  return temp;
}
inline ::nebulaidl::event::WorkflowExecutionEvent* WorkflowExecutionEventRequest::mutable_event() {
  
  if (event_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::event::WorkflowExecutionEvent>(GetArenaNoVirtual());
    event_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionEventRequest.event)
  return event_;
}
inline void WorkflowExecutionEventRequest::set_allocated_event(::nebulaidl::event::WorkflowExecutionEvent* event) {
  ...
  event_ = event;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionEventRequest.event)
}
...
inline const ::std::string& NodeExecutionEventRequest::request_id() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.NodeExecutionEventRequest.request_id)
  return request_id_.GetNoArena();
}
inline void NodeExecutionEventRequest::set_request_id(const ::std::string& value) {
  
  request_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.NodeExecutionEventRequest.request_id)
}
#if LANG_CXX11
inline void NodeExecutionEventRequest::set_request_id(::std::string&& value) {
  ...
  request_id_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.NodeExecutionEventRequest.request_id)
}
#endif
inline void NodeExecutionEventRequest::set_request_id(const char* value) {
  ...
  request_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.NodeExecutionEventRequest.request_id)
}
inline void NodeExecutionEventRequest::set_request_id(const char* value, size_t size) {
  
  request_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.NodeExecutionEventRequest.request_id)
}
inline ::std::string* NodeExecutionEventRequest::mutable_request_id() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.NodeExecutionEventRequest.request_id)
  return request_id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* NodeExecutionEventRequest::release_request_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.NodeExecutionEventRequest.request_id)
...
inline void NodeExecutionEventRequest::set_allocated_request_id(::std::string* request_id) {
  ...
  request_id_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), request_id);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.NodeExecutionEventRequest.request_id)
}
...
inline const ::nebulaidl::event::NodeExecutionEvent& NodeExecutionEventRequest::event() const {
  const ::nebulaidl::event::NodeExecutionEvent* p = event_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.NodeExecutionEventRequest.event)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::event::NodeExecutionEvent*>(
      &::nebulaidl::event::_NodeExecutionEvent_default_instance_);
}
inline ::nebulaidl::event::NodeExecutionEvent* NodeExecutionEventRequest::release_event() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.NodeExecutionEventRequest.event)
  
  ::nebulaidl::event::NodeExecutionEvent* temp = event_;
  event_ = nullptr;
  return temp;
}
inline ::nebulaidl::event::NodeExecutionEvent* NodeExecutionEventRequest::mutable_event() {
  
  if (event_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::event::NodeExecutionEvent>(GetArenaNoVirtual());
    event_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.NodeExecutionEventRequest.event)
  return event_;
}
inline void NodeExecutionEventRequest::set_allocated_event(::nebulaidl::event::NodeExecutionEvent* event) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(event_);
  }
  ...
  event_ = event;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.NodeExecutionEventRequest.event)
}
...
inline const ::std::string& TaskExecutionEventRequest::request_id() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionEventRequest.request_id)
  return request_id_.GetNoArena();
}
inline void TaskExecutionEventRequest::set_request_id(const ::std::string& value) {
  
  request_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionEventRequest.request_id)
}
#if LANG_CXX11
inline void TaskExecutionEventRequest::set_request_id(::std::string&& value) {
  ...
  request_id_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecutionEventRequest.request_id)
}
#endif
inline void TaskExecutionEventRequest::set_request_id(const char* value) {
  ...
  request_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecutionEventRequest.request_id)
}
inline void TaskExecutionEventRequest::set_request_id(const char* value, size_t size) {
  
  request_id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecutionEventRequest.request_id)
}
inline ::std::string* TaskExecutionEventRequest::mutable_request_id() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionEventRequest.request_id)
  return request_id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TaskExecutionEventRequest::release_request_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionEventRequest.request_id)
...
inline void TaskExecutionEventRequest::set_allocated_request_id(::std::string* request_id) {
  ...
  request_id_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), request_id);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionEventRequest.request_id)
}
...
inline const ::nebulaidl::event::TaskExecutionEvent& TaskExecutionEventRequest::event() const {
  const ::nebulaidl::event::TaskExecutionEvent* p = event_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionEventRequest.event)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::event::TaskExecutionEvent*>(
      &::nebulaidl::event::_TaskExecutionEvent_default_instance_);
}
inline ::nebulaidl::event::TaskExecutionEvent* TaskExecutionEventRequest::release_event() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionEventRequest.event)
  
  ::nebulaidl::event::TaskExecutionEvent* temp = event_;
  event_ = nullptr;
  return temp;
}
inline ::nebulaidl::event::TaskExecutionEvent* TaskExecutionEventRequest::mutable_event() {
  
  if (event_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::event::TaskExecutionEvent>(GetArenaNoVirtual());
    event_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionEventRequest.event)
  return event_;
}
inline void TaskExecutionEventRequest::set_allocated_event(::nebulaidl::event::TaskExecutionEvent* event) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(event_);
  }
  ...
  event_ = event;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionEventRequest.event)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fevent_2eproto
