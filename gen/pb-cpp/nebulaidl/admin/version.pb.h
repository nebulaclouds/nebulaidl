...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fversion_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fversion_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fadmin_2fversion_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fadmin_2fversion_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::admin::GetVersionRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::GetVersionRequest>(Arena*);
template<> ::nebulaidl::admin::GetVersionResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::GetVersionResponse>(Arena*);
template<> ::nebulaidl::admin::Version* Arena::CreateMaybeMessage<::nebulaidl::admin::Version>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace admin {
...
class GetVersionResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.GetVersionResponse) */ {
 public:
  GetVersionResponse();
  ...
  const ::nebulaidl::admin::Version& control_plane_version() const;
  ::nebulaidl::admin::Version* release_control_plane_version();
  ::nebulaidl::admin::Version* mutable_control_plane_version();
  void set_allocated_control_plane_version(::nebulaidl::admin::Version* control_plane_version);
 ...
 private:
  ...
  ::nebulaidl::admin::Version* control_plane_version_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fversion_2eproto;
};
// -------------------------------------------------------------------

class Version final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.Version) */ {
 public:
  Version();
  virtual ~Version();
...
class GetVersionRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.GetVersionRequest) */ {
 public:
  GetVersionRequest();
...
inline const ::nebulaidl::admin::Version& GetVersionResponse::control_plane_version() const {
  const ::nebulaidl::admin::Version* p = control_plane_version_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.GetVersionResponse.control_plane_version)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Version*>(
      &::nebulaidl::admin::_Version_default_instance_);
}
inline ::nebulaidl::admin::Version* GetVersionResponse::release_control_plane_version() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.GetVersionResponse.control_plane_version)
  
  ::nebulaidl::admin::Version* temp = control_plane_version_;
  control_plane_version_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Version* GetVersionResponse::mutable_control_plane_version() {
  
  if (control_plane_version_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Version>(GetArenaNoVirtual());
    control_plane_version_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.GetVersionResponse.control_plane_version)
  return control_plane_version_;
}
inline void GetVersionResponse::set_allocated_control_plane_version(::nebulaidl::admin::Version* control_plane_version) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.GetVersionResponse.control_plane_version)
}
...
inline const ::std::string& Version::build() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Version.Build)
...
inline void Version::set_build(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Version.Build)
}
#if LANG_CXX11
inline void Version::set_build(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Version.Build)
}
#endif
inline void Version::set_build(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Version.Build)
}
inline void Version::set_build(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Version.Build)
}
inline ::std::string* Version::mutable_build() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Version.Build)
  return build_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Version::release_build() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Version.Build)
...
inline void Version::set_allocated_build(::std::string* build) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Version.Build)
}
...
inline const ::std::string& Version::version() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Version.Version)
  return version_.GetNoArena();
}
inline void Version::set_version(const ::std::string& value) {
  
  version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Version.Version)
}
#if LANG_CXX11
inline void Version::set_version(::std::string&& value) {
  ...
  version_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Version.Version)
}
#endif
inline void Version::set_version(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Version.Version)
}
inline void Version::set_version(const char* value, size_t size) {
  
  version_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Version.Version)
}
inline ::std::string* Version::mutable_version() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Version.Version)
  return version_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Version::release_version() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Version.Version)
...
inline void Version::set_allocated_version(::std::string* version) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Version.Version)
}
...
inline const ::std::string& Version::buildtime() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Version.BuildTime)
...
inline void Version::set_buildtime(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Version.BuildTime)
}
#if LANG_CXX11
inline void Version::set_buildtime(::std::string&& value) {
  ...
  buildtime_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Version.BuildTime)
}
#endif
inline void Version::set_buildtime(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Version.BuildTime)
}
inline void Version::set_buildtime(const char* value, size_t size) {
  ...
  buildtime_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Version.BuildTime)
}
inline ::std::string* Version::mutable_buildtime() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Version.BuildTime)
...
inline ::std::string* Version::release_buildtime() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Version.BuildTime)
...
inline void Version::set_allocated_buildtime(::std::string* buildtime) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Version.BuildTime)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fversion_2eproto
