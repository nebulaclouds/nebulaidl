...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fdescription_5fentity_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fdescription_5fentity_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fadmin_2fdescription_5fentity_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fadmin_2fdescription_5fentity_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::admin::Description* Arena::CreateMaybeMessage<::nebulaidl::admin::Description>(Arena*);
template<> ::nebulaidl::admin::DescriptionEntity* Arena::CreateMaybeMessage<::nebulaidl::admin::DescriptionEntity>(Arena*);
template<> ::nebulaidl::admin::DescriptionEntityList* Arena::CreateMaybeMessage<::nebulaidl::admin::DescriptionEntityList>(Arena*);
template<> ::nebulaidl::admin::DescriptionEntityListRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::DescriptionEntityListRequest>(Arena*);
template<> ::nebulaidl::admin::SourceCode* Arena::CreateMaybeMessage<::nebulaidl::admin::SourceCode>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace admin {
...
class DescriptionEntity final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.DescriptionEntity) */ {
 public:
  DescriptionEntity();
  ...
  const ::nebulaidl::admin::Description& long_description() const;
  ::nebulaidl::admin::Description* release_long_description();
  ::nebulaidl::admin::Description* mutable_long_description();
  void set_allocated_long_description(::nebulaidl::admin::Description* long_description);

  // .nebulaidl.admin.SourceCode source_code = 4;
  bool has_source_code() const;
  void clear_source_code();
  static const int kSourceCodeFieldNumber = 4;
  const ::nebulaidl::admin::SourceCode& source_code() const;
  ::nebulaidl::admin::SourceCode* release_source_code();
  ::nebulaidl::admin::SourceCode* mutable_source_code();
  void set_allocated_source_code(::nebulaidl::admin::SourceCode* source_code);
 ...
 private:
  ...
  ::nebulaidl::admin::Description* long_description_;
  ::nebulaidl::admin::SourceCode* source_code_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fdescription_5fentity_2eproto;
};
// -------------------------------------------------------------------

class Description final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.Description) */ {
 public:
  Description();
  virtual ~Description();
  ...
  ::nebulaidl::admin::DescriptionFormat format() const;
  void set_format(::nebulaidl::admin::DescriptionFormat value);
...
class SourceCode final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.SourceCode) */ {
 public:
  SourceCode();
  virtual ~SourceCode();
...
class DescriptionEntityList final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.DescriptionEntityList) */ {
 public:
  ...
  ::nebulaidl::admin::DescriptionEntity* mutable_descriptionentities(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::DescriptionEntity >*
      mutable_descriptionentities();
  const ::nebulaidl::admin::DescriptionEntity& descriptionentities(int index) const;
  ::nebulaidl::admin::DescriptionEntity* add_descriptionentities();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::DescriptionEntity >&
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::DescriptionEntity > descriptionentities_;
...
class DescriptionEntityListRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.DescriptionEntityListRequest) */ {
 public:
...
inline const ::nebulaidl::core::Identifier& DescriptionEntity::id() const {
  const ::nebulaidl::core::Identifier* p = id_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntity.id)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::Identifier*>(
      &::nebulaidl::core::_Identifier_default_instance_);
}
inline ::nebulaidl::core::Identifier* DescriptionEntity::release_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntity.id)
  
  ::nebulaidl::core::Identifier* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::Identifier* DescriptionEntity::mutable_id() {
  
  if (id_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::Identifier>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntity.id)
  return id_;
}
inline void DescriptionEntity::set_allocated_id(::nebulaidl::core::Identifier* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntity.id)
}
...
inline const ::std::string& DescriptionEntity::short_description() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntity.short_description)
...
inline void DescriptionEntity::set_short_description(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.DescriptionEntity.short_description)
}
#if LANG_CXX11
inline void DescriptionEntity::set_short_description(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.DescriptionEntity.short_description)
}
#endif
inline void DescriptionEntity::set_short_description(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.DescriptionEntity.short_description)
}
inline void DescriptionEntity::set_short_description(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.DescriptionEntity.short_description)
}
inline ::std::string* DescriptionEntity::mutable_short_description() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntity.short_description)
...
inline ::std::string* DescriptionEntity::release_short_description() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntity.short_description)
...
inline void DescriptionEntity::set_allocated_short_description(::std::string* short_description) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntity.short_description)
}
...
inline const ::nebulaidl::admin::Description& DescriptionEntity::long_description() const {
  const ::nebulaidl::admin::Description* p = long_description_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntity.long_description)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Description*>(
      &::nebulaidl::admin::_Description_default_instance_);
}
inline ::nebulaidl::admin::Description* DescriptionEntity::release_long_description() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntity.long_description)
  
  ::nebulaidl::admin::Description* temp = long_description_;
  long_description_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Description* DescriptionEntity::mutable_long_description() {
  
  if (long_description_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Description>(GetArenaNoVirtual());
    long_description_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntity.long_description)
  return long_description_;
}
inline void DescriptionEntity::set_allocated_long_description(::nebulaidl::admin::Description* long_description) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete long_description_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntity.long_description)
}
...
inline const ::nebulaidl::admin::SourceCode& DescriptionEntity::source_code() const {
  const ::nebulaidl::admin::SourceCode* p = source_code_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntity.source_code)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::SourceCode*>(
      &::nebulaidl::admin::_SourceCode_default_instance_);
}
inline ::nebulaidl::admin::SourceCode* DescriptionEntity::release_source_code() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntity.source_code)
  
  ::nebulaidl::admin::SourceCode* temp = source_code_;
  source_code_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::SourceCode* DescriptionEntity::mutable_source_code() {
  
  if (source_code_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::SourceCode>(GetArenaNoVirtual());
    source_code_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntity.source_code)
  return source_code_;
}
inline void DescriptionEntity::set_allocated_source_code(::nebulaidl::admin::SourceCode* source_code) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete source_code_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntity.source_code)
}
...
inline const ::std::string& DescriptionEntity::tags(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntity.tags)
  return tags_.Get(index);
}
inline ::std::string* DescriptionEntity::mutable_tags(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntity.tags)
  return tags_.Mutable(index);
}
inline void DescriptionEntity::set_tags(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.admin.DescriptionEntity.tags)
...
inline void DescriptionEntity::set_tags(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tags_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.DescriptionEntity.tags)
}
inline void DescriptionEntity::set_tags(int index, const char* value, size_t size) {
  tags_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.DescriptionEntity.tags)
}
inline ::std::string* DescriptionEntity::add_tags() {
  // @@protoc_insertion_point(field_add_mutable:nebulaidl.admin.DescriptionEntity.tags)
  return tags_.Add();
}
inline void DescriptionEntity::add_tags(const ::std::string& value) {
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:nebulaidl.admin.DescriptionEntity.tags)
}
#if LANG_CXX11
...
inline void DescriptionEntity::add_tags(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:nebulaidl.admin.DescriptionEntity.tags)
}
inline void DescriptionEntity::add_tags(const char* value, size_t size) {
  tags_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:nebulaidl.admin.DescriptionEntity.tags)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
DescriptionEntity::tags() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.DescriptionEntity.tags)
  return tags_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>*
DescriptionEntity::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.DescriptionEntity.tags)
  return &tags_;
}
...
inline const ::std::string& Description::value() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Description.value)
  if (has_value()) {
...
inline void Description::set_value(const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Description.value)
  if (!has_value()) {
    clear_content();
    set_has_value();
...
inline void Description::set_value(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Description.value)
}
#endif
inline void Description::set_value(const char* value) {
  ...
  content_.value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Description.value)
}
inline void Description::set_value(const char* value, size_t size) {
  ...
  content_.value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Description.value)
}
inline ::std::string* Description::mutable_value() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Description.value)
...
inline ::std::string* Description::release_value() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Description.value)
  if (has_value()) {
    clear_has_content();
...
inline void Description::set_allocated_value(::std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Description.value)
}
...
inline const ::std::string& Description::uri() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Description.uri)
  if (has_uri()) {
...
inline void Description::set_uri(const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Description.uri)
  if (!has_uri()) {
    clear_content();
    set_has_uri();
...
inline void Description::set_uri(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Description.uri)
}
#endif
inline void Description::set_uri(const char* value) {
  ...
  content_.uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Description.uri)
}
inline void Description::set_uri(const char* value, size_t size) {
  ...
  content_.uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Description.uri)
}
inline ::std::string* Description::mutable_uri() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Description.uri)
...
inline ::std::string* Description::release_uri() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Description.uri)
  if (has_uri()) {
    clear_has_content();
...
inline void Description::set_allocated_uri(::std::string* uri) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Description.uri)
}
...
inline ::nebulaidl::admin::DescriptionFormat Description::format() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Description.format)
  return static_cast< ::nebulaidl::admin::DescriptionFormat >(format_);
}
inline void Description::set_format(::nebulaidl::admin::DescriptionFormat value) {
  
  format_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Description.format)
}
...
inline const ::std::string& Description::icon_link() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Description.icon_link)
...
inline void Description::set_icon_link(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Description.icon_link)
}
#if LANG_CXX11
inline void Description::set_icon_link(::std::string&& value) {
  ...
  icon_link_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Description.icon_link)
}
#endif
inline void Description::set_icon_link(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Description.icon_link)
}
inline void Description::set_icon_link(const char* value, size_t size) {
  ...
  icon_link_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Description.icon_link)
}
inline ::std::string* Description::mutable_icon_link() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Description.icon_link)
...
inline ::std::string* Description::release_icon_link() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Description.icon_link)
...
inline void Description::set_allocated_icon_link(::std::string* icon_link) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Description.icon_link)
}
...
inline const ::std::string& SourceCode::link() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.SourceCode.link)
...
inline void SourceCode::set_link(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.SourceCode.link)
}
#if LANG_CXX11
inline void SourceCode::set_link(::std::string&& value) {
  ...
  link_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.SourceCode.link)
}
#endif
inline void SourceCode::set_link(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.SourceCode.link)
}
inline void SourceCode::set_link(const char* value, size_t size) {
  ...
  link_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.SourceCode.link)
}
inline ::std::string* SourceCode::mutable_link() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.SourceCode.link)
...
inline ::std::string* SourceCode::release_link() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.SourceCode.link)
...
inline void SourceCode::set_allocated_link(::std::string* link) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.SourceCode.link)
}
...
inline ::nebulaidl::admin::DescriptionEntity* DescriptionEntityList::mutable_descriptionentities(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntityList.descriptionEntities)
  return descriptionentities_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::DescriptionEntity >*
DescriptionEntityList::mutable_descriptionentities() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.DescriptionEntityList.descriptionEntities)
  return &descriptionentities_;
}
inline const ::nebulaidl::admin::DescriptionEntity& DescriptionEntityList::descriptionentities(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityList.descriptionEntities)
  return descriptionentities_.Get(index);
}
inline ::nebulaidl::admin::DescriptionEntity* DescriptionEntityList::add_descriptionentities() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.DescriptionEntityList.descriptionEntities)
  return descriptionentities_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::DescriptionEntity >&
DescriptionEntityList::descriptionentities() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.DescriptionEntityList.descriptionEntities)
  return descriptionentities_;
}
...
inline const ::std::string& DescriptionEntityList::token() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityList.token)
  return token_.GetNoArena();
}
inline void DescriptionEntityList::set_token(const ::std::string& value) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.DescriptionEntityList.token)
}
#if LANG_CXX11
inline void DescriptionEntityList::set_token(::std::string&& value) {
  ...
  token_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.DescriptionEntityList.token)
}
#endif
inline void DescriptionEntityList::set_token(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.DescriptionEntityList.token)
}
inline void DescriptionEntityList::set_token(const char* value, size_t size) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.DescriptionEntityList.token)
}
inline ::std::string* DescriptionEntityList::mutable_token() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntityList.token)
  return token_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* DescriptionEntityList::release_token() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntityList.token)
...
inline void DescriptionEntityList::set_allocated_token(::std::string* token) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntityList.token)
}
...
inline ::nebulaidl::core::ResourceType DescriptionEntityListRequest::resource_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityListRequest.resource_type)
  return static_cast< ::nebulaidl::core::ResourceType >(resource_type_);
}
inline void DescriptionEntityListRequest::set_resource_type(::nebulaidl::core::ResourceType value) {
  
  resource_type_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.DescriptionEntityListRequest.resource_type)
}
...
inline const ::nebulaidl::admin::NamedEntityIdentifier& DescriptionEntityListRequest::id() const {
  const ::nebulaidl::admin::NamedEntityIdentifier* p = id_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityListRequest.id)
...
inline ::nebulaidl::admin::NamedEntityIdentifier* DescriptionEntityListRequest::release_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntityListRequest.id)
  
  ::nebulaidl::admin::NamedEntityIdentifier* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::NamedEntityIdentifier* DescriptionEntityListRequest::mutable_id() {
  
  if (id_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::NamedEntityIdentifier>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntityListRequest.id)
  return id_;
}
inline void DescriptionEntityListRequest::set_allocated_id(::nebulaidl::admin::NamedEntityIdentifier* id) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(id_);
  }
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntityListRequest.id)
}
...
inline ::google::protobuf::uint32 DescriptionEntityListRequest::limit() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityListRequest.limit)
  return limit_;
}
inline void DescriptionEntityListRequest::set_limit(::google::protobuf::uint32 value) {
  
  limit_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.DescriptionEntityListRequest.limit)
}
...
inline const ::std::string& DescriptionEntityListRequest::token() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityListRequest.token)
  return token_.GetNoArena();
}
inline void DescriptionEntityListRequest::set_token(const ::std::string& value) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.DescriptionEntityListRequest.token)
}
#if LANG_CXX11
inline void DescriptionEntityListRequest::set_token(::std::string&& value) {
  ...
  token_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.DescriptionEntityListRequest.token)
}
#endif
inline void DescriptionEntityListRequest::set_token(const char* value) {
  ...
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.DescriptionEntityListRequest.token)
}
inline void DescriptionEntityListRequest::set_token(const char* value, size_t size) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.DescriptionEntityListRequest.token)
}
inline ::std::string* DescriptionEntityListRequest::mutable_token() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntityListRequest.token)
  return token_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* DescriptionEntityListRequest::release_token() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntityListRequest.token)
...
inline void DescriptionEntityListRequest::set_allocated_token(::std::string* token) {
  ...
  token_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), token);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntityListRequest.token)
}
...
inline const ::std::string& DescriptionEntityListRequest::filters() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityListRequest.filters)
...
inline void DescriptionEntityListRequest::set_filters(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.DescriptionEntityListRequest.filters)
}
#if LANG_CXX11
inline void DescriptionEntityListRequest::set_filters(::std::string&& value) {
  ...
  filters_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.DescriptionEntityListRequest.filters)
}
#endif
inline void DescriptionEntityListRequest::set_filters(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.DescriptionEntityListRequest.filters)
}
inline void DescriptionEntityListRequest::set_filters(const char* value, size_t size) {
  ...
  filters_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.DescriptionEntityListRequest.filters)
}
inline ::std::string* DescriptionEntityListRequest::mutable_filters() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntityListRequest.filters)
...
inline ::std::string* DescriptionEntityListRequest::release_filters() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntityListRequest.filters)
...
inline void DescriptionEntityListRequest::set_allocated_filters(::std::string* filters) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntityListRequest.filters)
}
...
inline const ::nebulaidl::admin::Sort& DescriptionEntityListRequest::sort_by() const {
  const ::nebulaidl::admin::Sort* p = sort_by_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.DescriptionEntityListRequest.sort_by)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Sort*>(
      &::nebulaidl::admin::_Sort_default_instance_);
}
inline ::nebulaidl::admin::Sort* DescriptionEntityListRequest::release_sort_by() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.DescriptionEntityListRequest.sort_by)
  
  ::nebulaidl::admin::Sort* temp = sort_by_;
  sort_by_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Sort* DescriptionEntityListRequest::mutable_sort_by() {
  
  if (sort_by_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Sort>(GetArenaNoVirtual());
    sort_by_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.DescriptionEntityListRequest.sort_by)
  return sort_by_;
}
inline void DescriptionEntityListRequest::set_allocated_sort_by(::nebulaidl::admin::Sort* sort_by) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  sort_by_ = sort_by;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.DescriptionEntityListRequest.sort_by)
}
...
template <> struct is_proto_enum< ::nebulaidl::admin::DescriptionFormat> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::admin::DescriptionFormat>() {
  return ::nebulaidl::admin::DescriptionFormat_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fdescription_5fentity_2eproto
