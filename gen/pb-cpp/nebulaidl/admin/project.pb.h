...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fproject_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fproject_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fadmin_2fproject_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fadmin_2fproject_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::admin::Domain* Arena::CreateMaybeMessage<::nebulaidl::admin::Domain>(Arena*);
template<> ::nebulaidl::admin::Project* Arena::CreateMaybeMessage<::nebulaidl::admin::Project>(Arena*);
template<> ::nebulaidl::admin::ProjectListRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::ProjectListRequest>(Arena*);
template<> ::nebulaidl::admin::ProjectRegisterRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::ProjectRegisterRequest>(Arena*);
template<> ::nebulaidl::admin::ProjectRegisterResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::ProjectRegisterResponse>(Arena*);
template<> ::nebulaidl::admin::ProjectUpdateResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::ProjectUpdateResponse>(Arena*);
template<> ::nebulaidl::admin::Projects* Arena::CreateMaybeMessage<::nebulaidl::admin::Projects>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace admin {
...
class Domain final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.Domain) */ {
 public:
  Domain();
  virtual ~Domain();
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fadmin_2fproject_2eproto;
};
// -------------------------------------------------------------------

class Project final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.Project) */ {
 public:
  Project();
  virtual ~Project();
  ...
  ::nebulaidl::admin::Domain* mutable_domains(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Domain >*
      mutable_domains();
  const ::nebulaidl::admin::Domain& domains(int index) const;
  ::nebulaidl::admin::Domain* add_domains();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Domain >&
      domains() const;
  ...
  ::nebulaidl::admin::Project_ProjectState state() const;
  void set_state(::nebulaidl::admin::Project_ProjectState value);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Domain > domains_;
  ::google::protobuf::internal::ArenaStringPtr id_;
  ::google::protobuf::internal::ArenaStringPtr name_;
...
class Projects final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.Projects) */ {
 public:
  Projects();
  virtual ~Projects();
  ...
  ::nebulaidl::admin::Project* mutable_projects(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Project >*
      mutable_projects();
  const ::nebulaidl::admin::Project& projects(int index) const;
  ::nebulaidl::admin::Project* add_projects();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Project >&
      projects() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Project > projects_;
...
class ProjectListRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ProjectListRequest) */ {
 public:
  ProjectListRequest();
...
class ProjectRegisterRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ProjectRegisterRequest) */ {
 public:
  ...
  const ::nebulaidl::admin::Project& project() const;
  ::nebulaidl::admin::Project* release_project();
  ::nebulaidl::admin::Project* mutable_project();
  void set_allocated_project(::nebulaidl::admin::Project* project);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::nebulaidl::admin::Project* project_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fproject_2eproto;
};
// -------------------------------------------------------------------
...
class ProjectRegisterResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ProjectRegisterResponse) */ {
 public:
...
class ProjectUpdateResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ProjectUpdateResponse) */ {
 public:
...
inline const ::std::string& Domain::id() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Domain.id)
  return id_.GetNoArena();
}
inline void Domain::set_id(const ::std::string& value) {
  
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Domain.id)
}
#if LANG_CXX11
inline void Domain::set_id(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Domain.id)
}
#endif
inline void Domain::set_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Domain.id)
}
inline void Domain::set_id(const char* value, size_t size) {
  
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Domain.id)
}
inline ::std::string* Domain::mutable_id() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Domain.id)
  return id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Domain::release_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Domain.id)
...
inline void Domain::set_allocated_id(::std::string* id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Domain.id)
}
...
inline const ::std::string& Domain::name() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Domain.name)
  return name_.GetNoArena();
}
inline void Domain::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Domain.name)
}
#if LANG_CXX11
inline void Domain::set_name(::std::string&& value) {
  ...
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Domain.name)
}
#endif
inline void Domain::set_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Domain.name)
}
inline void Domain::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Domain.name)
}
inline ::std::string* Domain::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Domain.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Domain::release_name() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Domain.name)
...
inline void Domain::set_allocated_name(::std::string* name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Domain.name)
}
...
inline const ::std::string& Project::id() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Project.id)
  return id_.GetNoArena();
}
inline void Project::set_id(const ::std::string& value) {
  
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Project.id)
}
#if LANG_CXX11
inline void Project::set_id(::std::string&& value) {
  ...
  id_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Project.id)
}
#endif
inline void Project::set_id(const char* value) {
  ...
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Project.id)
}
inline void Project::set_id(const char* value, size_t size) {
  
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Project.id)
}
inline ::std::string* Project::mutable_id() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Project.id)
  return id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Project::release_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Project.id)
...
inline void Project::set_allocated_id(::std::string* id) {
  ...
  id_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), id);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Project.id)
}
...
inline const ::std::string& Project::name() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Project.name)
  return name_.GetNoArena();
}
inline void Project::set_name(const ::std::string& value) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Project.name)
}
#if LANG_CXX11
inline void Project::set_name(::std::string&& value) {
  ...
  name_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Project.name)
}
#endif
inline void Project::set_name(const char* value) {
  ...
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Project.name)
}
inline void Project::set_name(const char* value, size_t size) {
  
  name_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Project.name)
}
inline ::std::string* Project::mutable_name() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Project.name)
  return name_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Project::release_name() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Project.name)
...
inline void Project::set_allocated_name(::std::string* name) {
  ...
  name_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), name);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Project.name)
}
...
inline ::nebulaidl::admin::Domain* Project::mutable_domains(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Project.domains)
  return domains_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Domain >*
Project::mutable_domains() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.Project.domains)
  return &domains_;
}
inline const ::nebulaidl::admin::Domain& Project::domains(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Project.domains)
  return domains_.Get(index);
}
inline ::nebulaidl::admin::Domain* Project::add_domains() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.Project.domains)
  return domains_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Domain >&
Project::domains() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.Project.domains)
  return domains_;
}
...
inline const ::std::string& Project::description() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Project.description)
  return description_.GetNoArena();
}
inline void Project::set_description(const ::std::string& value) {
  
  description_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Project.description)
}
#if LANG_CXX11
inline void Project::set_description(::std::string&& value) {
  ...
  description_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Project.description)
}
#endif
inline void Project::set_description(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Project.description)
}
inline void Project::set_description(const char* value, size_t size) {
  
  description_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Project.description)
}
inline ::std::string* Project::mutable_description() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Project.description)
  return description_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Project::release_description() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Project.description)
...
inline void Project::set_allocated_description(::std::string* description) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Project.description)
}
...
inline const ::nebulaidl::admin::Labels& Project::labels() const {
  const ::nebulaidl::admin::Labels* p = labels_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Project.labels)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Labels*>(
      &::nebulaidl::admin::_Labels_default_instance_);
}
inline ::nebulaidl::admin::Labels* Project::release_labels() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Project.labels)
  
  ::nebulaidl::admin::Labels* temp = labels_;
  labels_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Labels* Project::mutable_labels() {
  
  if (labels_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Labels>(GetArenaNoVirtual());
    labels_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Project.labels)
  return labels_;
}
inline void Project::set_allocated_labels(::nebulaidl::admin::Labels* labels) {
  ...
  labels_ = labels;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Project.labels)
}
...
inline ::nebulaidl::admin::Project_ProjectState Project::state() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Project.state)
  return static_cast< ::nebulaidl::admin::Project_ProjectState >(state_);
}
inline void Project::set_state(::nebulaidl::admin::Project_ProjectState value) {
  
  state_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Project.state)
}
...
inline ::nebulaidl::admin::Project* Projects::mutable_projects(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Projects.projects)
  return projects_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Project >*
Projects::mutable_projects() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.Projects.projects)
  return &projects_;
}
inline const ::nebulaidl::admin::Project& Projects::projects(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Projects.projects)
  return projects_.Get(index);
}
inline ::nebulaidl::admin::Project* Projects::add_projects() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.Projects.projects)
  return projects_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Project >&
Projects::projects() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.Projects.projects)
  return projects_;
}
...
inline const ::std::string& Projects::token() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Projects.token)
  return token_.GetNoArena();
}
inline void Projects::set_token(const ::std::string& value) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Projects.token)
}
#if LANG_CXX11
inline void Projects::set_token(::std::string&& value) {
  ...
  token_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Projects.token)
}
#endif
inline void Projects::set_token(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Projects.token)
}
inline void Projects::set_token(const char* value, size_t size) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Projects.token)
}
inline ::std::string* Projects::mutable_token() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Projects.token)
  return token_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Projects::release_token() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Projects.token)
...
inline void Projects::set_allocated_token(::std::string* token) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Projects.token)
}
...
inline ::google::protobuf::uint32 ProjectListRequest::limit() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ProjectListRequest.limit)
  return limit_;
}
inline void ProjectListRequest::set_limit(::google::protobuf::uint32 value) {
  
  limit_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.ProjectListRequest.limit)
}
...
inline const ::std::string& ProjectListRequest::token() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ProjectListRequest.token)
  return token_.GetNoArena();
}
inline void ProjectListRequest::set_token(const ::std::string& value) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.ProjectListRequest.token)
}
#if LANG_CXX11
inline void ProjectListRequest::set_token(::std::string&& value) {
  ...
  token_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.ProjectListRequest.token)
}
#endif
inline void ProjectListRequest::set_token(const char* value) {
  ...
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.ProjectListRequest.token)
}
inline void ProjectListRequest::set_token(const char* value, size_t size) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.ProjectListRequest.token)
}
inline ::std::string* ProjectListRequest::mutable_token() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ProjectListRequest.token)
  return token_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ProjectListRequest::release_token() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.ProjectListRequest.token)
...
inline void ProjectListRequest::set_allocated_token(::std::string* token) {
  ...
  token_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), token);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.ProjectListRequest.token)
}
...
inline const ::std::string& ProjectListRequest::filters() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ProjectListRequest.filters)
...
inline void ProjectListRequest::set_filters(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.ProjectListRequest.filters)
}
#if LANG_CXX11
inline void ProjectListRequest::set_filters(::std::string&& value) {
  ...
  filters_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.ProjectListRequest.filters)
}
#endif
inline void ProjectListRequest::set_filters(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.ProjectListRequest.filters)
}
inline void ProjectListRequest::set_filters(const char* value, size_t size) {
  ...
  filters_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.ProjectListRequest.filters)
}
inline ::std::string* ProjectListRequest::mutable_filters() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ProjectListRequest.filters)
...
inline ::std::string* ProjectListRequest::release_filters() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.ProjectListRequest.filters)
...
inline void ProjectListRequest::set_allocated_filters(::std::string* filters) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.ProjectListRequest.filters)
}
...
inline const ::nebulaidl::admin::Sort& ProjectListRequest::sort_by() const {
  const ::nebulaidl::admin::Sort* p = sort_by_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ProjectListRequest.sort_by)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Sort*>(
      &::nebulaidl::admin::_Sort_default_instance_);
}
inline ::nebulaidl::admin::Sort* ProjectListRequest::release_sort_by() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.ProjectListRequest.sort_by)
  
  ::nebulaidl::admin::Sort* temp = sort_by_;
  sort_by_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Sort* ProjectListRequest::mutable_sort_by() {
  
  if (sort_by_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Sort>(GetArenaNoVirtual());
    sort_by_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ProjectListRequest.sort_by)
  return sort_by_;
}
inline void ProjectListRequest::set_allocated_sort_by(::nebulaidl::admin::Sort* sort_by) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  sort_by_ = sort_by;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.ProjectListRequest.sort_by)
}
...
inline const ::nebulaidl::admin::Project& ProjectRegisterRequest::project() const {
  const ::nebulaidl::admin::Project* p = project_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ProjectRegisterRequest.project)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Project*>(
      &::nebulaidl::admin::_Project_default_instance_);
}
inline ::nebulaidl::admin::Project* ProjectRegisterRequest::release_project() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.ProjectRegisterRequest.project)
  
  ::nebulaidl::admin::Project* temp = project_;
  project_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Project* ProjectRegisterRequest::mutable_project() {
  
  if (project_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Project>(GetArenaNoVirtual());
    project_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ProjectRegisterRequest.project)
  return project_;
}
inline void ProjectRegisterRequest::set_allocated_project(::nebulaidl::admin::Project* project) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete project_;
  }
  ...
  project_ = project;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.ProjectRegisterRequest.project)
}
...
template <> struct is_proto_enum< ::nebulaidl::admin::Project_ProjectState> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::admin::Project_ProjectState>() {
  return ::nebulaidl::admin::Project_ProjectState_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fproject_2eproto
