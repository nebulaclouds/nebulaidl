...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::admin::ClusterResourceAttributes* Arena::CreateMaybeMessage<::nebulaidl::admin::ClusterResourceAttributes>(Arena*);
template<> ::nebulaidl::admin::ClusterResourceAttributes_AttributesEntry_DoNotUse* Arena::CreateMaybeMessage<::nebulaidl::admin::ClusterResourceAttributes_AttributesEntry_DoNotUse>(Arena*);
template<> ::nebulaidl::admin::ExecutionClusterLabel* Arena::CreateMaybeMessage<::nebulaidl::admin::ExecutionClusterLabel>(Arena*);
template<> ::nebulaidl::admin::ExecutionQueueAttributes* Arena::CreateMaybeMessage<::nebulaidl::admin::ExecutionQueueAttributes>(Arena*);
template<> ::nebulaidl::admin::ListMatchableAttributesRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::ListMatchableAttributesRequest>(Arena*);
template<> ::nebulaidl::admin::ListMatchableAttributesResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::ListMatchableAttributesResponse>(Arena*);
template<> ::nebulaidl::admin::MatchableAttributesConfiguration* Arena::CreateMaybeMessage<::nebulaidl::admin::MatchableAttributesConfiguration>(Arena*);
template<> ::nebulaidl::admin::MatchingAttributes* Arena::CreateMaybeMessage<::nebulaidl::admin::MatchingAttributes>(Arena*);
template<> ::nebulaidl::admin::PluginOverride* Arena::CreateMaybeMessage<::nebulaidl::admin::PluginOverride>(Arena*);
template<> ::nebulaidl::admin::PluginOverrides* Arena::CreateMaybeMessage<::nebulaidl::admin::PluginOverrides>(Arena*);
template<> ::nebulaidl::admin::TaskResourceAttributes* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskResourceAttributes>(Arena*);
template<> ::nebulaidl::admin::TaskResourceSpec* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskResourceSpec>(Arena*);
template<> ::nebulaidl::admin::WorkflowExecutionConfig* Arena::CreateMaybeMessage<::nebulaidl::admin::WorkflowExecutionConfig>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace admin {
...
class TaskResourceSpec final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskResourceSpec) */ {
 public:
  TaskResourceSpec();
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto;
};
// -------------------------------------------------------------------

class TaskResourceAttributes final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskResourceAttributes) */ {
 public:
  ...
  const ::nebulaidl::admin::TaskResourceSpec& defaults() const;
  ::nebulaidl::admin::TaskResourceSpec* release_defaults();
  ::nebulaidl::admin::TaskResourceSpec* mutable_defaults();
  void set_allocated_defaults(::nebulaidl::admin::TaskResourceSpec* defaults);

  // .nebulaidl.admin.TaskResourceSpec limits = 2;
  bool has_limits() const;
  void clear_limits();
  static const int kLimitsFieldNumber = 2;
  const ::nebulaidl::admin::TaskResourceSpec& limits() const;
  ::nebulaidl::admin::TaskResourceSpec* release_limits();
  ::nebulaidl::admin::TaskResourceSpec* mutable_limits();
  void set_allocated_limits(::nebulaidl::admin::TaskResourceSpec* limits);
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::nebulaidl::admin::TaskResourceSpec* defaults_;
  ::nebulaidl::admin::TaskResourceSpec* limits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto;
};
// -------------------------------------------------------------------
...
class ClusterResourceAttributes final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ClusterResourceAttributes) */ {
 public:
...
class ExecutionQueueAttributes final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ExecutionQueueAttributes) */ {
 public:
...
class ExecutionClusterLabel final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ExecutionClusterLabel) */ {
 public:
...
class PluginOverride final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.PluginOverride) */ {
 public:
  PluginOverride();
  ...
  ::nebulaidl::admin::PluginOverride_MissingPluginBehavior missing_plugin_behavior() const;
  void set_missing_plugin_behavior(::nebulaidl::admin::PluginOverride_MissingPluginBehavior value);
...
class PluginOverrides final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.PluginOverrides) */ {
 public:
  PluginOverrides();
  ...
  ::nebulaidl::admin::PluginOverride* mutable_overrides(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::PluginOverride >*
      mutable_overrides();
  const ::nebulaidl::admin::PluginOverride& overrides(int index) const;
  ::nebulaidl::admin::PluginOverride* add_overrides();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::PluginOverride >&
      overrides() const;
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::PluginOverride > overrides_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto;
};
// -------------------------------------------------------------------
...
class WorkflowExecutionConfig final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.WorkflowExecutionConfig) */ {
 public:
...
class MatchingAttributes final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.MatchingAttributes) */ {
 public:
  MatchingAttributes();
  ...
  const ::nebulaidl::admin::TaskResourceAttributes& task_resource_attributes() const;
  ::nebulaidl::admin::TaskResourceAttributes* release_task_resource_attributes();
  ::nebulaidl::admin::TaskResourceAttributes* mutable_task_resource_attributes();
  void set_allocated_task_resource_attributes(::nebulaidl::admin::TaskResourceAttributes* task_resource_attributes);
  ...
  const ::nebulaidl::admin::ClusterResourceAttributes& cluster_resource_attributes() const;
  ::nebulaidl::admin::ClusterResourceAttributes* release_cluster_resource_attributes();
  ::nebulaidl::admin::ClusterResourceAttributes* mutable_cluster_resource_attributes();
  void set_allocated_cluster_resource_attributes(::nebulaidl::admin::ClusterResourceAttributes* cluster_resource_attributes);
  ...
  const ::nebulaidl::admin::ExecutionQueueAttributes& execution_queue_attributes() const;
  ::nebulaidl::admin::ExecutionQueueAttributes* release_execution_queue_attributes();
  ::nebulaidl::admin::ExecutionQueueAttributes* mutable_execution_queue_attributes();
  void set_allocated_execution_queue_attributes(::nebulaidl::admin::ExecutionQueueAttributes* execution_queue_attributes);
  ...
  const ::nebulaidl::admin::ExecutionClusterLabel& execution_cluster_label() const;
  ::nebulaidl::admin::ExecutionClusterLabel* release_execution_cluster_label();
  ::nebulaidl::admin::ExecutionClusterLabel* mutable_execution_cluster_label();
  void set_allocated_execution_cluster_label(::nebulaidl::admin::ExecutionClusterLabel* execution_cluster_label);
  ...
  const ::nebulaidl::admin::PluginOverrides& plugin_overrides() const;
  ::nebulaidl::admin::PluginOverrides* release_plugin_overrides();
  ::nebulaidl::admin::PluginOverrides* mutable_plugin_overrides();
  void set_allocated_plugin_overrides(::nebulaidl::admin::PluginOverrides* plugin_overrides);
  ...
  const ::nebulaidl::admin::WorkflowExecutionConfig& workflow_execution_config() const;
  ::nebulaidl::admin::WorkflowExecutionConfig* release_workflow_execution_config();
  ::nebulaidl::admin::WorkflowExecutionConfig* mutable_workflow_execution_config();
  void set_allocated_workflow_execution_config(::nebulaidl::admin::WorkflowExecutionConfig* workflow_execution_config);
 ...
 private:
  ...
  union TargetUnion {
    TargetUnion() {}
    ::nebulaidl::admin::TaskResourceAttributes* task_resource_attributes_;
    ::nebulaidl::admin::ClusterResourceAttributes* cluster_resource_attributes_;
    ::nebulaidl::admin::ExecutionQueueAttributes* execution_queue_attributes_;
    ::nebulaidl::admin::ExecutionClusterLabel* execution_cluster_label_;
    ::nebulaidl::core::QualityOfService* quality_of_service_;
    ::nebulaidl::admin::PluginOverrides* plugin_overrides_;
    ::nebulaidl::admin::WorkflowExecutionConfig* workflow_execution_config_;
...
class MatchableAttributesConfiguration final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.MatchableAttributesConfiguration) */ {
 public:
  ...
  void clear_attributes();
  static const int kAttributesFieldNumber = 1;
  const ::nebulaidl::admin::MatchingAttributes& attributes() const;
  ::nebulaidl::admin::MatchingAttributes* release_attributes();
  ::nebulaidl::admin::MatchingAttributes* mutable_attributes();
  void set_allocated_attributes(::nebulaidl::admin::MatchingAttributes* attributes);
 ...
 private:
  ...
  ::nebulaidl::admin::MatchingAttributes* attributes_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto;
};
// -------------------------------------------------------------------
...
class ListMatchableAttributesRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ListMatchableAttributesRequest) */ {
 public:
...
class ListMatchableAttributesResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.ListMatchableAttributesResponse) */ {
 public:
  ...
  ::nebulaidl::admin::MatchableAttributesConfiguration* mutable_configurations(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::MatchableAttributesConfiguration >*
      mutable_configurations();
  const ::nebulaidl::admin::MatchableAttributesConfiguration& configurations(int index) const;
  ::nebulaidl::admin::MatchableAttributesConfiguration* add_configurations();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::MatchableAttributesConfiguration >&
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::MatchableAttributesConfiguration > configurations_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto;
};
// ===================================================================
...
inline const ::std::string& TaskResourceSpec::cpu() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskResourceSpec.cpu)
...
inline void TaskResourceSpec::set_cpu(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskResourceSpec.cpu)
}
#if LANG_CXX11
inline void TaskResourceSpec::set_cpu(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskResourceSpec.cpu)
}
#endif
inline void TaskResourceSpec::set_cpu(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskResourceSpec.cpu)
}
inline void TaskResourceSpec::set_cpu(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskResourceSpec.cpu)
}
inline ::std::string* TaskResourceSpec::mutable_cpu() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskResourceSpec.cpu)
...
inline ::std::string* TaskResourceSpec::release_cpu() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskResourceSpec.cpu)
...
inline void TaskResourceSpec::set_allocated_cpu(::std::string* cpu) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskResourceSpec.cpu)
}
...
inline const ::std::string& TaskResourceSpec::gpu() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskResourceSpec.gpu)
...
inline void TaskResourceSpec::set_gpu(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskResourceSpec.gpu)
}
#if LANG_CXX11
inline void TaskResourceSpec::set_gpu(::std::string&& value) {
  ...
  gpu_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskResourceSpec.gpu)
}
#endif
inline void TaskResourceSpec::set_gpu(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskResourceSpec.gpu)
}
inline void TaskResourceSpec::set_gpu(const char* value, size_t size) {
  ...
  gpu_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskResourceSpec.gpu)
}
inline ::std::string* TaskResourceSpec::mutable_gpu() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskResourceSpec.gpu)
...
inline ::std::string* TaskResourceSpec::release_gpu() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskResourceSpec.gpu)
...
inline void TaskResourceSpec::set_allocated_gpu(::std::string* gpu) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskResourceSpec.gpu)
}
...
inline const ::std::string& TaskResourceSpec::memory() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskResourceSpec.memory)
...
inline void TaskResourceSpec::set_memory(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskResourceSpec.memory)
}
#if LANG_CXX11
inline void TaskResourceSpec::set_memory(::std::string&& value) {
  ...
  memory_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskResourceSpec.memory)
}
#endif
inline void TaskResourceSpec::set_memory(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskResourceSpec.memory)
}
inline void TaskResourceSpec::set_memory(const char* value, size_t size) {
  ...
  memory_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskResourceSpec.memory)
}
inline ::std::string* TaskResourceSpec::mutable_memory() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskResourceSpec.memory)
...
inline ::std::string* TaskResourceSpec::release_memory() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskResourceSpec.memory)
...
inline void TaskResourceSpec::set_allocated_memory(::std::string* memory) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskResourceSpec.memory)
}
...
inline const ::std::string& TaskResourceSpec::storage() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskResourceSpec.storage)
...
inline void TaskResourceSpec::set_storage(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskResourceSpec.storage)
}
#if LANG_CXX11
inline void TaskResourceSpec::set_storage(::std::string&& value) {
  ...
  storage_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskResourceSpec.storage)
}
#endif
inline void TaskResourceSpec::set_storage(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskResourceSpec.storage)
}
inline void TaskResourceSpec::set_storage(const char* value, size_t size) {
  ...
  storage_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskResourceSpec.storage)
}
inline ::std::string* TaskResourceSpec::mutable_storage() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskResourceSpec.storage)
...
inline ::std::string* TaskResourceSpec::release_storage() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskResourceSpec.storage)
...
inline void TaskResourceSpec::set_allocated_storage(::std::string* storage) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskResourceSpec.storage)
}
...
inline const ::std::string& TaskResourceSpec::ephemeral_storage() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
...
inline void TaskResourceSpec::set_ephemeral_storage(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
}
#if LANG_CXX11
inline void TaskResourceSpec::set_ephemeral_storage(::std::string&& value) {
  ...
  ephemeral_storage_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
}
#endif
inline void TaskResourceSpec::set_ephemeral_storage(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
}
inline void TaskResourceSpec::set_ephemeral_storage(const char* value, size_t size) {
  ...
  ephemeral_storage_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
}
inline ::std::string* TaskResourceSpec::mutable_ephemeral_storage() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
...
inline ::std::string* TaskResourceSpec::release_ephemeral_storage() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
...
inline void TaskResourceSpec::set_allocated_ephemeral_storage(::std::string* ephemeral_storage) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskResourceSpec.ephemeral_storage)
}
...
inline const ::nebulaidl::admin::TaskResourceSpec& TaskResourceAttributes::defaults() const {
  const ::nebulaidl::admin::TaskResourceSpec* p = defaults_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskResourceAttributes.defaults)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::TaskResourceSpec*>(
      &::nebulaidl::admin::_TaskResourceSpec_default_instance_);
}
inline ::nebulaidl::admin::TaskResourceSpec* TaskResourceAttributes::release_defaults() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskResourceAttributes.defaults)
  
  ::nebulaidl::admin::TaskResourceSpec* temp = defaults_;
  defaults_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::TaskResourceSpec* TaskResourceAttributes::mutable_defaults() {
  
  if (defaults_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::TaskResourceSpec>(GetArenaNoVirtual());
    defaults_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskResourceAttributes.defaults)
  return defaults_;
}
inline void TaskResourceAttributes::set_allocated_defaults(::nebulaidl::admin::TaskResourceSpec* defaults) {
  ...
  defaults_ = defaults;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskResourceAttributes.defaults)
}
...
inline const ::nebulaidl::admin::TaskResourceSpec& TaskResourceAttributes::limits() const {
  const ::nebulaidl::admin::TaskResourceSpec* p = limits_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskResourceAttributes.limits)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::TaskResourceSpec*>(
      &::nebulaidl::admin::_TaskResourceSpec_default_instance_);
}
inline ::nebulaidl::admin::TaskResourceSpec* TaskResourceAttributes::release_limits() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskResourceAttributes.limits)
  
  ::nebulaidl::admin::TaskResourceSpec* temp = limits_;
  limits_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::TaskResourceSpec* TaskResourceAttributes::mutable_limits() {
  
  if (limits_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::TaskResourceSpec>(GetArenaNoVirtual());
    limits_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskResourceAttributes.limits)
  return limits_;
}
inline void TaskResourceAttributes::set_allocated_limits(::nebulaidl::admin::TaskResourceSpec* limits) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete limits_;
  }
  ...
  limits_ = limits;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskResourceAttributes.limits)
}
...
ClusterResourceAttributes::attributes() const {
  // @@protoc_insertion_point(field_map:nebulaidl.admin.ClusterResourceAttributes.attributes)
  return attributes_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::std::string >*
ClusterResourceAttributes::mutable_attributes() {
  // @@protoc_insertion_point(field_mutable_map:nebulaidl.admin.ClusterResourceAttributes.attributes)
...
inline const ::std::string& ExecutionQueueAttributes::tags(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ExecutionQueueAttributes.tags)
  return tags_.Get(index);
}
inline ::std::string* ExecutionQueueAttributes::mutable_tags(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ExecutionQueueAttributes.tags)
  return tags_.Mutable(index);
}
inline void ExecutionQueueAttributes::set_tags(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.admin.ExecutionQueueAttributes.tags)
...
inline void ExecutionQueueAttributes::set_tags(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tags_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.ExecutionQueueAttributes.tags)
}
inline void ExecutionQueueAttributes::set_tags(int index, const char* value, size_t size) {
  tags_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.ExecutionQueueAttributes.tags)
}
inline ::std::string* ExecutionQueueAttributes::add_tags() {
  // @@protoc_insertion_point(field_add_mutable:nebulaidl.admin.ExecutionQueueAttributes.tags)
  return tags_.Add();
}
inline void ExecutionQueueAttributes::add_tags(const ::std::string& value) {
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:nebulaidl.admin.ExecutionQueueAttributes.tags)
}
#if LANG_CXX11
...
inline void ExecutionQueueAttributes::add_tags(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  tags_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:nebulaidl.admin.ExecutionQueueAttributes.tags)
}
inline void ExecutionQueueAttributes::add_tags(const char* value, size_t size) {
  tags_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:nebulaidl.admin.ExecutionQueueAttributes.tags)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
ExecutionQueueAttributes::tags() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.ExecutionQueueAttributes.tags)
  return tags_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>*
ExecutionQueueAttributes::mutable_tags() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.ExecutionQueueAttributes.tags)
  return &tags_;
}
...
inline const ::std::string& ExecutionClusterLabel::value() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ExecutionClusterLabel.value)
  return value_.GetNoArena();
}
inline void ExecutionClusterLabel::set_value(const ::std::string& value) {
  
  value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.ExecutionClusterLabel.value)
}
#if LANG_CXX11
inline void ExecutionClusterLabel::set_value(::std::string&& value) {
  ...
  value_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.ExecutionClusterLabel.value)
}
#endif
inline void ExecutionClusterLabel::set_value(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.ExecutionClusterLabel.value)
}
inline void ExecutionClusterLabel::set_value(const char* value, size_t size) {
  
  value_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.ExecutionClusterLabel.value)
}
inline ::std::string* ExecutionClusterLabel::mutable_value() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ExecutionClusterLabel.value)
  return value_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* ExecutionClusterLabel::release_value() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.ExecutionClusterLabel.value)
...
inline void ExecutionClusterLabel::set_allocated_value(::std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.ExecutionClusterLabel.value)
}
...
inline const ::std::string& PluginOverride::task_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.PluginOverride.task_type)
...
inline void PluginOverride::set_task_type(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.PluginOverride.task_type)
}
#if LANG_CXX11
inline void PluginOverride::set_task_type(::std::string&& value) {
  ...
  task_type_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.PluginOverride.task_type)
}
#endif
inline void PluginOverride::set_task_type(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.PluginOverride.task_type)
}
inline void PluginOverride::set_task_type(const char* value, size_t size) {
  ...
  task_type_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.PluginOverride.task_type)
}
inline ::std::string* PluginOverride::mutable_task_type() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.PluginOverride.task_type)
...
inline ::std::string* PluginOverride::release_task_type() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.PluginOverride.task_type)
...
inline void PluginOverride::set_allocated_task_type(::std::string* task_type) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.PluginOverride.task_type)
}
...
inline const ::std::string& PluginOverride::plugin_id(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.PluginOverride.plugin_id)
  return plugin_id_.Get(index);
}
inline ::std::string* PluginOverride::mutable_plugin_id(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.PluginOverride.plugin_id)
  return plugin_id_.Mutable(index);
}
inline void PluginOverride::set_plugin_id(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.admin.PluginOverride.plugin_id)
...
inline void PluginOverride::set_plugin_id(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  plugin_id_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.PluginOverride.plugin_id)
}
inline void PluginOverride::set_plugin_id(int index, const char* value, size_t size) {
  plugin_id_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.PluginOverride.plugin_id)
}
inline ::std::string* PluginOverride::add_plugin_id() {
  // @@protoc_insertion_point(field_add_mutable:nebulaidl.admin.PluginOverride.plugin_id)
  return plugin_id_.Add();
}
inline void PluginOverride::add_plugin_id(const ::std::string& value) {
  plugin_id_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:nebulaidl.admin.PluginOverride.plugin_id)
}
#if LANG_CXX11
...
inline void PluginOverride::add_plugin_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  plugin_id_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:nebulaidl.admin.PluginOverride.plugin_id)
}
inline void PluginOverride::add_plugin_id(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:nebulaidl.admin.PluginOverride.plugin_id)
}
inline const ::google::protobuf::RepeatedPtrField<::std::string>&
PluginOverride::plugin_id() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.PluginOverride.plugin_id)
  return plugin_id_;
}
inline ::google::protobuf::RepeatedPtrField<::std::string>*
PluginOverride::mutable_plugin_id() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.PluginOverride.plugin_id)
  return &plugin_id_;
}
...
inline ::nebulaidl::admin::PluginOverride_MissingPluginBehavior PluginOverride::missing_plugin_behavior() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.PluginOverride.missing_plugin_behavior)
  return static_cast< ::nebulaidl::admin::PluginOverride_MissingPluginBehavior >(missing_plugin_behavior_);
}
inline void PluginOverride::set_missing_plugin_behavior(::nebulaidl::admin::PluginOverride_MissingPluginBehavior value) {
  
  missing_plugin_behavior_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.PluginOverride.missing_plugin_behavior)
}
...
inline ::nebulaidl::admin::PluginOverride* PluginOverrides::mutable_overrides(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.PluginOverrides.overrides)
  return overrides_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::PluginOverride >*
PluginOverrides::mutable_overrides() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.PluginOverrides.overrides)
  return &overrides_;
}
inline const ::nebulaidl::admin::PluginOverride& PluginOverrides::overrides(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.PluginOverrides.overrides)
  return overrides_.Get(index);
}
inline ::nebulaidl::admin::PluginOverride* PluginOverrides::add_overrides() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.PluginOverrides.overrides)
  return overrides_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::PluginOverride >&
PluginOverrides::overrides() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.PluginOverrides.overrides)
  return overrides_;
}
...
inline ::google::protobuf::int32 WorkflowExecutionConfig::max_parallelism() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.max_parallelism)
...
inline void WorkflowExecutionConfig::set_max_parallelism(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.WorkflowExecutionConfig.max_parallelism)
}
...
inline const ::nebulaidl::core::SecurityContext& WorkflowExecutionConfig::security_context() const {
  const ::nebulaidl::core::SecurityContext* p = security_context_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.security_context)
...
inline ::nebulaidl::core::SecurityContext* WorkflowExecutionConfig::release_security_context() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionConfig.security_context)
  
  ::nebulaidl::core::SecurityContext* temp = security_context_;
  security_context_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::SecurityContext* WorkflowExecutionConfig::mutable_security_context() {
  
  if (security_context_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::SecurityContext>(GetArenaNoVirtual());
    security_context_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionConfig.security_context)
  return security_context_;
}
inline void WorkflowExecutionConfig::set_allocated_security_context(::nebulaidl::core::SecurityContext* security_context) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionConfig.security_context)
}
...
inline const ::nebulaidl::admin::RawOutputDataConfig& WorkflowExecutionConfig::raw_output_data_config() const {
  const ::nebulaidl::admin::RawOutputDataConfig* p = raw_output_data_config_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.raw_output_data_config)
...
inline ::nebulaidl::admin::RawOutputDataConfig* WorkflowExecutionConfig::release_raw_output_data_config() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionConfig.raw_output_data_config)
  
  ::nebulaidl::admin::RawOutputDataConfig* temp = raw_output_data_config_;
  raw_output_data_config_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::RawOutputDataConfig* WorkflowExecutionConfig::mutable_raw_output_data_config() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionConfig.raw_output_data_config)
  return raw_output_data_config_;
}
inline void WorkflowExecutionConfig::set_allocated_raw_output_data_config(::nebulaidl::admin::RawOutputDataConfig* raw_output_data_config) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionConfig.raw_output_data_config)
}
...
inline const ::nebulaidl::admin::Labels& WorkflowExecutionConfig::labels() const {
  const ::nebulaidl::admin::Labels* p = labels_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.labels)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Labels*>(
      &::nebulaidl::admin::_Labels_default_instance_);
}
inline ::nebulaidl::admin::Labels* WorkflowExecutionConfig::release_labels() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionConfig.labels)
  
  ::nebulaidl::admin::Labels* temp = labels_;
  labels_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Labels* WorkflowExecutionConfig::mutable_labels() {
  
  if (labels_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Labels>(GetArenaNoVirtual());
    labels_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionConfig.labels)
  return labels_;
}
inline void WorkflowExecutionConfig::set_allocated_labels(::nebulaidl::admin::Labels* labels) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  labels_ = labels;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionConfig.labels)
}
...
inline const ::nebulaidl::admin::Annotations& WorkflowExecutionConfig::annotations() const {
  const ::nebulaidl::admin::Annotations* p = annotations_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.annotations)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Annotations*>(
      &::nebulaidl::admin::_Annotations_default_instance_);
}
inline ::nebulaidl::admin::Annotations* WorkflowExecutionConfig::release_annotations() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionConfig.annotations)
  
  ::nebulaidl::admin::Annotations* temp = annotations_;
  annotations_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Annotations* WorkflowExecutionConfig::mutable_annotations() {
  
  if (annotations_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Annotations>(GetArenaNoVirtual());
    annotations_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionConfig.annotations)
  return annotations_;
}
inline void WorkflowExecutionConfig::set_allocated_annotations(::nebulaidl::admin::Annotations* annotations) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionConfig.annotations)
}
...
inline const ::google::protobuf::BoolValue& WorkflowExecutionConfig::interruptible() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.interruptible)
...
inline ::google::protobuf::BoolValue* WorkflowExecutionConfig::release_interruptible() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionConfig.interruptible)
...
inline ::google::protobuf::BoolValue* WorkflowExecutionConfig::mutable_interruptible() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionConfig.interruptible)
...
inline void WorkflowExecutionConfig::set_allocated_interruptible(::google::protobuf::BoolValue* interruptible) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionConfig.interruptible)
}
...
inline bool WorkflowExecutionConfig::overwrite_cache() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.overwrite_cache)
  return overwrite_cache_;
}
inline void WorkflowExecutionConfig::set_overwrite_cache(bool value) {
  
  overwrite_cache_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.WorkflowExecutionConfig.overwrite_cache)
}
...
inline const ::nebulaidl::admin::Envs& WorkflowExecutionConfig::envs() const {
  const ::nebulaidl::admin::Envs* p = envs_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.WorkflowExecutionConfig.envs)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Envs*>(
      &::nebulaidl::admin::_Envs_default_instance_);
}
inline ::nebulaidl::admin::Envs* WorkflowExecutionConfig::release_envs() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.WorkflowExecutionConfig.envs)
  
  ::nebulaidl::admin::Envs* temp = envs_;
  envs_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Envs* WorkflowExecutionConfig::mutable_envs() {
  
  if (envs_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Envs>(GetArenaNoVirtual());
    envs_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.WorkflowExecutionConfig.envs)
  return envs_;
}
inline void WorkflowExecutionConfig::set_allocated_envs(::nebulaidl::admin::Envs* envs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  envs_ = envs;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.WorkflowExecutionConfig.envs)
}
...
inline ::nebulaidl::admin::TaskResourceAttributes* MatchingAttributes::release_task_resource_attributes() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.task_resource_attributes)
  if (has_task_resource_attributes()) {
    clear_has_target();
      ::nebulaidl::admin::TaskResourceAttributes* temp = target_.task_resource_attributes_;
...
inline const ::nebulaidl::admin::TaskResourceAttributes& MatchingAttributes::task_resource_attributes() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.task_resource_attributes)
  return has_task_resource_attributes()
      ? *target_.task_resource_attributes_
      : *reinterpret_cast< ::nebulaidl::admin::TaskResourceAttributes*>(&::nebulaidl::admin::_TaskResourceAttributes_default_instance_);
}
inline ::nebulaidl::admin::TaskResourceAttributes* MatchingAttributes::mutable_task_resource_attributes() {
  if (!has_task_resource_attributes()) {
    clear_target();
    set_has_task_resource_attributes();
    target_.task_resource_attributes_ = CreateMaybeMessage< ::nebulaidl::admin::TaskResourceAttributes >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.task_resource_attributes)
...
inline ::nebulaidl::admin::ClusterResourceAttributes* MatchingAttributes::release_cluster_resource_attributes() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.cluster_resource_attributes)
  if (has_cluster_resource_attributes()) {
    clear_has_target();
      ::nebulaidl::admin::ClusterResourceAttributes* temp = target_.cluster_resource_attributes_;
...
inline const ::nebulaidl::admin::ClusterResourceAttributes& MatchingAttributes::cluster_resource_attributes() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.cluster_resource_attributes)
  return has_cluster_resource_attributes()
      ? *target_.cluster_resource_attributes_
      : *reinterpret_cast< ::nebulaidl::admin::ClusterResourceAttributes*>(&::nebulaidl::admin::_ClusterResourceAttributes_default_instance_);
}
inline ::nebulaidl::admin::ClusterResourceAttributes* MatchingAttributes::mutable_cluster_resource_attributes() {
  if (!has_cluster_resource_attributes()) {
    clear_target();
    set_has_cluster_resource_attributes();
    target_.cluster_resource_attributes_ = CreateMaybeMessage< ::nebulaidl::admin::ClusterResourceAttributes >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.cluster_resource_attributes)
...
inline ::nebulaidl::admin::ExecutionQueueAttributes* MatchingAttributes::release_execution_queue_attributes() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.execution_queue_attributes)
  if (has_execution_queue_attributes()) {
    clear_has_target();
      ::nebulaidl::admin::ExecutionQueueAttributes* temp = target_.execution_queue_attributes_;
...
inline const ::nebulaidl::admin::ExecutionQueueAttributes& MatchingAttributes::execution_queue_attributes() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.execution_queue_attributes)
  return has_execution_queue_attributes()
      ? *target_.execution_queue_attributes_
      : *reinterpret_cast< ::nebulaidl::admin::ExecutionQueueAttributes*>(&::nebulaidl::admin::_ExecutionQueueAttributes_default_instance_);
}
inline ::nebulaidl::admin::ExecutionQueueAttributes* MatchingAttributes::mutable_execution_queue_attributes() {
  if (!has_execution_queue_attributes()) {
    clear_target();
    set_has_execution_queue_attributes();
    target_.execution_queue_attributes_ = CreateMaybeMessage< ::nebulaidl::admin::ExecutionQueueAttributes >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.execution_queue_attributes)
...
inline ::nebulaidl::admin::ExecutionClusterLabel* MatchingAttributes::release_execution_cluster_label() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.execution_cluster_label)
  if (has_execution_cluster_label()) {
    clear_has_target();
      ::nebulaidl::admin::ExecutionClusterLabel* temp = target_.execution_cluster_label_;
...
inline const ::nebulaidl::admin::ExecutionClusterLabel& MatchingAttributes::execution_cluster_label() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.execution_cluster_label)
  return has_execution_cluster_label()
      ? *target_.execution_cluster_label_
      : *reinterpret_cast< ::nebulaidl::admin::ExecutionClusterLabel*>(&::nebulaidl::admin::_ExecutionClusterLabel_default_instance_);
}
inline ::nebulaidl::admin::ExecutionClusterLabel* MatchingAttributes::mutable_execution_cluster_label() {
  if (!has_execution_cluster_label()) {
    clear_target();
    set_has_execution_cluster_label();
    target_.execution_cluster_label_ = CreateMaybeMessage< ::nebulaidl::admin::ExecutionClusterLabel >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.execution_cluster_label)
...
inline ::nebulaidl::core::QualityOfService* MatchingAttributes::release_quality_of_service() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.quality_of_service)
  if (has_quality_of_service()) {
    clear_has_target();
      ::nebulaidl::core::QualityOfService* temp = target_.quality_of_service_;
...
inline const ::nebulaidl::core::QualityOfService& MatchingAttributes::quality_of_service() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.quality_of_service)
  return has_quality_of_service()
      ? *target_.quality_of_service_
      : *reinterpret_cast< ::nebulaidl::core::QualityOfService*>(&::nebulaidl::core::_QualityOfService_default_instance_);
}
inline ::nebulaidl::core::QualityOfService* MatchingAttributes::mutable_quality_of_service() {
  if (!has_quality_of_service()) {
    clear_target();
    set_has_quality_of_service();
    target_.quality_of_service_ = CreateMaybeMessage< ::nebulaidl::core::QualityOfService >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.quality_of_service)
...
inline ::nebulaidl::admin::PluginOverrides* MatchingAttributes::release_plugin_overrides() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.plugin_overrides)
  if (has_plugin_overrides()) {
    clear_has_target();
      ::nebulaidl::admin::PluginOverrides* temp = target_.plugin_overrides_;
...
inline const ::nebulaidl::admin::PluginOverrides& MatchingAttributes::plugin_overrides() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.plugin_overrides)
  return has_plugin_overrides()
      ? *target_.plugin_overrides_
      : *reinterpret_cast< ::nebulaidl::admin::PluginOverrides*>(&::nebulaidl::admin::_PluginOverrides_default_instance_);
}
inline ::nebulaidl::admin::PluginOverrides* MatchingAttributes::mutable_plugin_overrides() {
  if (!has_plugin_overrides()) {
    clear_target();
    set_has_plugin_overrides();
    target_.plugin_overrides_ = CreateMaybeMessage< ::nebulaidl::admin::PluginOverrides >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.plugin_overrides)
...
inline ::nebulaidl::admin::WorkflowExecutionConfig* MatchingAttributes::release_workflow_execution_config() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.workflow_execution_config)
  if (has_workflow_execution_config()) {
    clear_has_target();
      ::nebulaidl::admin::WorkflowExecutionConfig* temp = target_.workflow_execution_config_;
...
inline const ::nebulaidl::admin::WorkflowExecutionConfig& MatchingAttributes::workflow_execution_config() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.workflow_execution_config)
  return has_workflow_execution_config()
      ? *target_.workflow_execution_config_
      : *reinterpret_cast< ::nebulaidl::admin::WorkflowExecutionConfig*>(&::nebulaidl::admin::_WorkflowExecutionConfig_default_instance_);
}
inline ::nebulaidl::admin::WorkflowExecutionConfig* MatchingAttributes::mutable_workflow_execution_config() {
  if (!has_workflow_execution_config()) {
    clear_target();
    set_has_workflow_execution_config();
    target_.workflow_execution_config_ = CreateMaybeMessage< ::nebulaidl::admin::WorkflowExecutionConfig >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.workflow_execution_config)
...
inline ::nebulaidl::admin::ClusterAssignment* MatchingAttributes::release_cluster_assignment() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchingAttributes.cluster_assignment)
  if (has_cluster_assignment()) {
    clear_has_target();
      ::nebulaidl::admin::ClusterAssignment* temp = target_.cluster_assignment_;
...
inline const ::nebulaidl::admin::ClusterAssignment& MatchingAttributes::cluster_assignment() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchingAttributes.cluster_assignment)
  return has_cluster_assignment()
      ? *target_.cluster_assignment_
      : *reinterpret_cast< ::nebulaidl::admin::ClusterAssignment*>(&::nebulaidl::admin::_ClusterAssignment_default_instance_);
}
inline ::nebulaidl::admin::ClusterAssignment* MatchingAttributes::mutable_cluster_assignment() {
  if (!has_cluster_assignment()) {
    clear_target();
    set_has_cluster_assignment();
    target_.cluster_assignment_ = CreateMaybeMessage< ::nebulaidl::admin::ClusterAssignment >(
        GetArenaNoVirtual());
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchingAttributes.cluster_assignment)
...
inline const ::nebulaidl::admin::MatchingAttributes& MatchableAttributesConfiguration::attributes() const {
  const ::nebulaidl::admin::MatchingAttributes* p = attributes_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchableAttributesConfiguration.attributes)
...
inline ::nebulaidl::admin::MatchingAttributes* MatchableAttributesConfiguration::release_attributes() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchableAttributesConfiguration.attributes)
  
  ::nebulaidl::admin::MatchingAttributes* temp = attributes_;
  attributes_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::MatchingAttributes* MatchableAttributesConfiguration::mutable_attributes() {
  
  if (attributes_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::MatchingAttributes>(GetArenaNoVirtual());
    attributes_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchableAttributesConfiguration.attributes)
  return attributes_;
}
inline void MatchableAttributesConfiguration::set_allocated_attributes(::nebulaidl::admin::MatchingAttributes* attributes) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete attributes_;
  }
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.MatchableAttributesConfiguration.attributes)
}
...
inline const ::std::string& MatchableAttributesConfiguration::domain() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchableAttributesConfiguration.domain)
  return domain_.GetNoArena();
}
inline void MatchableAttributesConfiguration::set_domain(const ::std::string& value) {
  
  domain_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.MatchableAttributesConfiguration.domain)
}
#if LANG_CXX11
inline void MatchableAttributesConfiguration::set_domain(::std::string&& value) {
  ...
  domain_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.MatchableAttributesConfiguration.domain)
}
#endif
inline void MatchableAttributesConfiguration::set_domain(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.MatchableAttributesConfiguration.domain)
}
inline void MatchableAttributesConfiguration::set_domain(const char* value, size_t size) {
  
  domain_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.MatchableAttributesConfiguration.domain)
}
inline ::std::string* MatchableAttributesConfiguration::mutable_domain() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchableAttributesConfiguration.domain)
  return domain_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* MatchableAttributesConfiguration::release_domain() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchableAttributesConfiguration.domain)
...
inline void MatchableAttributesConfiguration::set_allocated_domain(::std::string* domain) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.MatchableAttributesConfiguration.domain)
}
...
inline const ::std::string& MatchableAttributesConfiguration::project() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchableAttributesConfiguration.project)
...
inline void MatchableAttributesConfiguration::set_project(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.MatchableAttributesConfiguration.project)
}
#if LANG_CXX11
inline void MatchableAttributesConfiguration::set_project(::std::string&& value) {
  ...
  project_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.MatchableAttributesConfiguration.project)
}
#endif
inline void MatchableAttributesConfiguration::set_project(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.MatchableAttributesConfiguration.project)
}
inline void MatchableAttributesConfiguration::set_project(const char* value, size_t size) {
  ...
  project_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.MatchableAttributesConfiguration.project)
}
inline ::std::string* MatchableAttributesConfiguration::mutable_project() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchableAttributesConfiguration.project)
...
inline ::std::string* MatchableAttributesConfiguration::release_project() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchableAttributesConfiguration.project)
...
inline void MatchableAttributesConfiguration::set_allocated_project(::std::string* project) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.MatchableAttributesConfiguration.project)
}
...
inline const ::std::string& MatchableAttributesConfiguration::workflow() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
...
inline void MatchableAttributesConfiguration::set_workflow(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
}
#if LANG_CXX11
inline void MatchableAttributesConfiguration::set_workflow(::std::string&& value) {
  ...
  workflow_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
}
#endif
inline void MatchableAttributesConfiguration::set_workflow(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
}
inline void MatchableAttributesConfiguration::set_workflow(const char* value, size_t size) {
  ...
  workflow_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
}
inline ::std::string* MatchableAttributesConfiguration::mutable_workflow() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
...
inline ::std::string* MatchableAttributesConfiguration::release_workflow() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
...
inline void MatchableAttributesConfiguration::set_allocated_workflow(::std::string* workflow) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.MatchableAttributesConfiguration.workflow)
}
...
inline const ::std::string& MatchableAttributesConfiguration::launch_plan() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
...
inline void MatchableAttributesConfiguration::set_launch_plan(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
}
#if LANG_CXX11
inline void MatchableAttributesConfiguration::set_launch_plan(::std::string&& value) {
  ...
  launch_plan_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
}
#endif
inline void MatchableAttributesConfiguration::set_launch_plan(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
}
inline void MatchableAttributesConfiguration::set_launch_plan(const char* value, size_t size) {
  ...
  launch_plan_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
}
inline ::std::string* MatchableAttributesConfiguration::mutable_launch_plan() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
...
inline ::std::string* MatchableAttributesConfiguration::release_launch_plan() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
...
inline void MatchableAttributesConfiguration::set_allocated_launch_plan(::std::string* launch_plan) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.MatchableAttributesConfiguration.launch_plan)
}
...
inline ::nebulaidl::admin::MatchableResource ListMatchableAttributesRequest::resource_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ListMatchableAttributesRequest.resource_type)
  return static_cast< ::nebulaidl::admin::MatchableResource >(resource_type_);
}
inline void ListMatchableAttributesRequest::set_resource_type(::nebulaidl::admin::MatchableResource value) {
  
  resource_type_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.ListMatchableAttributesRequest.resource_type)
}
...
inline ::nebulaidl::admin::MatchableAttributesConfiguration* ListMatchableAttributesResponse::mutable_configurations(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.ListMatchableAttributesResponse.configurations)
  return configurations_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::MatchableAttributesConfiguration >*
ListMatchableAttributesResponse::mutable_configurations() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.ListMatchableAttributesResponse.configurations)
  return &configurations_;
}
inline const ::nebulaidl::admin::MatchableAttributesConfiguration& ListMatchableAttributesResponse::configurations(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.ListMatchableAttributesResponse.configurations)
  return configurations_.Get(index);
}
inline ::nebulaidl::admin::MatchableAttributesConfiguration* ListMatchableAttributesResponse::add_configurations() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.ListMatchableAttributesResponse.configurations)
  return configurations_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::MatchableAttributesConfiguration >&
ListMatchableAttributesResponse::configurations() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.ListMatchableAttributesResponse.configurations)
  return configurations_;
}
...
template <> struct is_proto_enum< ::nebulaidl::admin::PluginOverride_MissingPluginBehavior> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::admin::PluginOverride_MissingPluginBehavior>() {
  return ::nebulaidl::admin::PluginOverride_MissingPluginBehavior_descriptor();
}
template <> struct is_proto_enum< ::nebulaidl::admin::MatchableResource> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::nebulaidl::admin::MatchableResource>() {
  return ::nebulaidl::admin::MatchableResource_descriptor();
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fadmin_2fmatchable_5fresource_2eproto
