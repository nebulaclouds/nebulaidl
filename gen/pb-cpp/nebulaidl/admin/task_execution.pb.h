...
#ifndef PROTOBUF_INCLUDED_nebulaidl_2fadmin_2ftask_5fexecution_2eproto
#define PROTOBUF_INCLUDED_nebulaidl_2fadmin_2ftask_5fexecution_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_nebulaidl_2fadmin_2ftask_5fexecution_2eproto

// Internal implementation detail -- do not use these members.
struct TableStruct_nebulaidl_2fadmin_2ftask_5fexecution_2eproto {
...
namespace google {
namespace protobuf {
template<> ::nebulaidl::admin::Reason* Arena::CreateMaybeMessage<::nebulaidl::admin::Reason>(Arena*);
template<> ::nebulaidl::admin::TaskExecution* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecution>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionClosure* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionClosure>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionGetDataRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionGetDataRequest>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionGetDataResponse* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionGetDataResponse>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionGetRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionGetRequest>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionList* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionList>(Arena*);
template<> ::nebulaidl::admin::TaskExecutionListRequest* Arena::CreateMaybeMessage<::nebulaidl::admin::TaskExecutionListRequest>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace nebulaidl {
namespace admin {
...
class TaskExecutionGetRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionGetRequest) */ {
 public:
 ...
 private:
  ...
  friend struct ::TableStruct_nebulaidl_2fadmin_2ftask_5fexecution_2eproto;
};
// -------------------------------------------------------------------

class TaskExecutionListRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionListRequest) */ {
 public:
...
class TaskExecution final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecution) */ {
 public:
  TaskExecution();
  ...
  const ::nebulaidl::admin::TaskExecutionClosure& closure() const;
  ::nebulaidl::admin::TaskExecutionClosure* release_closure();
  ::nebulaidl::admin::TaskExecutionClosure* mutable_closure();
  void set_allocated_closure(::nebulaidl::admin::TaskExecutionClosure* closure);
 ...
 private:
  ...
  ::nebulaidl::core::TaskExecutionIdentifier* id_;
  ::nebulaidl::admin::TaskExecutionClosure* closure_;
  bool is_parent_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2ftask_5fexecution_2eproto;
};
...
class TaskExecutionList final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionList) */ {
 public:
  TaskExecutionList();
  ...
  ::nebulaidl::admin::TaskExecution* mutable_task_executions(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::TaskExecution >*
      mutable_task_executions();
  const ::nebulaidl::admin::TaskExecution& task_executions(int index) const;
  ::nebulaidl::admin::TaskExecution* add_task_executions();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::TaskExecution >&
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::TaskExecution > task_executions_;
  ::google::protobuf::internal::ArenaStringPtr token_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_nebulaidl_2fadmin_2ftask_5fexecution_2eproto;
};
...
class TaskExecutionClosure final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionClosure) */ {
 public:
  ...
  ::nebulaidl::admin::Reason* mutable_reasons(int index);
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Reason >*
      mutable_reasons();
  const ::nebulaidl::admin::Reason& reasons(int index) const;
  ::nebulaidl::admin::Reason* add_reasons();
  const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Reason >&
      reasons() const;
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Reason > reasons_;
...
class Reason final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.Reason) */ {
 public:
  Reason();
  virtual ~Reason();
...
class TaskExecutionGetDataRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionGetDataRequest) */ {
 public:
...
class TaskExecutionGetDataResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:nebulaidl.admin.TaskExecutionGetDataResponse) */ {
 public:
  ...
  static const int kNebulaUrlsFieldNumber = 5;
...
inline const ::nebulaidl::core::TaskExecutionIdentifier& TaskExecutionGetRequest::id() const {
  const ::nebulaidl::core::TaskExecutionIdentifier* p = id_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionGetRequest.id)
...
inline ::nebulaidl::core::TaskExecutionIdentifier* TaskExecutionGetRequest::release_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionGetRequest.id)
  
  ::nebulaidl::core::TaskExecutionIdentifier* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::TaskExecutionIdentifier* TaskExecutionGetRequest::mutable_id() {
  
  if (id_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::TaskExecutionIdentifier>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionGetRequest.id)
  return id_;
}
inline void TaskExecutionGetRequest::set_allocated_id(::nebulaidl::core::TaskExecutionIdentifier* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionGetRequest.id)
}
...
inline const ::nebulaidl::core::NodeExecutionIdentifier& TaskExecutionListRequest::node_execution_id() const {
  const ::nebulaidl::core::NodeExecutionIdentifier* p = node_execution_id_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionListRequest.node_execution_id)
...
inline ::nebulaidl::core::NodeExecutionIdentifier* TaskExecutionListRequest::release_node_execution_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionListRequest.node_execution_id)
  
  ::nebulaidl::core::NodeExecutionIdentifier* temp = node_execution_id_;
  node_execution_id_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::NodeExecutionIdentifier* TaskExecutionListRequest::mutable_node_execution_id() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionListRequest.node_execution_id)
  return node_execution_id_;
}
inline void TaskExecutionListRequest::set_allocated_node_execution_id(::nebulaidl::core::NodeExecutionIdentifier* node_execution_id) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionListRequest.node_execution_id)
}
...
inline ::google::protobuf::uint32 TaskExecutionListRequest::limit() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionListRequest.limit)
  return limit_;
}
inline void TaskExecutionListRequest::set_limit(::google::protobuf::uint32 value) {
  
  limit_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionListRequest.limit)
}
...
inline const ::std::string& TaskExecutionListRequest::token() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionListRequest.token)
  return token_.GetNoArena();
}
inline void TaskExecutionListRequest::set_token(const ::std::string& value) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionListRequest.token)
}
#if LANG_CXX11
inline void TaskExecutionListRequest::set_token(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecutionListRequest.token)
}
#endif
inline void TaskExecutionListRequest::set_token(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecutionListRequest.token)
}
inline void TaskExecutionListRequest::set_token(const char* value, size_t size) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecutionListRequest.token)
}
inline ::std::string* TaskExecutionListRequest::mutable_token() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionListRequest.token)
  return token_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TaskExecutionListRequest::release_token() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionListRequest.token)
...
inline void TaskExecutionListRequest::set_allocated_token(::std::string* token) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionListRequest.token)
}
...
inline const ::std::string& TaskExecutionListRequest::filters() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionListRequest.filters)
...
inline void TaskExecutionListRequest::set_filters(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionListRequest.filters)
}
#if LANG_CXX11
inline void TaskExecutionListRequest::set_filters(::std::string&& value) {
  ...
  filters_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecutionListRequest.filters)
}
#endif
inline void TaskExecutionListRequest::set_filters(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecutionListRequest.filters)
}
inline void TaskExecutionListRequest::set_filters(const char* value, size_t size) {
  ...
  filters_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecutionListRequest.filters)
}
inline ::std::string* TaskExecutionListRequest::mutable_filters() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionListRequest.filters)
...
inline ::std::string* TaskExecutionListRequest::release_filters() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionListRequest.filters)
...
inline void TaskExecutionListRequest::set_allocated_filters(::std::string* filters) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionListRequest.filters)
}
...
inline const ::nebulaidl::admin::Sort& TaskExecutionListRequest::sort_by() const {
  const ::nebulaidl::admin::Sort* p = sort_by_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionListRequest.sort_by)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::Sort*>(
      &::nebulaidl::admin::_Sort_default_instance_);
}
inline ::nebulaidl::admin::Sort* TaskExecutionListRequest::release_sort_by() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionListRequest.sort_by)
  
  ::nebulaidl::admin::Sort* temp = sort_by_;
  sort_by_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::Sort* TaskExecutionListRequest::mutable_sort_by() {
  
  if (sort_by_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::Sort>(GetArenaNoVirtual());
    sort_by_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionListRequest.sort_by)
  return sort_by_;
}
inline void TaskExecutionListRequest::set_allocated_sort_by(::nebulaidl::admin::Sort* sort_by) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  sort_by_ = sort_by;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionListRequest.sort_by)
}
...
inline const ::nebulaidl::core::TaskExecutionIdentifier& TaskExecution::id() const {
  const ::nebulaidl::core::TaskExecutionIdentifier* p = id_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecution.id)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::TaskExecutionIdentifier*>(
      &::nebulaidl::core::_TaskExecutionIdentifier_default_instance_);
}
inline ::nebulaidl::core::TaskExecutionIdentifier* TaskExecution::release_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecution.id)
  
  ::nebulaidl::core::TaskExecutionIdentifier* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::TaskExecutionIdentifier* TaskExecution::mutable_id() {
  
  if (id_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::TaskExecutionIdentifier>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecution.id)
  return id_;
}
inline void TaskExecution::set_allocated_id(::nebulaidl::core::TaskExecutionIdentifier* id) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(id_);
  }
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecution.id)
}
...
inline const ::std::string& TaskExecution::input_uri() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecution.input_uri)
...
inline void TaskExecution::set_input_uri(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecution.input_uri)
}
#if LANG_CXX11
inline void TaskExecution::set_input_uri(::std::string&& value) {
  ...
  input_uri_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecution.input_uri)
}
#endif
inline void TaskExecution::set_input_uri(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecution.input_uri)
}
inline void TaskExecution::set_input_uri(const char* value, size_t size) {
  ...
  input_uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecution.input_uri)
}
inline ::std::string* TaskExecution::mutable_input_uri() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecution.input_uri)
...
inline ::std::string* TaskExecution::release_input_uri() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecution.input_uri)
...
inline void TaskExecution::set_allocated_input_uri(::std::string* input_uri) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecution.input_uri)
}
...
inline const ::nebulaidl::admin::TaskExecutionClosure& TaskExecution::closure() const {
  const ::nebulaidl::admin::TaskExecutionClosure* p = closure_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecution.closure)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::TaskExecutionClosure*>(
      &::nebulaidl::admin::_TaskExecutionClosure_default_instance_);
}
inline ::nebulaidl::admin::TaskExecutionClosure* TaskExecution::release_closure() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecution.closure)
  
  ::nebulaidl::admin::TaskExecutionClosure* temp = closure_;
  closure_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::TaskExecutionClosure* TaskExecution::mutable_closure() {
  
  if (closure_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::TaskExecutionClosure>(GetArenaNoVirtual());
    closure_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecution.closure)
  return closure_;
}
inline void TaskExecution::set_allocated_closure(::nebulaidl::admin::TaskExecutionClosure* closure) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete closure_;
  }
  ...
  closure_ = closure;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecution.closure)
}
...
inline bool TaskExecution::is_parent() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecution.is_parent)
  return is_parent_;
}
inline void TaskExecution::set_is_parent(bool value) {
  
  is_parent_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecution.is_parent)
}
...
inline ::nebulaidl::admin::TaskExecution* TaskExecutionList::mutable_task_executions(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionList.task_executions)
  return task_executions_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::TaskExecution >*
TaskExecutionList::mutable_task_executions() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.TaskExecutionList.task_executions)
  return &task_executions_;
}
inline const ::nebulaidl::admin::TaskExecution& TaskExecutionList::task_executions(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionList.task_executions)
  return task_executions_.Get(index);
}
inline ::nebulaidl::admin::TaskExecution* TaskExecutionList::add_task_executions() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.TaskExecutionList.task_executions)
  return task_executions_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::TaskExecution >&
TaskExecutionList::task_executions() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.TaskExecutionList.task_executions)
  return task_executions_;
}
...
inline const ::std::string& TaskExecutionList::token() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionList.token)
  return token_.GetNoArena();
}
inline void TaskExecutionList::set_token(const ::std::string& value) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionList.token)
}
#if LANG_CXX11
inline void TaskExecutionList::set_token(::std::string&& value) {
  ...
  token_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecutionList.token)
}
#endif
inline void TaskExecutionList::set_token(const char* value) {
  ...
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecutionList.token)
}
inline void TaskExecutionList::set_token(const char* value, size_t size) {
  
  token_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecutionList.token)
}
inline ::std::string* TaskExecutionList::mutable_token() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionList.token)
  return token_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TaskExecutionList::release_token() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionList.token)
...
inline void TaskExecutionList::set_allocated_token(::std::string* token) {
  ...
  token_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), token);
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionList.token)
}
...
inline const ::std::string& TaskExecutionClosure::output_uri() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.output_uri)
  if (has_output_uri()) {
...
inline void TaskExecutionClosure::set_output_uri(const ::std::string& value) {
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionClosure.output_uri)
  if (!has_output_uri()) {
    clear_output_result();
    set_has_output_uri();
...
inline void TaskExecutionClosure::set_output_uri(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecutionClosure.output_uri)
}
#endif
inline void TaskExecutionClosure::set_output_uri(const char* value) {
  ...
  output_result_.output_uri_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(value));
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecutionClosure.output_uri)
}
inline void TaskExecutionClosure::set_output_uri(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecutionClosure.output_uri)
}
inline ::std::string* TaskExecutionClosure::mutable_output_uri() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.output_uri)
...
inline ::std::string* TaskExecutionClosure::release_output_uri() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.output_uri)
  if (has_output_uri()) {
    clear_has_output_result();
...
inline void TaskExecutionClosure::set_allocated_output_uri(::std::string* output_uri) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.output_uri)
}
...
inline ::nebulaidl::core::ExecutionError* TaskExecutionClosure::release_error() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.error)
  if (has_error()) {
    clear_has_output_result();
...
inline const ::nebulaidl::core::ExecutionError& TaskExecutionClosure::error() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.error)
  return has_error()
      ? *output_result_.error_
      : *reinterpret_cast< ::nebulaidl::core::ExecutionError*>(&::nebulaidl::core::_ExecutionError_default_instance_);
}
inline ::nebulaidl::core::ExecutionError* TaskExecutionClosure::mutable_error() {
  if (!has_error()) {
    clear_output_result();
    set_has_error();
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.error)
...
inline ::nebulaidl::core::LiteralMap* TaskExecutionClosure::release_output_data() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.output_data)
  if (has_output_data()) {
    clear_has_output_result();
...
inline const ::nebulaidl::core::LiteralMap& TaskExecutionClosure::output_data() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.output_data)
...
inline ::nebulaidl::core::LiteralMap* TaskExecutionClosure::mutable_output_data() {
  if (!has_output_data()) {
    clear_output_result();
    set_has_output_data();
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.output_data)
...
inline ::nebulaidl::core::TaskExecution_Phase TaskExecutionClosure::phase() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.phase)
  return static_cast< ::nebulaidl::core::TaskExecution_Phase >(phase_);
}
inline void TaskExecutionClosure::set_phase(::nebulaidl::core::TaskExecution_Phase value) {
  
  phase_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionClosure.phase)
}
...
inline ::nebulaidl::core::TaskLog* TaskExecutionClosure::mutable_logs(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.logs)
  return logs_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::core::TaskLog >*
TaskExecutionClosure::mutable_logs() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.TaskExecutionClosure.logs)
  return &logs_;
}
inline const ::nebulaidl::core::TaskLog& TaskExecutionClosure::logs(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.logs)
  return logs_.Get(index);
}
inline ::nebulaidl::core::TaskLog* TaskExecutionClosure::add_logs() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.TaskExecutionClosure.logs)
  return logs_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::core::TaskLog >&
TaskExecutionClosure::logs() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.TaskExecutionClosure.logs)
  return logs_;
}
...
inline const ::google::protobuf::Timestamp& TaskExecutionClosure::started_at() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.started_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* TaskExecutionClosure::release_started_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.started_at)
...
inline ::google::protobuf::Timestamp* TaskExecutionClosure::mutable_started_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.started_at)
  return started_at_;
}
inline void TaskExecutionClosure::set_allocated_started_at(::google::protobuf::Timestamp* started_at) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.started_at)
}
...
inline const ::google::protobuf::Duration& TaskExecutionClosure::duration() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.duration)
...
inline ::google::protobuf::Duration* TaskExecutionClosure::release_duration() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.duration)
...
inline ::google::protobuf::Duration* TaskExecutionClosure::mutable_duration() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.duration)
  return duration_;
}
inline void TaskExecutionClosure::set_allocated_duration(::google::protobuf::Duration* duration) {
  ...
  duration_ = duration;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.duration)
}
...
inline const ::google::protobuf::Timestamp& TaskExecutionClosure::created_at() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.created_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* TaskExecutionClosure::release_created_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.created_at)
...
inline ::google::protobuf::Timestamp* TaskExecutionClosure::mutable_created_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.created_at)
  return created_at_;
}
inline void TaskExecutionClosure::set_allocated_created_at(::google::protobuf::Timestamp* created_at) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.created_at)
}
...
inline const ::google::protobuf::Timestamp& TaskExecutionClosure::updated_at() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.updated_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* TaskExecutionClosure::release_updated_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.updated_at)
...
inline ::google::protobuf::Timestamp* TaskExecutionClosure::mutable_updated_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.updated_at)
  return updated_at_;
}
inline void TaskExecutionClosure::set_allocated_updated_at(::google::protobuf::Timestamp* updated_at) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.updated_at)
}
...
inline const ::google::protobuf::Struct& TaskExecutionClosure::custom_info() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.custom_info)
...
inline ::google::protobuf::Struct* TaskExecutionClosure::release_custom_info() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.custom_info)
...
inline ::google::protobuf::Struct* TaskExecutionClosure::mutable_custom_info() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.custom_info)
  return custom_info_;
}
inline void TaskExecutionClosure::set_allocated_custom_info(::google::protobuf::Struct* custom_info) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.custom_info)
}
...
inline const ::std::string& TaskExecutionClosure::reason() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.reason)
  return reason_.GetNoArena();
}
inline void TaskExecutionClosure::set_reason(const ::std::string& value) {
  
  reason_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionClosure.reason)
}
#if LANG_CXX11
inline void TaskExecutionClosure::set_reason(::std::string&& value) {
  ...
  reason_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecutionClosure.reason)
}
#endif
inline void TaskExecutionClosure::set_reason(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecutionClosure.reason)
}
inline void TaskExecutionClosure::set_reason(const char* value, size_t size) {
  
  reason_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecutionClosure.reason)
}
inline ::std::string* TaskExecutionClosure::mutable_reason() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.reason)
  return reason_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* TaskExecutionClosure::release_reason() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.reason)
...
inline void TaskExecutionClosure::set_allocated_reason(::std::string* reason) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.reason)
}
...
inline const ::std::string& TaskExecutionClosure::task_type() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.task_type)
...
inline void TaskExecutionClosure::set_task_type(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionClosure.task_type)
}
#if LANG_CXX11
inline void TaskExecutionClosure::set_task_type(::std::string&& value) {
  ...
  task_type_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.TaskExecutionClosure.task_type)
}
#endif
inline void TaskExecutionClosure::set_task_type(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.TaskExecutionClosure.task_type)
}
inline void TaskExecutionClosure::set_task_type(const char* value, size_t size) {
  ...
  task_type_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.TaskExecutionClosure.task_type)
}
inline ::std::string* TaskExecutionClosure::mutable_task_type() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.task_type)
...
inline ::std::string* TaskExecutionClosure::release_task_type() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.task_type)
...
inline void TaskExecutionClosure::set_allocated_task_type(::std::string* task_type) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.task_type)
}
...
inline const ::nebulaidl::event::TaskExecutionMetadata& TaskExecutionClosure::metadata() const {
  const ::nebulaidl::event::TaskExecutionMetadata* p = metadata_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.metadata)
...
inline ::nebulaidl::event::TaskExecutionMetadata* TaskExecutionClosure::release_metadata() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionClosure.metadata)
  
  ::nebulaidl::event::TaskExecutionMetadata* temp = metadata_;
  metadata_ = nullptr;
  return temp;
}
inline ::nebulaidl::event::TaskExecutionMetadata* TaskExecutionClosure::mutable_metadata() {
  
  if (metadata_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::event::TaskExecutionMetadata>(GetArenaNoVirtual());
    metadata_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.metadata)
  return metadata_;
}
inline void TaskExecutionClosure::set_allocated_metadata(::nebulaidl::event::TaskExecutionMetadata* metadata) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  metadata_ = metadata;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionClosure.metadata)
}
...
inline ::google::protobuf::int32 TaskExecutionClosure::event_version() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.event_version)
  return event_version_;
}
inline void TaskExecutionClosure::set_event_version(::google::protobuf::int32 value) {
  
  event_version_ = value;
  // @@protoc_insertion_point(field_set:nebulaidl.admin.TaskExecutionClosure.event_version)
}
...
inline ::nebulaidl::admin::Reason* TaskExecutionClosure::mutable_reasons(int index) {
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionClosure.reasons)
  return reasons_.Mutable(index);
}
inline ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Reason >*
TaskExecutionClosure::mutable_reasons() {
  // @@protoc_insertion_point(field_mutable_list:nebulaidl.admin.TaskExecutionClosure.reasons)
  return &reasons_;
}
inline const ::nebulaidl::admin::Reason& TaskExecutionClosure::reasons(int index) const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionClosure.reasons)
  return reasons_.Get(index);
}
inline ::nebulaidl::admin::Reason* TaskExecutionClosure::add_reasons() {
  // @@protoc_insertion_point(field_add:nebulaidl.admin.TaskExecutionClosure.reasons)
  return reasons_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::nebulaidl::admin::Reason >&
TaskExecutionClosure::reasons() const {
  // @@protoc_insertion_point(field_list:nebulaidl.admin.TaskExecutionClosure.reasons)
  return reasons_;
}
...
inline const ::google::protobuf::Timestamp& Reason::occurred_at() const {
  ...
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Reason.occurred_at)
  return p != nullptr ? *p : *reinterpret_cast<const ::google::protobuf::Timestamp*>(
      &::google::protobuf::_Timestamp_default_instance_);
}
inline ::google::protobuf::Timestamp* Reason::release_occurred_at() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Reason.occurred_at)
...
inline ::google::protobuf::Timestamp* Reason::mutable_occurred_at() {
  ...
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Reason.occurred_at)
  return occurred_at_;
}
inline void Reason::set_allocated_occurred_at(::google::protobuf::Timestamp* occurred_at) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Reason.occurred_at)
}
...
inline const ::std::string& Reason::message() const {
  // @@protoc_insertion_point(field_get:nebulaidl.admin.Reason.message)
  return message_.GetNoArena();
}
inline void Reason::set_message(const ::std::string& value) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:nebulaidl.admin.Reason.message)
}
#if LANG_CXX11
inline void Reason::set_message(::std::string&& value) {
  ...
  message_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:nebulaidl.admin.Reason.message)
}
#endif
inline void Reason::set_message(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:nebulaidl.admin.Reason.message)
}
inline void Reason::set_message(const char* value, size_t size) {
  
  message_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:nebulaidl.admin.Reason.message)
}
inline ::std::string* Reason::mutable_message() {
  
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.Reason.message)
  return message_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Reason::release_message() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.Reason.message)
...
inline void Reason::set_allocated_message(::std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.Reason.message)
}
...
inline const ::nebulaidl::core::TaskExecutionIdentifier& TaskExecutionGetDataRequest::id() const {
  const ::nebulaidl::core::TaskExecutionIdentifier* p = id_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionGetDataRequest.id)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::TaskExecutionIdentifier*>(
      &::nebulaidl::core::_TaskExecutionIdentifier_default_instance_);
}
inline ::nebulaidl::core::TaskExecutionIdentifier* TaskExecutionGetDataRequest::release_id() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionGetDataRequest.id)
  
  ::nebulaidl::core::TaskExecutionIdentifier* temp = id_;
  id_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::TaskExecutionIdentifier* TaskExecutionGetDataRequest::mutable_id() {
  
  if (id_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::TaskExecutionIdentifier>(GetArenaNoVirtual());
    id_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionGetDataRequest.id)
  return id_;
}
inline void TaskExecutionGetDataRequest::set_allocated_id(::nebulaidl::core::TaskExecutionIdentifier* id) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::google::protobuf::MessageLite*>(id_);
  }
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionGetDataRequest.id)
}
...
inline const ::nebulaidl::admin::UrlBlob& TaskExecutionGetDataResponse::inputs() const {
  const ::nebulaidl::admin::UrlBlob* p = inputs_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionGetDataResponse.inputs)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::UrlBlob*>(
      &::nebulaidl::admin::_UrlBlob_default_instance_);
}
inline ::nebulaidl::admin::UrlBlob* TaskExecutionGetDataResponse::release_inputs() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionGetDataResponse.inputs)
  
  ::nebulaidl::admin::UrlBlob* temp = inputs_;
  inputs_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::UrlBlob* TaskExecutionGetDataResponse::mutable_inputs() {
  
  if (inputs_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::UrlBlob>(GetArenaNoVirtual());
    inputs_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionGetDataResponse.inputs)
  return inputs_;
}
inline void TaskExecutionGetDataResponse::set_allocated_inputs(::nebulaidl::admin::UrlBlob* inputs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  inputs_ = inputs;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionGetDataResponse.inputs)
}
...
inline const ::nebulaidl::admin::UrlBlob& TaskExecutionGetDataResponse::outputs() const {
  const ::nebulaidl::admin::UrlBlob* p = outputs_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionGetDataResponse.outputs)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::UrlBlob*>(
      &::nebulaidl::admin::_UrlBlob_default_instance_);
}
inline ::nebulaidl::admin::UrlBlob* TaskExecutionGetDataResponse::release_outputs() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionGetDataResponse.outputs)
  
  ::nebulaidl::admin::UrlBlob* temp = outputs_;
  outputs_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::UrlBlob* TaskExecutionGetDataResponse::mutable_outputs() {
  
  if (outputs_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::UrlBlob>(GetArenaNoVirtual());
    outputs_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionGetDataResponse.outputs)
  return outputs_;
}
inline void TaskExecutionGetDataResponse::set_allocated_outputs(::nebulaidl::admin::UrlBlob* outputs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  outputs_ = outputs;
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionGetDataResponse.outputs)
}
...
inline const ::nebulaidl::core::LiteralMap& TaskExecutionGetDataResponse::full_inputs() const {
  const ::nebulaidl::core::LiteralMap* p = full_inputs_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionGetDataResponse.full_inputs)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::LiteralMap*>(
      &::nebulaidl::core::_LiteralMap_default_instance_);
}
inline ::nebulaidl::core::LiteralMap* TaskExecutionGetDataResponse::release_full_inputs() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionGetDataResponse.full_inputs)
  
  ::nebulaidl::core::LiteralMap* temp = full_inputs_;
  full_inputs_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::LiteralMap* TaskExecutionGetDataResponse::mutable_full_inputs() {
  
  if (full_inputs_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::LiteralMap>(GetArenaNoVirtual());
    full_inputs_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionGetDataResponse.full_inputs)
  return full_inputs_;
}
inline void TaskExecutionGetDataResponse::set_allocated_full_inputs(::nebulaidl::core::LiteralMap* full_inputs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionGetDataResponse.full_inputs)
}
...
inline const ::nebulaidl::core::LiteralMap& TaskExecutionGetDataResponse::full_outputs() const {
  const ::nebulaidl::core::LiteralMap* p = full_outputs_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionGetDataResponse.full_outputs)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::core::LiteralMap*>(
      &::nebulaidl::core::_LiteralMap_default_instance_);
}
inline ::nebulaidl::core::LiteralMap* TaskExecutionGetDataResponse::release_full_outputs() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionGetDataResponse.full_outputs)
  
  ::nebulaidl::core::LiteralMap* temp = full_outputs_;
  full_outputs_ = nullptr;
  return temp;
}
inline ::nebulaidl::core::LiteralMap* TaskExecutionGetDataResponse::mutable_full_outputs() {
  
  if (full_outputs_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::core::LiteralMap>(GetArenaNoVirtual());
    full_outputs_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionGetDataResponse.full_outputs)
  return full_outputs_;
}
inline void TaskExecutionGetDataResponse::set_allocated_full_outputs(::nebulaidl::core::LiteralMap* full_outputs) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionGetDataResponse.full_outputs)
}

// .nebulaidl.admin.NebulaURLs nebula_urls = 5;
inline bool TaskExecutionGetDataResponse::has_nebula_urls() const {
  return this != internal_default_instance() && nebula_urls_ != nullptr;
}
inline const ::nebulaidl::admin::NebulaURLs& TaskExecutionGetDataResponse::nebula_urls() const {
  const ::nebulaidl::admin::NebulaURLs* p = nebula_urls_;
  // @@protoc_insertion_point(field_get:nebulaidl.admin.TaskExecutionGetDataResponse.nebula_urls)
  return p != nullptr ? *p : *reinterpret_cast<const ::nebulaidl::admin::NebulaURLs*>(
      &::nebulaidl::admin::_NebulaURLs_default_instance_);
}
inline ::nebulaidl::admin::NebulaURLs* TaskExecutionGetDataResponse::release_nebula_urls() {
  // @@protoc_insertion_point(field_release:nebulaidl.admin.TaskExecutionGetDataResponse.nebula_urls)
  
  ::nebulaidl::admin::NebulaURLs* temp = nebula_urls_;
  nebula_urls_ = nullptr;
  return temp;
}
inline ::nebulaidl::admin::NebulaURLs* TaskExecutionGetDataResponse::mutable_nebula_urls() {
  
  if (nebula_urls_ == nullptr) {
    auto* p = CreateMaybeMessage<::nebulaidl::admin::NebulaURLs>(GetArenaNoVirtual());
    nebula_urls_ = p;
  }
  // @@protoc_insertion_point(field_mutable:nebulaidl.admin.TaskExecutionGetDataResponse.nebula_urls)
  return nebula_urls_;
}
inline void TaskExecutionGetDataResponse::set_allocated_nebula_urls(::nebulaidl::admin::NebulaURLs* nebula_urls) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:nebulaidl.admin.TaskExecutionGetDataResponse.nebula_urls)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_nebulaidl_2fadmin_2ftask_5fexecution_2eproto
