...
.. _ref_nebulaidl/event/event.proto:

nebulaidl/event/event.proto
==================================================================
...
.. _ref_nebulaidl.event.DynamicWorkflowNodeMetadata:
...
.. _ref_nebulaidl.event.ExternalResourceInfo:
...
.. csv-table:: ExternalResourceInfo type fields
   ...
   "phase", ":ref:`ref_nebulaidl.core.TaskExecution.Phase`", "", "Phase associated with the external resource"
   "cache_status", ":ref:`ref_nebulaidl.core.CatalogCacheStatus`", "", "Captures the status of caching for this external resource execution."
   "logs", ":ref:`ref_nebulaidl.core.TaskLog`", "repeated", "log information for the external resource execution"
...
.. _ref_nebulaidl.event.NodeExecutionEvent:
...
.. csv-table:: NodeExecutionEvent type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", "Unique identifier for this node execution"
   "producer_id", ":ref:`ref_string`", "", "the id of the originator (Propeller) of the event"
   "phase", ":ref:`ref_nebulaidl.core.NodeExecution.Phase`", "", ""
   ...
   "error", ":ref:`ref_nebulaidl.core.ExecutionError`", "", "Error information for the execution"
   "output_data", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Raw output data produced by this node execution."
   "workflow_node_metadata", ":ref:`ref_nebulaidl.event.WorkflowNodeMetadata`", "", ""
   "task_node_metadata", ":ref:`ref_nebulaidl.event.TaskNodeMetadata`", "", ""
   "parent_task_metadata", ":ref:`ref_nebulaidl.event.ParentTaskExecutionMetadata`", "", "[To be deprecated] Specifies which task (if any) launched this node."
   "parent_node_metadata", ":ref:`ref_nebulaidl.event.ParentNodeExecutionMetadata`", "", "Specifies the parent node of the current node execution. Node executions at level zero will not have a parent node."
...
.. _ref_nebulaidl.event.ParentNodeExecutionMetadata:
...
.. _ref_nebulaidl.event.ParentTaskExecutionMetadata:
...
.. csv-table:: ParentTaskExecutionMetadata type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.TaskExecutionIdentifier`", "", ""
...
.. _ref_nebulaidl.event.ResourcePoolInfo:
...
.. _ref_nebulaidl.event.TaskExecutionEvent:
...
.. csv-table:: TaskExecutionEvent type fields
   ...
   "task_id", ":ref:`ref_nebulaidl.core.Identifier`", "", "ID of the task. In combination with the retryAttempt this will indicate the task execution uniquely for a given parent node execution."
   "parent_node_execution_id", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", "A task execution is always kicked off by a node execution, the event consumer will use the parent_id to relate the task to it's parent node execution"
   "retry_attempt", ":ref:`ref_uint32`", "", "retry attempt number for this task, ie., 2 for the second attempt"
   "phase", ":ref:`ref_nebulaidl.core.TaskExecution.Phase`", "", "Phase associated with the event"
   "producer_id", ":ref:`ref_string`", "", "id of the process that sent this event, mainly for trace debugging"
   "logs", ":ref:`ref_nebulaidl.core.TaskLog`", "repeated", "log information for the task execution"
   ...
   "error", ":ref:`ref_nebulaidl.core.ExecutionError`", "", "Error information for the execution"
   "output_data", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Raw output data produced by this task execution."
   ...
   "task_type", ":ref:`ref_string`", "", "A predefined yet extensible Task type identifier. If the task definition is already registered in nebula admin this type will be identical, but not all task executions necessarily use pre-registered definitions and this type is useful to render the task in the UI, filter task executions, etc."
...
.. _ref_nebulaidl.event.TaskExecutionMetadata:
...
.. csv-table:: TaskExecutionMetadata type fields
   ...
   "external_resources", ":ref:`ref_nebulaidl.event.ExternalResourceInfo`", "repeated", "Additional data on external resources on other back-ends or platforms (e.g. Hive, Qubole, etc) launched by this task execution."
   "resource_pool_info", ":ref:`ref_nebulaidl.event.ResourcePoolInfo`", "repeated", "Includes additional data on concurrent resource management used during execution.. This is a repeated field because a plugin can request multiple resource allocations during execution."
   "plugin_identifier", ":ref:`ref_string`", "", "The identifier of the plugin used to execute this task."
   "instance_class", ":ref:`ref_nebulaidl.event.TaskExecutionMetadata.InstanceClass`", "", ""
...
.. _ref_nebulaidl.event.TaskNodeMetadata:
...
.. csv-table:: TaskNodeMetadata type fields
   ...
   "reservation_status", ":ref:`ref_nebulaidl.core.CatalogReservation.Status`", "", "Captures the status of cache reservations for this execution."
   "checkpoint_uri", ":ref:`ref_string`", "", "The latest checkpoint location"
   "dynamic_workflow", ":ref:`ref_nebulaidl.event.DynamicWorkflowNodeMetadata`", "", "In the case this task launched a dynamic workflow we capture its structure here."
...
.. _ref_nebulaidl.event.WorkflowExecutionEvent:
...
.. csv-table:: WorkflowExecutionEvent type fields
   ...
   "execution_id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Workflow execution id"
   "producer_id", ":ref:`ref_string`", "", "the id of the originator (Propeller) of the event"
   ...
   "output_uri", ":ref:`ref_string`", "", "URL to the output of the execution, it encodes all the information including Cloud source provider. ie., s3://..."
   "error", ":ref:`ref_nebulaidl.core.ExecutionError`", "", "Error information for the execution"
   "output_data", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "Raw output data produced by this workflow execution."
...
.. _ref_nebulaidl.event.WorkflowNodeMetadata:
...
.. _ref_nebulaidl.event.TaskExecutionMetadata.InstanceClass:
...
.. csv-table:: Enum TaskExecutionMetadata.InstanceClass values
   ...
   "DEFAULT", "0", "The default instance class configured for the nebula application platform."
