...
.. _ref_nebulaidl/core/catalog.proto:

nebulaidl/core/catalog.proto
==================================================================
...
.. _ref_nebulaidl.core.CatalogArtifactTag:
...
.. csv-table:: CatalogArtifactTag type fields
   ...
   "name", ":ref:`ref_string`", "", "Nebula computes the tag automatically, as the hash of the values"
...
.. _ref_nebulaidl.core.CatalogMetadata:
...
.. csv-table:: CatalogMetadata type fields
   ...
   "dataset_id", ":ref:`ref_nebulaidl.core.Identifier`", "", "Dataset ID in the catalog"
   "artifact_tag", ":ref:`ref_nebulaidl.core.CatalogArtifactTag`", "", "Artifact tag in the catalog"
   "source_task_execution", ":ref:`ref_nebulaidl.core.TaskExecutionIdentifier`", "", "Today we only support TaskExecutionIdentifier as a source, as catalog caching only works for task executions"
...
.. _ref_nebulaidl.core.CatalogReservation:
...
.. _ref_nebulaidl.core.CatalogCacheStatus:
...
.. _ref_nebulaidl.core.CatalogReservation.Status:
...
.. _ref_nebulaidl/core/compiler.proto:

nebulaidl/core/compiler.proto
==================================================================
...
.. _ref_nebulaidl.core.CompiledTask:
...
.. csv-table:: CompiledTask type fields
   ...
   "template", ":ref:`ref_nebulaidl.core.TaskTemplate`", "", "Completely contained TaskTemplate"
...
.. _ref_nebulaidl.core.CompiledWorkflow:
...
.. csv-table:: CompiledWorkflow type fields
   ...
   "template", ":ref:`ref_nebulaidl.core.WorkflowTemplate`", "", "Completely contained Workflow Template"
   "connections", ":ref:`ref_nebulaidl.core.ConnectionSet`", "", "For internal use only! This field is used by the system and must not be filled in. Any values set will be ignored."
...
.. _ref_nebulaidl.core.CompiledWorkflowClosure:
...
.. csv-table:: CompiledWorkflowClosure type fields
   ...
   "primary", ":ref:`ref_nebulaidl.core.CompiledWorkflow`", "", "+required"
   "sub_workflows", ":ref:`ref_nebulaidl.core.CompiledWorkflow`", "repeated", "Guaranteed that there will only exist one and only one workflow with a given id, i.e., every sub workflow has a unique identifier. Also every enclosed subworkflow is used either by a primary workflow or by a subworkflow as an inlined workflow +optional"
   "tasks", ":ref:`ref_nebulaidl.core.CompiledTask`", "repeated", "Guaranteed that there will only exist one and only one task with a given id, i.e., every task has a unique id +required (at least 1)"
...
.. _ref_nebulaidl.core.ConnectionSet:
...
.. csv-table:: ConnectionSet type fields
   ...
   "downstream", ":ref:`ref_nebulaidl.core.ConnectionSet.DownstreamEntry`", "repeated", "A list of all the node ids that are downstream from a given node id"
   "upstream", ":ref:`ref_nebulaidl.core.ConnectionSet.UpstreamEntry`", "repeated", "A list of all the node ids, that are upstream of this node id"
...
.. _ref_nebulaidl.core.ConnectionSet.DownstreamEntry:
...
.. csv-table:: ConnectionSet.DownstreamEntry type fields
   ...
   "key", ":ref:`ref_string`", "", ""
   "value", ":ref:`ref_nebulaidl.core.ConnectionSet.IdList`", "", ""
...
.. _ref_nebulaidl.core.ConnectionSet.IdList:
...
.. _ref_nebulaidl.core.ConnectionSet.UpstreamEntry:
...
.. _ref_nebulaidl/core/condition.proto:

nebulaidl/core/condition.proto
==================================================================
...
.. _ref_nebulaidl.core.BooleanExpression:
...
.. csv-table:: BooleanExpression type fields
   ...
   "conjunction", ":ref:`ref_nebulaidl.core.ConjunctionExpression`", "", ""
   "comparison", ":ref:`ref_nebulaidl.core.ComparisonExpression`", "", ""
...
.. _ref_nebulaidl.core.ComparisonExpression:
...
.. csv-table:: ComparisonExpression type fields
   ...
   "operator", ":ref:`ref_nebulaidl.core.ComparisonExpression.Operator`", "", ""
   "left_value", ":ref:`ref_nebulaidl.core.Operand`", "", ""
   "right_value", ":ref:`ref_nebulaidl.core.Operand`", "", ""
...
.. _ref_nebulaidl.core.ConjunctionExpression:
...
.. csv-table:: ConjunctionExpression type fields
   ...
   "operator", ":ref:`ref_nebulaidl.core.ConjunctionExpression.LogicalOperator`", "", ""
   "left_expression", ":ref:`ref_nebulaidl.core.BooleanExpression`", "", ""
   "right_expression", ":ref:`ref_nebulaidl.core.BooleanExpression`", "", ""
...
.. csv-table:: Operand type fields
   ...
   "primitive", ":ref:`ref_nebulaidl.core.Primitive`", "", "Can be a constant"
...
.. _ref_nebulaidl.core.ComparisonExpression.Operator:
...
.. _ref_nebulaidl.core.ConjunctionExpression.LogicalOperator:
...
.. _ref_nebulaidl/core/dynamic_job.proto:

nebulaidl/core/dynamic_job.proto
==================================================================
...
.. _ref_nebulaidl.core.DynamicJobSpec:
...
.. csv-table:: DynamicJobSpec type fields
   ...
   "nodes", ":ref:`ref_nebulaidl.core.Node`", "repeated", "A collection of nodes to execute."
   ...
   "outputs", ":ref:`ref_nebulaidl.core.Binding`", "repeated", "Describes how to bind the final output of the dynamic job from the outputs of executed nodes. The referenced ids in bindings should have the generated id for the subtask."
   "tasks", ":ref:`ref_nebulaidl.core.TaskTemplate`", "repeated", "[Optional] A complete list of task specs referenced in nodes."
   "subworkflows", ":ref:`ref_nebulaidl.core.WorkflowTemplate`", "repeated", "[Optional] A complete list of task specs referenced in nodes."
...
.. _ref_nebulaidl/core/errors.proto:

nebulaidl/core/errors.proto
==================================================================
...
.. _ref_nebulaidl.core.ContainerError:
...
.. csv-table:: ContainerError type fields
   ...
   "kind", ":ref:`ref_nebulaidl.core.ContainerError.Kind`", "", "An abstract error kind for this error. Defaults to Non_Recoverable if not specified."
   "origin", ":ref:`ref_nebulaidl.core.ExecutionError.ErrorKind`", "", "Defines the origin of the error (system, user, unknown)."
...
.. _ref_nebulaidl.core.ErrorDocument:
...
.. csv-table:: ErrorDocument type fields
   ...
   "error", ":ref:`ref_nebulaidl.core.ContainerError`", "", "The error raised during execution."
...
.. _ref_nebulaidl.core.ContainerError.Kind:
...
.. _ref_nebulaidl/core/execution.proto:

nebulaidl/core/execution.proto
==================================================================
...
.. _ref_nebulaidl.core.ExecutionError:
...
.. csv-table:: ExecutionError type fields
   ...
   "kind", ":ref:`ref_nebulaidl.core.ExecutionError.ErrorKind`", "", ""
...
.. _ref_nebulaidl.core.NodeExecution:
...
.. _ref_nebulaidl.core.QualityOfService:
...
.. csv-table:: QualityOfService type fields
   ...
   "tier", ":ref:`ref_nebulaidl.core.QualityOfService.Tier`", "", ""
   "spec", ":ref:`ref_nebulaidl.core.QualityOfServiceSpec`", "", ""
...
.. _ref_nebulaidl.core.QualityOfServiceSpec:
...
.. _ref_nebulaidl.core.TaskExecution:
...
.. csv-table:: TaskLog type fields
   ...
   "uri", ":ref:`ref_string`", "", ""
   "name", ":ref:`ref_string`", "", ""
   "message_format", ":ref:`ref_nebulaidl.core.TaskLog.MessageFormat`", "", ""
...
.. _ref_nebulaidl.core.WorkflowExecution:
...
.. _ref_nebulaidl.core.ExecutionError.ErrorKind:
...
.. _ref_nebulaidl.core.NodeExecution.Phase:
...
.. _ref_nebulaidl.core.QualityOfService.Tier:
...
.. _ref_nebulaidl.core.TaskExecution.Phase:
...
.. _ref_nebulaidl.core.TaskLog.MessageFormat:
...
.. _ref_nebulaidl.core.WorkflowExecution.Phase:
...
.. _ref_nebulaidl/core/identifier.proto:

nebulaidl/core/identifier.proto
==================================================================
...
.. _ref_nebulaidl.core.Identifier:
...
.. _ref_nebulaidl.core.NodeExecutionIdentifier:
...
.. csv-table:: NodeExecutionIdentifier type fields
   ...
   "execution_id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", ""
...
.. _ref_nebulaidl.core.SignalIdentifier:
...
.. csv-table:: SignalIdentifier type fields
   ...
   "execution_id", ":ref:`ref_nebulaidl.core.WorkflowExecutionIdentifier`", "", "Identifies the Nebula workflow execution this signal belongs to."
...
.. _ref_nebulaidl.core.TaskExecutionIdentifier:
...
.. csv-table:: TaskExecutionIdentifier type fields
   ...
   "task_id", ":ref:`ref_nebulaidl.core.Identifier`", "", ""
   "node_execution_id", ":ref:`ref_nebulaidl.core.NodeExecutionIdentifier`", "", ""
...
.. _ref_nebulaidl.core.WorkflowExecutionIdentifier:
...
.. _ref_nebulaidl.core.ResourceType:
...
.. _ref_nebulaidl/core/interface.proto:

nebulaidl/core/interface.proto
==================================================================
...
.. csv-table:: Parameter type fields
   ...
   "var", ":ref:`ref_nebulaidl.core.Variable`", "", "+required Variable. Defines the type of the variable backing this parameter."
   "default", ":ref:`ref_nebulaidl.core.Literal`", "", "Defines a default value that has to match the variable type defined."
...
.. _ref_nebulaidl.core.ParameterMap:
...
.. csv-table:: ParameterMap type fields
   ...
   "parameters", ":ref:`ref_nebulaidl.core.ParameterMap.ParametersEntry`", "repeated", "Defines a map of parameter names to parameters."
...
.. _ref_nebulaidl.core.ParameterMap.ParametersEntry:
...
.. csv-table:: ParameterMap.ParametersEntry type fields
   ...
   "key", ":ref:`ref_string`", "", ""
   "value", ":ref:`ref_nebulaidl.core.Parameter`", "", ""
...
.. _ref_nebulaidl.core.TypedInterface:
...
.. csv-table:: TypedInterface type fields
   ...
   "inputs", ":ref:`ref_nebulaidl.core.VariableMap`", "", ""
   "outputs", ":ref:`ref_nebulaidl.core.VariableMap`", "", ""
...
.. csv-table:: Variable type fields
   ...
   "type", ":ref:`ref_nebulaidl.core.LiteralType`", "", "Variable literal type."
...
.. _ref_nebulaidl.core.VariableMap:
...
.. csv-table:: VariableMap type fields
   ...
   "variables", ":ref:`ref_nebulaidl.core.VariableMap.VariablesEntry`", "repeated", "Defines a map of variable names to variables."
...
.. _ref_nebulaidl.core.VariableMap.VariablesEntry:
...
.. csv-table:: VariableMap.VariablesEntry type fields
   ...
   "key", ":ref:`ref_string`", "", ""
   "value", ":ref:`ref_nebulaidl.core.Variable`", "", ""
...
.. _ref_nebulaidl/core/literals.proto:

nebulaidl/core/literals.proto
==================================================================
...
.. csv-table:: Binding type fields
   ...
   "binding", ":ref:`ref_nebulaidl.core.BindingData`", "", "Data to use to bind this variable."
...
.. _ref_nebulaidl.core.BindingData:
...
.. csv-table:: BindingData type fields
   ...
   "scalar", ":ref:`ref_nebulaidl.core.Scalar`", "", "A simple scalar value."
   "collection", ":ref:`ref_nebulaidl.core.BindingDataCollection`", "", "A collection of binding data. This allows nesting of binding data to any number of levels."
   "promise", ":ref:`ref_nebulaidl.core.OutputReference`", "", "References an output promised by another node."
   "map", ":ref:`ref_nebulaidl.core.BindingDataMap`", "", "A map of bindings. The key is always a string."
   "union", ":ref:`ref_nebulaidl.core.UnionInfo`", "", ""
...
.. _ref_nebulaidl.core.BindingDataCollection:
...
.. csv-table:: BindingDataCollection type fields
   ...
   "bindings", ":ref:`ref_nebulaidl.core.BindingData`", "repeated", ""
...
.. _ref_nebulaidl.core.BindingDataMap:
...
.. csv-table:: BindingDataMap type fields
   ...
   "bindings", ":ref:`ref_nebulaidl.core.BindingDataMap.BindingsEntry`", "repeated", ""
...
.. _ref_nebulaidl.core.BindingDataMap.BindingsEntry:
...
.. csv-table:: BindingDataMap.BindingsEntry type fields
   ...
   "key", ":ref:`ref_string`", "", ""
   "value", ":ref:`ref_nebulaidl.core.BindingData`", "", ""
...
.. csv-table:: Blob type fields
   ...
   "metadata", ":ref:`ref_nebulaidl.core.BlobMetadata`", "", ""
   "uri", ":ref:`ref_string`", "", ""
...
.. _ref_nebulaidl.core.BlobMetadata:
...
.. csv-table:: BlobMetadata type fields
   ...
   "type", ":ref:`ref_nebulaidl.core.BlobType`", "", ""
...
.. _ref_nebulaidl.core.KeyValuePair:
...
.. csv-table:: Literal type fields
   ...
   "scalar", ":ref:`ref_nebulaidl.core.Scalar`", "", "A simple value."
   "collection", ":ref:`ref_nebulaidl.core.LiteralCollection`", "", "A collection of literals to allow nesting."
   "map", ":ref:`ref_nebulaidl.core.LiteralMap`", "", "A map of strings to literals."
   "hash", ":ref:`ref_string`", "", "A hash representing this literal. This is used for caching purposes. For more details refer to RFC 1893 (https://github.com/nebulaclouds/nebula/blob/master/rfc/system/1893-caching-of-offloaded-objects.md)"
...
.. _ref_nebulaidl.core.LiteralCollection:
...
.. csv-table:: LiteralCollection type fields
   ...
   "literals", ":ref:`ref_nebulaidl.core.Literal`", "repeated", ""
...
.. _ref_nebulaidl.core.LiteralMap:
...
.. csv-table:: LiteralMap type fields
   ...
   "literals", ":ref:`ref_nebulaidl.core.LiteralMap.LiteralsEntry`", "repeated", ""
...
.. _ref_nebulaidl.core.LiteralMap.LiteralsEntry:
...
.. _ref_nebulaidl.core.RetryStrategy:
...
.. csv-table:: Scalar type fields
   ...
   "primitive", ":ref:`ref_nebulaidl.core.Primitive`", "", ""
   "blob", ":ref:`ref_nebulaidl.core.Blob`", "", ""
   "binary", ":ref:`ref_nebulaidl.core.Binary`", "", ""
   "schema", ":ref:`ref_nebulaidl.core.Schema`", "", ""
   "none_type", ":ref:`ref_nebulaidl.core.Void`", "", ""
   "error", ":ref:`ref_nebulaidl.core.Error`", "", ""
   "generic", ":ref:`ref_google.protobuf.Struct`", "", ""
   "structured_dataset", ":ref:`ref_nebulaidl.core.StructuredDataset`", "", ""
   "union", ":ref:`ref_nebulaidl.core.Union`", "", ""
...
.. csv-table:: Schema type fields
   ...
   "uri", ":ref:`ref_string`", "", ""
   "type", ":ref:`ref_nebulaidl.core.SchemaType`", "", ""
...
.. _ref_nebulaidl.core.StructuredDataset:
...
.. csv-table:: StructuredDataset type fields
   ...
   "metadata", ":ref:`ref_nebulaidl.core.StructuredDatasetMetadata`", "", ""
...
.. _ref_nebulaidl.core.StructuredDatasetMetadata:
...
.. csv-table:: StructuredDatasetMetadata type fields
   ...
   "structured_dataset_type", ":ref:`ref_nebulaidl.core.StructuredDatasetType`", "", "Bundle the type information along with the literal. This is here because StructuredDatasets can often be more defined at run time than at compile time. That is, at compile time you might only declare a task to return a pandas dataframe or a StructuredDataset, without any column information, but at run time, you might have that column information. nebulakit python will copy this type information into the literal, from the type information, if not provided by the various plugins (encoders). Since this field is run time generated, it's not used for any type checking."
...
.. csv-table:: Union type fields
   ...
   "value", ":ref:`ref_nebulaidl.core.Literal`", "", ""
   "type", ":ref:`ref_nebulaidl.core.LiteralType`", "", ""
...
.. csv-table:: UnionInfo type fields
   ...
   "targetType", ":ref:`ref_nebulaidl.core.LiteralType`", "", ""
...
.. _ref_nebulaidl/core/security.proto:

nebulaidl/core/security.proto
==================================================================
...
.. csv-table:: Identity type fields
   ...
   "oauth2_client", ":ref:`ref_nebulaidl.core.OAuth2Client`", "", "oauth2_client references an oauth2 client. Backend plugins can use this information to impersonate the client when making external calls."
...
.. _ref_nebulaidl.core.OAuth2Client:
...
.. csv-table:: OAuth2Client type fields
   ...
   "client_secret", ":ref:`ref_nebulaidl.core.Secret`", "", "client_secret is a reference to the secret used to authenticate the OAuth2 client. +required"
...
.. _ref_nebulaidl.core.OAuth2TokenRequest:
...
.. csv-table:: OAuth2TokenRequest type fields
   ...
   "type", ":ref:`ref_nebulaidl.core.OAuth2TokenRequest.Type`", "", "type indicates the type of the request to make. Defaults to CLIENT_CREDENTIALS. +required"
   "client", ":ref:`ref_nebulaidl.core.OAuth2Client`", "", "client references the client_id/secret to use to request the OAuth2 token. +required"
...
.. _ref_nebulaidl.core.SecurityContext:
...
.. csv-table:: SecurityContext type fields
   ...
   "run_as", ":ref:`ref_nebulaidl.core.Identity`", "", "run_as encapsulates the identity a pod should run as. If the task fills in multiple fields here, it'll be up to the backend plugin to choose the appropriate identity for the execution engine the task will run on."
   "secrets", ":ref:`ref_nebulaidl.core.Secret`", "repeated", "secrets indicate the list of secrets the task needs in order to proceed. Secrets will be mounted/passed to the pod as it starts. If the plugin responsible for kicking of the task will not run it on a nebula cluster (e.g. AWS Batch), it's the responsibility of the plugin to fetch the secret (which means propeller identity will need access to the secret) and to pass it to the remote execution engine."
   "tokens", ":ref:`ref_nebulaidl.core.OAuth2TokenRequest`", "repeated", "tokens indicate the list of token requests the task needs in order to proceed. Tokens will be mounted/passed to the pod as it starts. If the plugin responsible for kicking of the task will not run it on a nebula cluster (e.g. AWS Batch), it's the responsibility of the plugin to fetch the secret (which means propeller identity will need access to the secret) and to pass it to the remote execution engine."
...
.. _ref_nebulaidl.core.OAuth2TokenRequest.Type:
...
.. _ref_nebulaidl.core.Secret.MountType:
...
.. _ref_nebulaidl/core/tasks.proto:

nebulaidl/core/tasks.proto
==================================================================
...
.. csv-table:: Container type fields
   ...
   "args", ":ref:`ref_string`", "repeated", "These will default to Nebula given paths. If provided, the system will not append known paths. If the task still needs nebula's inputs and outputs path, add $(NEBULA_INPUT_FILE), $(NEBULA_OUTPUT_FILE) wherever makes sense and the system will populate these before executing the container."
   "resources", ":ref:`ref_nebulaidl.core.Resources`", "", "Container resources requirement as specified by the container engine."
   "env", ":ref:`ref_nebulaidl.core.KeyValuePair`", "repeated", "Environment variables will be set as the container is starting up."
   "config", ":ref:`ref_nebulaidl.core.KeyValuePair`", "repeated", "**Deprecated.** Allows extra configs to be available for the container. TODO: elaborate on how configs will become available. Deprecated, please use TaskTemplate.config instead."
   "ports", ":ref:`ref_nebulaidl.core.ContainerPort`", "repeated", "Ports to open in the container. This feature is not supported by all execution engines. (e.g. supported on K8s but not supported on AWS Batch) Only K8s"
   "data_config", ":ref:`ref_nebulaidl.core.DataLoadingConfig`", "", "BETA: Optional configuration for DataLoading. If not specified, then default values are used. This makes it possible to to run a completely portable container, that uses inputs and outputs only from the local file-system and without having any reference to nebulaidl. This is supported only on K8s at the moment. If data loading is enabled, then data will be mounted in accompanying directories specified in the DataLoadingConfig. If the directories are not specified, inputs will be mounted onto and outputs will be uploaded from a pre-determined file-system path. Refer to the documentation to understand the default paths. Only K8s"
   "architecture", ":ref:`ref_nebulaidl.core.Container.Architecture`", "", ""
...
.. _ref_nebulaidl.core.ContainerPort:
...
.. _ref_nebulaidl.core.DataLoadingConfig:
...
.. csv-table:: DataLoadingConfig type fields
   ...
   "input_path", ":ref:`ref_string`", "", "File system path (start at root). This folder will contain all the inputs exploded to a separate file. Example, if the input interface needs (x: int, y: blob, z: multipart_blob) and the input path is '/var/nebula/inputs', then the file system will look like /var/nebula/inputs/inputs.<metadata format dependent -> .pb .json .yaml> -> Format as defined previously. The Blob and Multipart blob will reference local filesystem instead of remote locations /var/nebula/inputs/x -> X is a file that contains the value of x (integer) in string format /var/nebula/inputs/y -> Y is a file in Binary format /var/nebula/inputs/z/... -> Note Z itself is a directory More information about the protocol - refer to docs #TODO reference docs here"
...
.. _ref_nebulaidl.core.IOStrategy:
...
.. csv-table:: IOStrategy type fields
   ...
   "download_mode", ":ref:`ref_nebulaidl.core.IOStrategy.DownloadMode`", "", "Mode to use to manage downloads"
   "upload_mode", ":ref:`ref_nebulaidl.core.IOStrategy.UploadMode`", "", "Mode to use to manage uploads"
...
.. _ref_nebulaidl.core.K8sObjectMetadata:
...
.. csv-table:: K8sObjectMetadata type fields
   ...
   "labels", ":ref:`ref_nebulaidl.core.K8sObjectMetadata.LabelsEntry`", "repeated", "Optional labels to add to the pod definition."
   "annotations", ":ref:`ref_nebulaidl.core.K8sObjectMetadata.AnnotationsEntry`", "repeated", "Optional annotations to add to the pod definition."
...
.. _ref_nebulaidl.core.K8sObjectMetadata.AnnotationsEntry:
...
.. _ref_nebulaidl.core.K8sObjectMetadata.LabelsEntry:
...
.. csv-table:: K8sPod type fields
   ...
   "metadata", ":ref:`ref_nebulaidl.core.K8sObjectMetadata`", "", "Contains additional metadata for building a kubernetes pod."
...
.. csv-table:: Resources type fields
   ...
   "requests", ":ref:`ref_nebulaidl.core.Resources.ResourceEntry`", "repeated", "The desired set of resources requested. ResourceNames must be unique within the list."
   "limits", ":ref:`ref_nebulaidl.core.Resources.ResourceEntry`", "repeated", "Defines a set of bounds (e.g. min/max) within which the task can reliably run. ResourceNames must be unique within the list."
...
.. _ref_nebulaidl.core.Resources.ResourceEntry:
...
.. csv-table:: Resources.ResourceEntry type fields
   ...
   "name", ":ref:`ref_nebulaidl.core.Resources.ResourceName`", "", "Resource name."
...
.. _ref_nebulaidl.core.RuntimeMetadata:
...
.. csv-table:: RuntimeMetadata type fields
   ...
   "type", ":ref:`ref_nebulaidl.core.RuntimeMetadata.RuntimeType`", "", "Type of runtime."
...
.. csv-table:: Sql type fields
   ...
   "statement", ":ref:`ref_string`", "", "The actual query to run, the query can have templated parameters. We use Nebula's Golang templating format for Query templating. Refer to the templating documentation. https://docs.nebula.org/projects/cookbook/en/latest/auto/integrations/external_services/hive/hive.html#sphx-glr-auto-integrations-external-services-hive-hive-py For example, insert overwrite directory '{{ .rawOutputDataPrefix }}' stored as parquet select * from my_table where ds = '{{ .Inputs.ds }}'"
   "dialect", ":ref:`ref_nebulaidl.core.Sql.Dialect`", "", ""
...
.. _ref_nebulaidl.core.TaskMetadata:
...
.. csv-table:: TaskMetadata type fields
   ...
   "runtime", ":ref:`ref_nebulaidl.core.RuntimeMetadata`", "", "Runtime information about the task."
   "timeout", ":ref:`ref_google.protobuf.Duration`", "", "The overall timeout of a task including user-triggered retries."
   "retries", ":ref:`ref_nebulaidl.core.RetryStrategy`", "", "Number of retries per task."
   ...
   "tags", ":ref:`ref_nebulaidl.core.TaskMetadata.TagsEntry`", "repeated", "Arbitrary tags that allow users and the platform to store small but arbitrary labels"
...
.. _ref_nebulaidl.core.TaskMetadata.TagsEntry:
...
.. _ref_nebulaidl.core.TaskTemplate:
...
.. csv-table:: TaskTemplate type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "Auto generated taskId by the system. Task Id uniquely identifies this task globally."
   "type", ":ref:`ref_string`", "", "A predefined yet extensible Task type identifier. This can be used to customize any of the components. If no extensions are provided in the system, Nebula will resolve the this task to its TaskCategory and default the implementation registered for the TaskCategory."
   "metadata", ":ref:`ref_nebulaidl.core.TaskMetadata`", "", "Extra metadata about the task."
   "interface", ":ref:`ref_nebulaidl.core.TypedInterface`", "", "A strongly typed interface for the task. This enables others to use this task within a workflow and guarantees compile-time validation of the workflow to avoid costly runtime failures."
   ...
   "container", ":ref:`ref_nebulaidl.core.Container`", "", ""
   "k8s_pod", ":ref:`ref_nebulaidl.core.K8sPod`", "", ""
   "sql", ":ref:`ref_nebulaidl.core.Sql`", "", ""
   "task_type_version", ":ref:`ref_int32`", "", "This can be used to customize task handling at execution time for the same task type."
   "security_context", ":ref:`ref_nebulaidl.core.SecurityContext`", "", "security_context encapsulates security attributes requested to run this task."
   "config", ":ref:`ref_nebulaidl.core.TaskTemplate.ConfigEntry`", "repeated", "Metadata about the custom defined for this task. This is extensible to allow various plugins in the system to use as required. reserve the field numbers 1 through 15 for very frequently occurring message elements"
...
.. _ref_nebulaidl.core.TaskTemplate.ConfigEntry:
...
.. _ref_nebulaidl.core.Container.Architecture:
...
.. _ref_nebulaidl.core.DataLoadingConfig.LiteralMapFormat:
...
.. csv-table:: Enum DataLoadingConfig.LiteralMapFormat values
   ...
   "YAML", "1", ""
   "PROTO", "2", "Proto is a serialized binary of `core.LiteralMap` defined in nebulaidl/core"



.. _ref_nebulaidl.core.IOStrategy.DownloadMode:
...
.. _ref_nebulaidl.core.IOStrategy.UploadMode:
...
.. _ref_nebulaidl.core.Resources.ResourceName:
...
.. _ref_nebulaidl.core.RuntimeMetadata.RuntimeType:
...
.. _ref_nebulaidl.core.Sql.Dialect:
...
.. _ref_nebulaidl/core/types.proto:

nebulaidl/core/types.proto
==================================================================
...
.. csv-table:: BlobType type fields
   ...
   "dimensionality", ":ref:`ref_nebulaidl.core.BlobType.BlobDimensionality`", "", ""
...
.. _ref_nebulaidl.core.LiteralType:
...
.. csv-table:: LiteralType type fields
   ...
   "simple", ":ref:`ref_nebulaidl.core.SimpleType`", "", "A simple type that can be compared one-to-one with another."
   "schema", ":ref:`ref_nebulaidl.core.SchemaType`", "", "A complex type that requires matching of inner fields."
   "collection_type", ":ref:`ref_nebulaidl.core.LiteralType`", "", "Defines the type of the value of a collection. Only homogeneous collections are allowed."
   "map_value_type", ":ref:`ref_nebulaidl.core.LiteralType`", "", "Defines the type of the value of a map type. The type of the key is always a string."
   "blob", ":ref:`ref_nebulaidl.core.BlobType`", "", "A blob might have specialized implementation details depending on associated metadata."
   "enum_type", ":ref:`ref_nebulaidl.core.EnumType`", "", "Defines an enum with pre-defined string values."
   "structured_dataset_type", ":ref:`ref_nebulaidl.core.StructuredDatasetType`", "", "Generalized schema support"
   "union_type", ":ref:`ref_nebulaidl.core.UnionType`", "", "Defines an union type with pre-defined LiteralTypes."
   ...
   "annotation", ":ref:`ref_nebulaidl.core.TypeAnnotation`", "", "This field contains arbitrary data that might have special semantic meaning for the client but does not effect internal nebula behavior."
   "structure", ":ref:`ref_nebulaidl.core.TypeStructure`", "", "Hints to improve type matching."
...
.. _ref_nebulaidl.core.OutputReference:
...
.. _ref_nebulaidl.core.SchemaType:
...
.. csv-table:: SchemaType type fields
   ...
   "columns", ":ref:`ref_nebulaidl.core.SchemaType.SchemaColumn`", "repeated", "A list of ordered columns this schema comprises of."
...
.. _ref_nebulaidl.core.SchemaType.SchemaColumn:
...
.. csv-table:: SchemaType.SchemaColumn type fields
   ...
   "type", ":ref:`ref_nebulaidl.core.SchemaType.SchemaColumn.SchemaColumnType`", "", "The column type. This allows a limited set of types currently."
...
.. _ref_nebulaidl.core.StructuredDatasetType:
...
.. csv-table:: StructuredDatasetType type fields
   ...
   "columns", ":ref:`ref_nebulaidl.core.StructuredDatasetType.DatasetColumn`", "repeated", "A list of ordered columns this schema comprises of."
...
.. _ref_nebulaidl.core.StructuredDatasetType.DatasetColumn:
...
.. csv-table:: StructuredDatasetType.DatasetColumn type fields
   ...
   "name", ":ref:`ref_string`", "", "A unique name within the schema type for the column."
   "literal_type", ":ref:`ref_nebulaidl.core.LiteralType`", "", "The column type."
...
.. _ref_nebulaidl.core.TypeAnnotation:
...
.. _ref_nebulaidl.core.TypeStructure:
...
.. csv-table:: UnionType type fields
   ...
   "variants", ":ref:`ref_nebulaidl.core.LiteralType`", "repeated", "Predefined set of variants in union."
...
.. _ref_nebulaidl.core.BlobType.BlobDimensionality:
...
.. _ref_nebulaidl.core.SchemaType.SchemaColumn.SchemaColumnType:
...
.. _ref_nebulaidl.core.SimpleType:
...
.. _ref_nebulaidl/core/workflow.proto:

nebulaidl/core/workflow.proto
==================================================================
...
.. _ref_nebulaidl.core.ApproveCondition:
...
.. _ref_nebulaidl.core.BranchNode:
...
.. csv-table:: BranchNode type fields
   ...
   "if_else", ":ref:`ref_nebulaidl.core.IfElseBlock`", "", "+required"
...
.. csv-table:: GateNode type fields
   ...
   "approve", ":ref:`ref_nebulaidl.core.ApproveCondition`", "", "ApproveCondition represents a dependency on an external approval provided by a boolean signal."
   "signal", ":ref:`ref_nebulaidl.core.SignalCondition`", "", "SignalCondition represents a dependency on an signal."
   "sleep", ":ref:`ref_nebulaidl.core.SleepCondition`", "", "SleepCondition represents a dependency on waiting for the specified duration."
...
.. csv-table:: IfBlock type fields
   ...
   "condition", ":ref:`ref_nebulaidl.core.BooleanExpression`", "", ""
   "then_node", ":ref:`ref_nebulaidl.core.Node`", "", ""
...
.. _ref_nebulaidl.core.IfElseBlock:
...
.. csv-table:: IfElseBlock type fields
   ...
   "case", ":ref:`ref_nebulaidl.core.IfBlock`", "", "+required. First condition to evaluate."
   "other", ":ref:`ref_nebulaidl.core.IfBlock`", "repeated", "+optional. Additional branches to evaluate."
   "else_node", ":ref:`ref_nebulaidl.core.Node`", "", "The node to execute in case none of the branches were taken."
   "error", ":ref:`ref_nebulaidl.core.Error`", "", "An error to throw in case none of the branches were taken."
...
.. csv-table:: Node type fields
   ...
   "metadata", ":ref:`ref_nebulaidl.core.NodeMetadata`", "", "Extra metadata about the node."
   "inputs", ":ref:`ref_nebulaidl.core.Binding`", "repeated", "Specifies how to bind the underlying interface's inputs. All required inputs specified in the underlying interface must be fulfilled."
   ...
   "output_aliases", ":ref:`ref_nebulaidl.core.Alias`", "repeated", "+optional. A node can define aliases for a subset of its outputs. This is particularly useful if different nodes need to conform to the same interface (e.g. all branches in a branch node). Downstream nodes must refer to this nodes outputs using the alias if one's specified."
   "task_node", ":ref:`ref_nebulaidl.core.TaskNode`", "", "Information about the Task to execute in this node."
   "workflow_node", ":ref:`ref_nebulaidl.core.WorkflowNode`", "", "Information about the Workflow to execute in this mode."
   "branch_node", ":ref:`ref_nebulaidl.core.BranchNode`", "", "Information about the branch node to evaluate in this node."
   "gate_node", ":ref:`ref_nebulaidl.core.GateNode`", "", "Information about the condition to evaluate in this node."
...
.. _ref_nebulaidl.core.NodeMetadata:
...
.. _ref_nebulaidl.core.SignalCondition:
...
.. _ref_nebulaidl.core.SleepCondition:
...
.. csv-table:: TaskNode type fields
   ...
   "reference_id", ":ref:`ref_nebulaidl.core.Identifier`", "", "A globally unique identifier for the task."
   "overrides", ":ref:`ref_nebulaidl.core.TaskNodeOverrides`", "", "Optional overrides applied at task execution time."
...
.. _ref_nebulaidl.core.TaskNodeOverrides:
...
.. csv-table:: TaskNodeOverrides type fields
   ...
   "resources", ":ref:`ref_nebulaidl.core.Resources`", "", "A customizable interface to convey resources requested for a task container."
...
.. _ref_nebulaidl.core.WorkflowMetadata:
...
.. csv-table:: WorkflowMetadata type fields
   ...
   "quality_of_service", ":ref:`ref_nebulaidl.core.QualityOfService`", "", "Indicates the runtime priority of workflow executions."
   "on_failure", ":ref:`ref_nebulaidl.core.WorkflowMetadata.OnFailurePolicy`", "", "Defines how the system should behave when a failure is detected in the workflow execution."
   "tags", ":ref:`ref_nebulaidl.core.WorkflowMetadata.TagsEntry`", "repeated", "Arbitrary tags that allow users and the platform to store small but arbitrary labels"
...
.. _ref_nebulaidl.core.WorkflowMetadata.TagsEntry:
...
.. _ref_nebulaidl.core.WorkflowMetadataDefaults:
...
.. _ref_nebulaidl.core.WorkflowNode:
...
.. csv-table:: WorkflowNode type fields
   ...
   "launchplan_ref", ":ref:`ref_nebulaidl.core.Identifier`", "", "A globally unique identifier for the launch plan."
   "sub_workflow_ref", ":ref:`ref_nebulaidl.core.Identifier`", "", "Reference to a subworkflow, that should be defined with the compiler context"
...
.. _ref_nebulaidl.core.WorkflowTemplate:
...
.. csv-table:: WorkflowTemplate type fields
   ...
   "id", ":ref:`ref_nebulaidl.core.Identifier`", "", "A globally unique identifier for the workflow."
   "metadata", ":ref:`ref_nebulaidl.core.WorkflowMetadata`", "", "Extra metadata about the workflow."
   "interface", ":ref:`ref_nebulaidl.core.TypedInterface`", "", "Defines a strongly typed interface for the Workflow. This can include some optional parameters."
   "nodes", ":ref:`ref_nebulaidl.core.Node`", "repeated", "A list of nodes. In addition, 'globals' is a special reserved node id that can be used to consume workflow inputs."
   "outputs", ":ref:`ref_nebulaidl.core.Binding`", "repeated", "A list of output bindings that specify how to construct workflow outputs. Bindings can pull node outputs or specify literals. All workflow outputs specified in the interface field must be bound in order for the workflow to be validated. A workflow has an implicit dependency on all of its nodes to execute successfully in order to bind final outputs. Most of these outputs will be Binding's with a BindingData of type OutputReference. That is, your workflow can just have an output of some constant (`Output(5)`), but usually, the workflow will be pulling outputs from the output of a task."
   "failure_node", ":ref:`ref_nebulaidl.core.Node`", "", "+optional A catch-all node. This node is executed whenever the execution engine determines the workflow has failed. The interface of this node must match the Workflow interface with an additional input named 'error' of type pb.lyft.nebula.core.Error."
   "metadata_defaults", ":ref:`ref_nebulaidl.core.WorkflowMetadataDefaults`", "", "workflow defaults"
...
.. _ref_nebulaidl.core.WorkflowMetadata.OnFailurePolicy:
...
.. _ref_nebulaidl/core/workflow_closure.proto:

nebulaidl/core/workflow_closure.proto
==================================================================
...
.. _ref_nebulaidl.core.WorkflowClosure:
...
.. csv-table:: WorkflowClosure type fields
   ...
   "workflow", ":ref:`ref_nebulaidl.core.WorkflowTemplate`", "", "required. Workflow template."
   "tasks", ":ref:`ref_nebulaidl.core.TaskTemplate`", "repeated", "optional. A collection of tasks referenced by the workflow. Only needed if the workflow references tasks."
