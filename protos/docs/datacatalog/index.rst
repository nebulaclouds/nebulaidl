Nebula Data Catalog Service
============================

Protos provides the interface definition for the Data Catalog Service. Data Catalog is a service to
index parameterized, strongly-typed data artifacts across revisions. It is used in the Nebula ecosystem
...
`Datacatalog raw proto <https://github.com/nebulaclouds/nebulaidl/blob/master/protos/nebulaidl/datacatalog/datacatalog.proto>`__
